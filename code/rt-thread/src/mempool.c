 ...
 */
void __fast rt_mp_alloc_sethook(void (*hook)(struct rt_mempool *mp, void *block))
{
 ...
 * @param hook the hook function
 */
void __fast rt_mp_free_sethook(void (*hook)(struct rt_mempool *mp, void *block))
{
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_mp_detach(struct rt_mempool *mp)
{
 ...
 */
rt_mp_t __fast rt_mp_create(const char *name,
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_mp_delete(rt_mp_t mp)
{
    struct rt_thread *thread;
    register rt_ubase_t temp;
 ...
 */
void __fast *rt_mp_alloc(rt_mp_t mp, rt_int32_t time)
{
    rt_uint8_t *block_ptr;
 ...
 */
void __fast rt_mp_free(void *block)
{
    rt_uint8_t **block_ptr;
    struct rt_mempool *mp;
    struct rt_thread *thread;
