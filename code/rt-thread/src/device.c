 ...
 */
rt_device_t __fast rt_device_find(const char *name)
{
 ...
 * @return the result
 */
rt_err_t __fast rt_device_open(rt_device_t dev, rt_uint16_t oflag)
{
    rt_err_t result = RT_EOK;
 ...
 * @return the result
 */
rt_err_t __fast rt_device_close(rt_device_t dev)
{
    rt_err_t result = RT_EOK;
 ...
 */
rt_size_t __fast rt_device_read(rt_device_t dev,
                         rt_off_t    pos,
                         void       *buffer,
                         rt_size_t   size)
{
 ...
 * @note since 0.4.0, the unit of size/pos is a block for block device.
 */
rt_size_t __fast rt_device_write(rt_device_t dev,
                          rt_off_t    pos,
                          const void *buffer,
                          rt_size_t   size)
{
 ...
 * @return the result
 */
rt_err_t __fast rt_device_control(rt_device_t dev, int cmd, void *arg)
{
    RT_ASSERT(dev != RT_NULL);
 ...
 */
rt_err_t
__fast rt_device_set_rx_indicate(rt_device_t dev,
 ...
 */
rt_err_t
__fast rt_device_set_tx_complete(rt_device_t dev,
