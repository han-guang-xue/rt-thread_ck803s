 ...
 */
void __fast rt_object_attach_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
void __fast rt_object_detach_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
void __fast rt_object_trytake_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
void __fast rt_object_take_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
void __fast rt_object_put_sethook(void (*hook)(struct rt_object *object))
{
 ...
 */
void __fast rt_system_object_init(void)
{
}
...
__fast rt_object_get_information(enum rt_object_class_type type)
{
    int index;
 ...
 */
void __fast rt_object_init(struct rt_object         *object,
 ...
 */
void __fast rt_object_detach(rt_object_t object)
{
    register rt_base_t temp;
 ...
 * @return object
 */
rt_object_t __fast rt_object_allocate(enum rt_object_class_type type, const char *name)
{
 ...
 */
void __fast rt_object_delete(rt_object_t object)
{
    register rt_base_t temp;
 ...
 */
rt_bool_t __fast rt_object_is_systemobject(rt_object_t object)
{
    /* object check */
    RT_ASSERT(object != RT_NULL);
 ...
 */
rt_object_t __fast rt_object_find(const char *name, rt_uint8_t type)
{
