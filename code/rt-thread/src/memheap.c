...
rt_err_t __fast rt_memheap_detach(struct rt_memheap *heap)
{
    RT_ASSERT(heap);
...
void __fast *rt_memheap_alloc(struct rt_memheap *heap, rt_uint32_t size)
{
    rt_err_t result;
...
void __fast *rt_memheap_realloc(struct rt_memheap *heap, void *ptr, rt_size_t newsize)
{
    rt_err_t result;
    rt_size_t oldsize;
    struct rt_memheap_item *header_ptr;
...
void __fast rt_memheap_free(void *ptr)
{
    rt_err_t result;
