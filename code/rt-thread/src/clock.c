 ...
 * @return current tick
 */
rt_tick_t __fast rt_tick_get(void)
{
 ...
 */
void __fast rt_tick_set(rt_tick_t tick)
{
    rt_base_t level;
 ...
 */
void __fast rt_tick_increase(void)
{
 ...
 */
int __fast rt_tick_from_millisecond(rt_int32_t ms)
{
    int tick;
