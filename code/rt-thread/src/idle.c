 ...
 */
void __fast rt_thread_idle_sethook(void (*hook)(void))
{
    rt_thread_idle_hook = hook;
}
void __fast rt_thread_idle_delhook(void (*hook)(void))
{
...
rt_inline int __fast _has_defunct_thread(void)
{
 ...
 */
void __fast rt_thread_idle_excute(void)
{
...
static void __fast rt_thread_idle_entry(void *parameter)
{
    while (1)
    {
#ifdef RT_USING_IDLE_HOOK
 ...
 *
 */
rt_thread_t __fast rt_thread_idle_gethandler(void)
{
