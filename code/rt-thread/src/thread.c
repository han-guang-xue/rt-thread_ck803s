 ...
 */
void __fast rt_thread_suspend_sethook(void (*hook)(rt_thread_t thread))
{
 ...
 * @note the hook function must be simple and never be blocked or suspend.
 */
void __fast rt_thread_resume_sethook(void (*hook)(rt_thread_t thread))
{
 ...
 * @param hook the specified hook function
 */
void __fast rt_thread_inited_sethook(void (*hook)(rt_thread_t thread))
{
 ...
 */
rt_thread_t __fast rt_thread_self(void)
{
 ...
 * @return the operation status, RT_EOK on OK, -RT_ERROR on error
 */
rt_err_t __fast rt_thread_startup(rt_thread_t thread)
{
    /* thread check */
    RT_ASSERT(thread != RT_NULL);
 ...
 * @return the operation status, RT_EOK on OK, -RT_ERROR on error
 */
rt_err_t __fast rt_thread_detach(rt_thread_t thread)
{
    rt_base_t lock;
 ...
 * @return the operation status, RT_EOK on OK, -RT_ERROR on error
 */
rt_err_t __fast rt_thread_delete(rt_thread_t thread)
{
    rt_base_t lock;
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_thread_yield(void)
{
    register rt_base_t level;
    struct rt_thread *thread;
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_thread_sleep(rt_tick_t tick)
{
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_thread_delay(rt_tick_t tick)
{
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_thread_mdelay(rt_int32_t ms)
{
    rt_tick_t tick;
 ...
 * @return RT_EOK
 */
rt_err_t __fast rt_thread_control(rt_thread_t thread, int cmd, void *arg)
{
    register rt_base_t temp;
 ...
 */
rt_err_t __fast rt_thread_suspend(rt_thread_t thread)
{
    register rt_base_t temp;
 ...
 * @return the operation status, RT_EOK on OK, -RT_ERROR on error
 */
rt_err_t __fast rt_thread_resume(rt_thread_t thread)
{
    register rt_base_t temp;
 ...
 */
void __fast rt_thread_timeout(void *parameter)
{
    struct rt_thread *thread;
 ...
 */
rt_thread_t __fast rt_thread_find(char *name)
{
