 ...
 */
rt_inline rt_err_t __fast rt_ipc_object_init(struct rt_ipc_object *ipc)
{
    /* init ipc object */
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_inline rt_err_t __fast rt_ipc_list_suspend(rt_list_t        *list,
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_inline rt_err_t __fast rt_ipc_list_resume(rt_list_t *list)
{
    struct rt_thread *thread;
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_inline rt_err_t __fast rt_ipc_list_resume_all(rt_list_t *list)
{
    struct rt_thread *thread;
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_sem_init(rt_sem_t    sem,
                     const char *name,
                     rt_uint32_t value,
                     rt_uint8_t  flag)
{
 ...
 * @see rt_sem_delete
 */
rt_err_t __fast rt_sem_detach(rt_sem_t sem)
{
    RT_ASSERT(sem != RT_NULL);
 ...
 * @see rt_sem_init
 */
rt_sem_t __fast rt_sem_create(const char *name, rt_uint32_t value, rt_uint8_t flag)
{
    rt_sem_t sem;
 ...
 * @see rt_sem_detach
 */
rt_err_t __fast rt_sem_delete(rt_sem_t sem)
{
    RT_DEBUG_NOT_IN_INTERRUPT;
 ...
 * @return the error code
 */
rt_err_t __fast rt_sem_take(rt_sem_t sem, rt_int32_t time)
{
 ...
 * @return the error code
 */
rt_err_t __fast rt_sem_trytake(rt_sem_t sem)
{
 ...
 * @return the error code
 */
rt_err_t __fast rt_sem_release(rt_sem_t sem)
{
    register rt_base_t temp;
 ...
 * @return the error code
 */
rt_err_t __fast rt_sem_control(rt_sem_t sem, int cmd, void *arg)
{
    rt_ubase_t level;
    RT_ASSERT(sem != RT_NULL);
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_mutex_init(rt_mutex_t mutex, const char *name, rt_uint8_t flag)
{
 ...
 * @see rt_mutex_delete
 */
rt_err_t __fast rt_mutex_detach(rt_mutex_t mutex)
{
    RT_ASSERT(mutex != RT_NULL);
 ...
 * @see rt_mutex_init
 */
rt_mutex_t __fast rt_mutex_create(const char *name, rt_uint8_t flag)
{
 ...
 * @see rt_mutex_detach
 */
rt_err_t __fast rt_mutex_delete(rt_mutex_t mutex)
{
    RT_DEBUG_NOT_IN_INTERRUPT;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mutex_take(rt_mutex_t mutex, rt_int32_t time)
{
    register rt_base_t temp;
    struct rt_thread *thread;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mutex_release(rt_mutex_t mutex)
{
    register rt_base_t temp;
    struct rt_thread *thread;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mutex_control(rt_mutex_t mutex, int cmd, void *arg)
{
    return -RT_ERROR;
}
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_event_init(rt_event_t event, const char *name, rt_uint8_t flag)
{
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_event_detach(rt_event_t event)
{
    /* parameter check */
    RT_ASSERT(event != RT_NULL);
 ...
 */
rt_event_t __fast rt_event_create(const char *name, rt_uint8_t flag)
{
    rt_event_t event;
 ...
 * @return the error code
 */
rt_err_t __fast rt_event_delete(rt_event_t event)
{
    /* parameter check */
    RT_ASSERT(event != RT_NULL);
 ...
 * @return the error code
 */
rt_err_t __fast rt_event_send(rt_event_t event, rt_uint32_t set)
{
    struct rt_list_node *n;
    struct rt_thread *thread;
 ...
 * @return the error code
 */
rt_err_t __fast rt_event_recv(rt_event_t   event,
                       rt_uint32_t  set,
                       rt_uint8_t   option,
                       rt_int32_t   timeout,
                       rt_uint32_t *recved)
 ...
 * @return the error code
 */
rt_err_t __fast rt_event_control(rt_event_t event, int cmd, void *arg)
{
    rt_ubase_t level;
    RT_ASSERT(event != RT_NULL);
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_mb_init(rt_mailbox_t mb,
                    const char  *name,
                    void        *msgpool,
                    rt_size_t    size,
                    rt_uint8_t   flag)
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_mb_detach(rt_mailbox_t mb)
{
    /* parameter check */
    RT_ASSERT(mb != RT_NULL);
 ...
 */
rt_mailbox_t __fast rt_mb_create(const char *name, rt_size_t size, rt_uint8_t flag)
{
    rt_mailbox_t mb;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mb_delete(rt_mailbox_t mb)
{
    RT_DEBUG_NOT_IN_INTERRUPT;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mb_send_wait(rt_mailbox_t mb,
                         rt_uint32_t  value,
                         rt_int32_t   timeout)
{
    struct rt_thread *thread;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mb_send(rt_mailbox_t mb, rt_uint32_t value)
{
 ...
 * @return the error code
 */
rt_err_t __fast rt_mb_recv(rt_mailbox_t mb, rt_uint32_t *value, rt_int32_t timeout)
{
    struct rt_thread *thread;
    register rt_ubase_t temp;
    rt_uint32_t tick_delta;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mb_control(rt_mailbox_t mb, int cmd, void *arg)
{
    rt_ubase_t level;
    RT_ASSERT(mb != RT_NULL);
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_mq_init(rt_mq_t     mq,
                    const char *name,
                    void       *msgpool,
                    rt_size_t   msg_size,
                    rt_size_t   pool_size,
 ...
 * @return the operation status, RT_EOK on successful
 */
rt_err_t __fast rt_mq_detach(rt_mq_t mq)
{
    /* parameter check */
    RT_ASSERT(mq != RT_NULL);
 ...
 */
rt_mq_t __fast rt_mq_create(const char *name,
                     rt_size_t   msg_size,
                     rt_size_t   max_msgs,
                     rt_uint8_t  flag)
{
 ...
 * @return the error code
 */
rt_err_t __fast rt_mq_delete(rt_mq_t mq)
{
    RT_DEBUG_NOT_IN_INTERRUPT;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mq_send(rt_mq_t mq, void *buffer, rt_size_t size)
{
    register rt_ubase_t temp;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mq_urgent(rt_mq_t mq, void *buffer, rt_size_t size)
{
    register rt_ubase_t temp;
    struct rt_mq_message *msg;
 ...
 * @return the error code
 */
rt_err_t __fast rt_mq_recv(rt_mq_t    mq,
                    void      *buffer,
                    rt_size_t  size,
                    rt_int32_t timeout)
{
 ...
 * @return the error code
 */
rt_err_t __fast rt_mq_control(rt_mq_t mq, int cmd, void *arg)
{
    rt_ubase_t level;
    struct rt_mq_message *msg;
