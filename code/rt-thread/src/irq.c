 ...
 */
void __fast rt_interrupt_enter_sethook(void (*hook)(void))
{
 ...
 * @note the hook function must be simple and never be blocked or suspend.
 */
void __fast rt_interrupt_leave_sethook(void (*hook)(void))
{
 ...
 */
void __fast rt_interrupt_enter(void)
{
    rt_base_t level;
 ...
 */
void __fast rt_interrupt_leave(void)
{
    rt_base_t level;
 ...
 */
rt_uint8_t __fast rt_interrupt_get_nest(void)
{
