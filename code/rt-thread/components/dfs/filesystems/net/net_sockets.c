...
int __fast recv(int s, void *mem, size_t len, int flags)
{
    int sock = dfs_net_getsocket(s);
...
int __fast recvfrom(int s, void *mem, size_t len, int flags,
...
int __fast send(int s, const void *dataptr, size_t size, int flags)
{
    int sock = dfs_net_getsocket(s);
...
int __fast sendto(int s, const void *dataptr, size_t size, int flags,
