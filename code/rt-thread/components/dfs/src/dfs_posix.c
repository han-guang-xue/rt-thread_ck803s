...
int __fast read(int fd, void *buf,int len)
#else
int __fast read(int fd, void *buf, size_t len)
#endif
{
    int result;
    struct dfs_fd *d;
 ...
 */
#ifdef RT_USING_MINILIBC
int __fast write(int fd, const void *buf, int len)
#else
int __fast write(int fd, const void *buf, size_t len)
#endif
{
    int result;
    struct dfs_fd *d;
 ...
 */
off_t __fast lseek(int fd, off_t offset, int whence)
{
    int result;
    struct dfs_fd *d;
 ...
 */
struct dirent * __fast readdir(DIR *d)
{
    int result;
    struct dfs_fd *fd;
 ...
 */
void __fast seekdir(DIR *d, off_t offset)
{
    struct dfs_fd *fd;
 ...
 */
char * __fast getcwd(char *buf, size_t size)
{
#ifdef DFS_USING_WORKDIR
    rt_enter_critical();
