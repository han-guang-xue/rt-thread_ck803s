...
int __fast clock_time_to_tick(const struct timespec *time)
{
    int tick;
    int nsecond, second;
    struct timespec tp;
...
int __fast clock_getres(clockid_t clockid, struct timespec *res)
{
    int ret = 0;
...
int __fast clock_gettime(clockid_t clockid, struct timespec *tp)
{
    int ret = 0;
...
int __fast clock_settime(clockid_t clockid, const struct timespec *tp)
{
    int second;
    rt_tick_t tick;
    rt_device_t device;
