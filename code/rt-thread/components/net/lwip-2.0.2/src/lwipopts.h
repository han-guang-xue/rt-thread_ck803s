...
//#define TCP_WND_UPDATE_THRESHOLD    LWIP_MIN((TCP_WND / 4), (TCP_MSS * 1))
...
/* PBUF_LINK_HLEN: the number of bytes that should be allocated for a
   link level header. */
#ifndef RT_LWIP_SUPPORT_VLAN
#define PBUF_LINK_HLEN              16
#else
#define ETHARP_SUPPORT_VLAN         1
#define ETHARP_VLAN_CHECK           RT_LWIP_VLAN_ID
/**
 *  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 *  This must be defined before PBUF_LINK_HLEN to get VLAN work
 *  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 */
#define LWIP_HOOK_VLAN_SET(netif, p, src, dst, eth_type)  (0<<13 | 0<<12 | RT_LWIP_VLAN_ID)

#define PBUF_LINK_HLEN              20//(16+4)
#endif
...
#define TCP_OOSEQ_MAX_BYTES         TCP_MSS * TCP_OOSEQ_MAX_PBUFS
#endif
...
#ifndef LWIP_SO_GET_IF_HWADDR
#define LWIP_SO_GET_IF_HWADDR           1
#endif

#ifndef LWIP_SO_GET_IF_ADDR
