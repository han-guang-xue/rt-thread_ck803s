...
void __fast rt_wqueue_add(rt_wqueue_t *queue, struct rt_wqueue_node *node)
{
    rt_base_t level;
...
void __fast rt_wqueue_remove(struct rt_wqueue_node *node)
{
    rt_base_t level;
...
int __fast __wqueue_default_wake(struct rt_wqueue_node *wait, void *key)
{
    return 0;
}

void __fast rt_wqueue_wakeup(rt_wqueue_t *queue, void *key)
{
    rt_base_t level;
...
int __fast rt_wqueue_wait(rt_wqueue_t *queue, int condition, int msec)
{
    int tick;
