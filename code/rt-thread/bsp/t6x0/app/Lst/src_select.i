...
# 25 "../../../components/dfs/src/select.c" 2
...
# 26 "../../../components/dfs/src/select.c" 2
...
# 27 "../../../components/dfs/src/select.c" 2
...
# 29 "../../../components/dfs/src/select.c" 2
...
# 30 "../../../components/dfs/src/select.c" 2
...
int __attribute__((section(".fast"))) select(int nfds, _types_fd_set *readfds, _types_fd_set *writefds, _types_fd_set *exceptfds, struct timeval *timeout)
{
    ...
    {
        int incr = 0;
# 74 "../../../components/dfs/src/select.c"
        if (readfds && ((readfds)->fds_bits[(fd)/(sizeof (fd_mask) * 8)] & (1L << ((fd) % (sizeof (fd_mask) * 8)))))
        {
            pollset[ndx].fd = fd;
