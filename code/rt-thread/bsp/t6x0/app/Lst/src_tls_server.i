# 1 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
# 19 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
...
# 20 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 2
...
# 21 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 2
...
# 22 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 2
...
# 26 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 2
# 1 "../../../packages/mbedtls-2.6.0/ports/inc/tls_certificate.h" 1
# 24 "../../../packages/mbedtls-2.6.0/ports/inc/tls_certificate.h"
extern const char mbedtls_root_certificate[];

extern const size_t mbedtls_root_certificate_len;
# 27 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 2
...
# 34 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 2
...
tls_srv_context* tls_srv_create(char *bind_host, char *bind_port, int suite_preset)
{
    ...
    if (!bind_port) {
        return 
# 52 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
              (0)
# 52 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                  ;
    }
    ...
    if (!ctx) {
        ...
        return 
# 58 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
              (0)
# 58 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                  ;
    }

    if (!bind_host)
        ctx->host = 
# 62 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                   (0)
# 62 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                       ;
    else
    ...
    if (suite_preset == 3) {
        ...
        ret = mbedtls_gm_pk_parse_key(&ctx->gm_pkey_dsa,
                                      ...
                                      mbedtls_gmtest_srv_dsa_key_len, 
# 115 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                     (0)
# 115 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                         , 0);
        if (ret != 0) {
        ...
        ret = mbedtls_gm_pk_parse_key(&ctx->gm_pkey_enc,
                                      ...
                                      mbedtls_gmtest_srv_enc_key_len, 
# 123 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                     (0)
# 123 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                         , 0);
        if (ret != 0) {
            rt_kprintf("[fail]mbedtls_pk_parse_key returned %d\n", ret);
            goto exit;
    ...
    if ((suite_preset == 0) || (suite_preset == 2)) {
...
# 146 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                            (0)
# 146 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                , 0);
        if (ret != 0) {
            rt_kprintf("[fail]mbedtls_pk_parse_key returned %d\n", ret);
            goto exit;
        ...
        ret = mbedtls_pk_parse_key(&ctx->pkey, (const unsigned char*)mbedtls_test_srv_key,
                                   mbedtls_test_srv_key_len, 
# 168 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                            (0)
# 168 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                , 0);
        if (ret != 0) {
            rt_kprintf("[fail]mbedtls_pk_parse_key returned %d\n", ret);
            goto exit;
        ...
        ret = mbedtls_gm_pk_parse_key(&ctx->gm_pkey_dsa,
                                      (const unsigned char*)mbedtls_gmtest_srv_dsa_key,
                                      mbedtls_gmtest_srv_dsa_key_len, 
# 197 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                     (0)
# 197 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                         , 0);
        if (ret != 0) {
            rt_kprintf("[fail]mbedtls_pk_parse_key returned %d\n", ret);
            goto exit;
        ...
        ret = mbedtls_gm_pk_parse_key(&ctx->gm_pkey_enc,
                                      (const unsigned char*)mbedtls_gmtest_srv_enc_key,
                                      mbedtls_gmtest_srv_enc_key_len, 
# 205 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                     (0)
# 205 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                         , 0);
        if (ret != 0) {
            rt_kprintf("[fail]mbedtls_pk_parse_key returned %d\n", ret);
            goto exit;
...
exit:
    ...
    return 
# 226 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
          (0)
# 226 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
              ;
}
...
int tls_srv_listen(tls_srv_context *ctx)
{
    ...
    if ((ret = mbedtls_net_bind(&ctx->listen_fd, ctx->host, ctx->port, 0)) != 0) {
...
tls_srv_session* tls_srv_session_create(tls_srv_context *ctx)
{
    ...
    if (!ctx) {
        return 
# 289 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
              (0)
# 289 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                  ;
    }
    ...
    if (!session) {
        ...
        return 
# 295 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
              (0)
# 295 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                  ;
    }
    ...
    session->port = 
# 314 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                   (0)
# 314 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                       ;
...
exit:
    ...
    return 
# 321 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
          (0)
# 321 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
              ;
}
...
int tls_srv_session_config(tls_srv_session *session)
{
    ...
    if ((ret = mbedtls_ssl_config_defaults(&session->conf, 1,
                                           0,
    ...
    mbedtls_ssl_conf_rng(&session->conf, mbedtls_hardware_random, 
# 405 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                 (0)
# 405 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                     );
    ...
    mbedtls_gmssl_conf_ca_chain(&session->conf, session->gm_srv_crt->next->next, 
# 416 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                                (0)
# 416 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                                    );
    ...
    mbedtls_ssl_conf_ca_chain(&session->conf, session->srv_crt->next, 
# 429 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                     (0)
# 429 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                         );
    ...
    mbedtls_ssl_session_reset(&session->ssl);
    mbedtls_ssl_set_bio(&session->ssl, &session->cli_fd, mbedtls_net_send, mbedtls_net_recv, 
# 442 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c" 3 4
                                                                                            (0)
# 442 "../../../packages/mbedtls-2.6.0/ports/src/tls_server.c"
                                                                                                );
...
int tls_srv_session_read(tls_srv_session *session, unsigned char *buf, size_t len)
{
    ...
    do {
        ...
        if (read_count == -0x6900 || read_count == -0x6880)
            continue;
