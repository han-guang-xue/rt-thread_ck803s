...
# 1 "<command-line>"
# 1 "../../../components/drivers/misc/pin.c"
# 25 "../../../components/drivers/misc/pin.c"
# 1 "../../../components/drivers/include/drivers/pin.h" 1
# 29 "../../../components/drivers/include/drivers/pin.h"
...
# 30 "../../../components/drivers/include/drivers/pin.h" 2
...
# 31 "../../../components/drivers/include/drivers/pin.h" 2
...
# 26 "../../../components/drivers/misc/pin.c" 2
...
# 29 "../../../components/drivers/misc/pin.c" 2
...
static rt_size_t _pin_write(rt_device_t dev, rt_off_t pos, const void *buffer, rt_size_t size)
{
    ...
    if (!(pin != (0))) { rt_assert_handler("pin != RT_NULL", __FUNCTION__, 53); };
...
static rt_err_t _pin_control(rt_device_t dev, int cmd, void *args)
{
    ...
    if (!(pin != (0))) { rt_assert_handler("pin != RT_NULL", __FUNCTION__, 69); };
...
# 91 "../../../components/drivers/misc/pin.c"
int rt_device_pin_register(const char *name, const struct rt_pin_ops *ops, void *user_data)
{
...
rt_err_t rt_pin_attach_irq(rt_int32_t pin, rt_uint32_t mode,
                             void (*hdr)(void *args), void *args)
{
    if (!(_hw_pin.ops != (0))) { rt_assert_handler("_hw_pin.ops != RT_NULL", __FUNCTION__, 120); };
...
rt_err_t rt_pin_detach_irq(rt_int32_t pin)
{
    if (!(_hw_pin.ops != (0))) { rt_assert_handler("_hw_pin.ops != RT_NULL", __FUNCTION__, 129); };
...
rt_err_t rt_pin_irq_enable(rt_base_t pin, rt_uint32_t enabled)
{
    if (!(_hw_pin.ops != (0))) { rt_assert_handler("_hw_pin.ops != RT_NULL", __FUNCTION__, 139); };
...
const char __fsym_pinMode_name[] __attribute__((section(".rodata.name"))) = "pinMode"; const char __fsym_pinMode_desc[] __attribute__((section(".rodata.name"))) = "set hardware pin mode"; const struct finsh_syscall __fsym_pinMode __attribute__((section("FSymTab")))= { __fsym_pinMode_name, __fsym_pinMode_desc, (syscall_func)&rt_pin_mode };;
...
const char __fsym_pinWrite_name[] __attribute__((section(".rodata.name"))) = "pinWrite"; const char __fsym_pinWrite_desc[] __attribute__((section(".rodata.name"))) = "write value to hardware pin"; const struct finsh_syscall __fsym_pinWrite __attribute__((section("FSymTab")))= { __fsym_pinWrite_name, __fsym_pinWrite_desc, (syscall_func)&rt_pin_write };;

int rt_pin_read(rt_base_t pin)
{
    if (!(_hw_pin.ops != (0))) { rt_assert_handler("_hw_pin.ops != RT_NULL", __FUNCTION__, 164); };
    return _hw_pin.ops->pin_read(&_hw_pin.parent, pin);
}
const char __fsym_pinRead_name[] __attribute__((section(".rodata.name"))) = "pinRead"; const char __fsym_pinRead_desc[] __attribute__((section(".rodata.name"))) = "read status from hardware pin"; const struct finsh_syscall __fsym_pinRead __attribute__((section("FSymTab")))= { __fsym_pinRead_name, __fsym_pinRead_desc, (syscall_func)&rt_pin_read };;
