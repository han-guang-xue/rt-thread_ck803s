...
# 1 "<command-line>"
# 1 "../../../components/dfs/src/dfs_posix.c"
# 26 "../../../components/dfs/src/dfs_posix.c"
...
# 27 "../../../components/dfs/src/dfs_posix.c" 2
...
# 28 "../../../components/dfs/src/dfs_posix.c" 2
...
# 29 "../../../components/dfs/src/dfs_posix.c" 2
# 45 "../../../components/dfs/src/dfs_posix.c"
int open(const char *file, int flags, ...)
{
    int fd, result;
    struct dfs_fd *d;
...
;
# 87 "../../../components/dfs/src/dfs_posix.c"
int close(int fd)
{
    int result;
    struct dfs_fd *d;
    ...
    d = fd_get(fd);
    if (d == 
# 93 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 93 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_set_errno(-9);
...
;
# 128 "../../../components/dfs/src/dfs_posix.c"
...

{
    ...
    d = fd_get(fd);
    if (d == 
# 138 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 138 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_set_errno(-9);
...
;
# 172 "../../../components/dfs/src/dfs_posix.c"
...

{
    ...
    d = fd_get(fd);
    if (d == 
# 182 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 182 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_set_errno(-9);
...
;
# 215 "../../../components/dfs/src/dfs_posix.c"
off_t __attribute__((section(".fast"))) lseek(int fd, off_t offset, int whence)
{
    ...
    d = fd_get(fd);
    if (d == 
# 221 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 221 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_set_errno(-9);
    ...
    {
    case 
# 230 "../../../components/dfs/src/dfs_posix.c" 3 4
        0
# 230 "../../../components/dfs/src/dfs_posix.c"
                :
        break;

    case 
# 233 "../../../components/dfs/src/dfs_posix.c" 3 4
        1
# 233 "../../../components/dfs/src/dfs_posix.c"
                :
        offset += d->pos;
        break;

    case 
# 237 "../../../components/dfs/src/dfs_posix.c" 3 4
        2
# 237 "../../../components/dfs/src/dfs_posix.c"
                :
        offset += d->size;
        break;
...
;
# 282 "../../../components/dfs/src/dfs_posix.c"
...
;
# 306 "../../../components/dfs/src/dfs_posix.c"
int unlink(const char *pathname)
{
    int result;
...
;
# 331 "../../../components/dfs/src/dfs_posix.c"
int stat(const char *file, struct stat *buf)
{
    int result;
...
;
# 355 "../../../components/dfs/src/dfs_posix.c"
int fstat(int fildes, struct stat *buf)
{
    struct dfs_fd *d;
    ...
    d = fd_get(fildes);
    if (d == 
# 361 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 361 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_set_errno(-9);
...
;
# 399 "../../../components/dfs/src/dfs_posix.c"
int __attribute__((section(".fast"))) fsync(int fildes)
{
    ...
    d = fd_get(fildes);
    if (d == 
# 406 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 406 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_set_errno(-9);
        return -1;
...
;
# 431 "../../../components/dfs/src/dfs_posix.c"
int fcntl(int fildes, int cmd, ...)
{
    int ret = -1;
    struct dfs_fd *d;
...
;
# 474 "../../../components/dfs/src/dfs_posix.c"
int ioctl(int fildes, int cmd, ...)
{
    void* arg;
    va_list ap;
...
;
# 497 "../../../components/dfs/src/dfs_posix.c"
int statfs(const char *path, struct statfs *buf)
{
    int result;
...
;
# 521 "../../../components/dfs/src/dfs_posix.c"
int mkdir(const char *path, mode_t mode)
{
    int fd;
    struct dfs_fd *d;
...
# 558 "../../../components/dfs/src/dfs_posix.c" 2
...
# 568 "../../../components/dfs/src/dfs_posix.c"
...
;
# 591 "../../../components/dfs/src/dfs_posix.c"
DIR *opendir(const char *name)
{
    struct dfs_fd *d;
    int fd, result;
    ...
    t = 
# 597 "../../../components/dfs/src/dfs_posix.c" 3 4
       (0)
# 597 "../../../components/dfs/src/dfs_posix.c"
           ;
    ...
    if (fd == -1)
    {
        ...
        return 
# 605 "../../../components/dfs/src/dfs_posix.c" 3 4
              (0)
# 605 "../../../components/dfs/src/dfs_posix.c"
                  ;
    }
    d = fd_get(fd);
    ...
    if (result >= 0)
    {
        ...
        if (t == 
# 614 "../../../components/dfs/src/dfs_posix.c" 3 4
                (0)
# 614 "../../../components/dfs/src/dfs_posix.c"
                    )
        {
            dfs_file_close(d);
            fd_put(d);
    ...
    return 
# 635 "../../../components/dfs/src/dfs_posix.c" 3 4
          (0)
# 635 "../../../components/dfs/src/dfs_posix.c"
              ;
}
;
# 648 "../../../components/dfs/src/dfs_posix.c"
struct dirent * __attribute__((section(".fast"))) readdir(DIR *d)
{
    ...
    fd = fd_get(d->fd);
    if (fd == 
# 654 "../../../components/dfs/src/dfs_posix.c" 3 4
             (0)
# 654 "../../../components/dfs/src/dfs_posix.c"
                 )
    {
        rt_set_errno(-9);
        return 
# 657 "../../../components/dfs/src/dfs_posix.c" 3 4
              (0)
# 657 "../../../components/dfs/src/dfs_posix.c"
                  ;
    }
    ...
    if (!d->num || d->cur >= d->num)
    {
        ...
        if (result <= 0)
        {
            ...
            return 
# 678 "../../../components/dfs/src/dfs_posix.c" 3 4
                  (0)
# 678 "../../../components/dfs/src/dfs_posix.c"
                      ;
        }
...
;
# 699 "../../../components/dfs/src/dfs_posix.c"
long telldir(DIR *d)
{
    struct dfs_fd *fd;
    long result;
    ...
    fd = fd_get(d->fd);
    if (fd == 
# 705 "../../../components/dfs/src/dfs_posix.c" 3 4
             (0)
# 705 "../../../components/dfs/src/dfs_posix.c"
                 )
    {
        rt_set_errno(-9);
...
;
# 726 "../../../components/dfs/src/dfs_posix.c"
void __attribute__((section(".fast"))) seekdir(DIR *d, off_t offset)
{
    ...
    fd = fd_get(d->fd);
    if (fd == 
# 731 "../../../components/dfs/src/dfs_posix.c" 3 4
             (0)
# 731 "../../../components/dfs/src/dfs_posix.c"
                 )
    {
        rt_set_errno(-9);
...
void rewinddir(DIR *d)
{
    ...
    fd = fd_get(d->fd);
    if (fd == 
# 756 "../../../components/dfs/src/dfs_posix.c" 3 4
             (0)
# 756 "../../../components/dfs/src/dfs_posix.c"
                 )
    {
        rt_set_errno(-9);
...
;
# 778 "../../../components/dfs/src/dfs_posix.c"
int closedir(DIR *d)
{
    int result;
    struct dfs_fd *fd;
    ...
    fd = fd_get(d->fd);
    if (fd == 
# 784 "../../../components/dfs/src/dfs_posix.c" 3 4
             (0)
# 784 "../../../components/dfs/src/dfs_posix.c"
                 )
    {
        rt_set_errno(-9);
...
;
# 817 "../../../components/dfs/src/dfs_posix.c"
int chdir(const char *path)
{
    char *fullpath;
    DIR *d;
    ...
    if (path == 
# 822 "../../../components/dfs/src/dfs_posix.c" 3 4
               (0)
# 822 "../../../components/dfs/src/dfs_posix.c"
                   )
    {
        dfs_lock();
        rt_kprintf("%s\n", working_directory);
...
# 838 "../../../components/dfs/src/dfs_posix.c" 3 4
                                 (0)
# 838 "../../../components/dfs/src/dfs_posix.c"
                                     , path);
    if (fullpath == 
# 839 "../../../components/dfs/src/dfs_posix.c" 3 4
                   (0)
# 839 "../../../components/dfs/src/dfs_posix.c"
                       )
    {
        rt_set_errno(-20);
    ...
    d = opendir(fullpath);
    if (d == 
# 848 "../../../components/dfs/src/dfs_posix.c" 3 4
            (0)
# 848 "../../../components/dfs/src/dfs_posix.c"
                )
    {
        rt_free(fullpath);
...
# 885 "../../../components/dfs/src/dfs_posix.c"
int access(const char *path, int amode)
{
    struct stat sb;
    if (stat(path, &sb) < 0)
...
# 904 "../../../components/dfs/src/dfs_posix.c"
