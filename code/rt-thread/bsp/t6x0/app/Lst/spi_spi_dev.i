...
# 25 "../../../components/drivers/spi/spi_dev.c" 2
...
# 26 "../../../components/drivers/spi/spi_dev.c" 2
                                      ...
                                      rt_size_t size)
{
    ...
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 36); };
    if (!(bus->owner != (0))) { rt_assert_handler("bus->owner != RT_NULL", __FUNCTION__, 37); };
                                       ...
                                       rt_size_t size)
{
    ...
    bus = (struct rt_spi_bus *)dev;
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 50); };
    if (!(bus->owner != (0))) { rt_assert_handler("bus->owner != RT_NULL", __FUNCTION__, 51); };
...
# 84 "../../../components/drivers/spi/spi_dev.c"
rt_err_t rt_spi_bus_device_init(struct rt_spi_bus *bus, const char *name)
{
    struct rt_device *device;
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 87); };
                                     ...
                                     rt_size_t size)
{
    ...
    if (!(device != (0))) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 118); };
    if (!(device->bus != (0))) { rt_assert_handler("device->bus != RT_NULL", __FUNCTION__, 119); };
                                      ...
                                      rt_size_t size)
{
    ...
    device = (struct rt_spi_device *)dev;
    if (!(device != (0))) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 132); };
    if (!(device->bus != (0))) { rt_assert_handler("device->bus != RT_NULL", __FUNCTION__, 133); };
...
# 165 "../../../components/drivers/spi/spi_dev.c"
rt_err_t rt_spidev_device_init(struct rt_spi_device *dev, const char *name)
{
    struct rt_device *device;
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 168); };
