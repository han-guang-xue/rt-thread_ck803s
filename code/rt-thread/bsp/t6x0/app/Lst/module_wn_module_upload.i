# 1 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
# 24 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 25 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 2
# 1 "../../../packages/webnet-2.0.0/inc/webnet.h" 1
# 51 "../../../packages/webnet-2.0.0/inc/webnet.h"
# 1 "../../../packages/mbedtls-2.6.0/ports/inc/tls_server.h" 1
# 23 "../../../packages/mbedtls-2.6.0/ports/inc/tls_server.h"
...
# 24 "../../../packages/mbedtls-2.6.0/ports/inc/tls_server.h" 2
...
# 25 "../../../packages/mbedtls-2.6.0/ports/inc/tls_server.h" 2
...
# 26 "../../../packages/mbedtls-2.6.0/ports/inc/tls_server.h" 2
...
# 27 "../../../packages/mbedtls-2.6.0/ports/inc/tls_server.h" 2

tls_srv_context* tls_srv_create(char *bind_host, char *bind_port, int suite_preset);
...
# 52 "../../../packages/webnet-2.0.0/inc/webnet.h" 2
# 100 "../../../packages/webnet-2.0.0/inc/webnet.h"
...
# 26 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 2
# 1 "../../../packages/webnet-2.0.0/inc/wn_module.h" 1
# 33 "../../../packages/webnet-2.0.0/inc/wn_module.h"
# 1 "../../../packages/webnet-2.0.0/inc/wn_session.h" 1
# 27 "../../../packages/webnet-2.0.0/inc/wn_session.h"
# 1 "../../../packages/webnet-2.0.0/inc/wn_request.h" 1
# 30 "../../../packages/webnet-2.0.0/inc/wn_request.h"
# 1 "../../../packages/webnet-2.0.0/inc/wn_session.h" 1
# 31 "../../../packages/webnet-2.0.0/inc/wn_request.h" 2
...
# 28 "../../../packages/webnet-2.0.0/inc/wn_session.h" 2
...
# 33 "../../../packages/webnet-2.0.0/inc/wn_session.h" 2



# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/net_sockets.h" 1
# 37 "../../../packages/webnet-2.0.0/inc/wn_session.h" 2
# 53 "../../../packages/webnet-2.0.0/inc/wn_session.h"
...
int webnet_sessions_set_fds(_types_fd_set *readset, _types_fd_set *writeset);
void webnet_sessions_handle_fds(_types_fd_set *readset, _types_fd_set *writeset);

void webnet_sessions_set_err_callback(void (*callback)(struct webnet_session *session));
# 34 "../../../packages/webnet-2.0.0/inc/wn_module.h" 2
# 56 "../../../packages/webnet-2.0.0/inc/wn_module.h"
...
# 27 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 2
# 1 "../../../packages/webnet-2.0.0/inc/wn_utils.h" 1
# 33 "../../../packages/webnet-2.0.0/inc/wn_utils.h"
...
# 28 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 2
...
# 36 "../../../components/dfs/include/dfs.h"
...
# 31 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 2
# 53 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
static const struct webnet_module_upload_entry **_upload_entries = (0);
...
# 88 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   __builtin_va_start(
# 88 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
   args
# 88 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   ,
# 88 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 88 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
    ...
    {
        match = 
# 91 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
               __builtin_va_arg(
# 91 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
               args
# 91 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
               ,
# 91 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 100 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   __builtin_va_end(
# 100 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
   args
# 100 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   )
# 100 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 137 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   __builtin_va_start(
# 137 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
   args
# 137 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   ,
# 137 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 137 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
    ...
    {
        index_str = 
# 141 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
                   __builtin_va_arg(
# 141 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
                   args
# 141 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
                   ,
# 141 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 144 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   __builtin_va_end(
# 144 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
   args
# 144 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   )
# 144 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
    ...
    substr = rt_malloc(total_size + 1);
    ptr = substr;
    
# 148 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   __builtin_va_start(
# 148 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
   args
# 148 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   ,
# 148 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 148 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
    ...
    {
        index_str = 
# 151 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
                   __builtin_va_arg(
# 151 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
                   args
# 151 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
                   ,
# 151 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
# 156 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   __builtin_va_end(
# 156 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
   args
# 156 "../../../packages/webnet-2.0.0/module/wn_module_upload.c" 3 4
   )
# 156 "../../../packages/webnet-2.0.0/module/wn_module_upload.c"
...
static char* _webnet_module_upload_parse_header(struct webnet_session* session, char* buffer, rt_size_t length)
{
    ...
    char *name = (0), *filename = (0), *content_type = (0);
    ...
    if (str_begin_with_strs(ptr, 3, "\r\n", upload_session->boundary, "--\r\n"))
    {
        ptr += (strlen(upload_session->boundary) + 6);
        return ptr;
    }

    if (str_begin_with_strs(ptr, 3, "\r\n", upload_session->boundary, "\r\n"))
        ptr += (strlen(upload_session->boundary) + 4);
    else if (str_begin_with_strs(ptr, 2, upload_session->boundary, "\r\n"))
        ptr += (strlen(upload_session->boundary) + 2);
    if (ptr == buffer) return (0);

    if (upload_session->filename != (0) &&
            upload_session->content_type != (0))
    {

        rt_free(upload_session->filename);
        rt_free(upload_session->content_type);

        upload_session->filename = (0);
        upload_session->content_type = (0);
    }
    ...
    while ((rt_uint32_t)ptr - (rt_uint32_t)buffer < length)
    {
        ...
        if (str_begin_with(ptr, "Content-Disposition:"))
        {
            ptr += sizeof("Content-Disposition:") - 1;
            while (*ptr == ' ') ptr ++;


            if (str_begin_with(ptr, "form-data"))
            {
                ptr += sizeof("form-data") - 1;
                while (*ptr == ' ' || *ptr == ';') ptr ++;


                if (str_begin_with(ptr, "name=\""))
                {
                    ptr += sizeof("name=\"") - 1;
                    name = ptr;
                ...
                if (str_begin_with(ptr, "filename=\""))
                {
        ...
        else if (str_begin_with(ptr, "Content-Type:"))
        {
            ptr += sizeof("Content-Type:") - 1;
            while (*ptr == ' ') ptr ++;

            content_type = ptr;
        }

        else if (str_begin_with(ptr, "Content-Range:"))
        {
            ptr += sizeof("Content-Range:") - 1;
            while (*ptr == ' ') ptr ++;
        }
        ...
        else if (str_begin_with(ptr, "\r\n"))
        {
            ...
            if (upload_session->content_type != (0))
            {
                rt_free(upload_session->content_type);
                upload_session->content_type = (0);
            }
            ...
            if (filename != (0))
            {
                upload_session->filename = rt_strdup(filename);
            }
            if (content_type != (0))
            {
                upload_session->content_type = rt_strdup(content_type);
            }
            if (name != (0))
            {

                if (upload_session->name_entries == (0))
                {
                    upload_session->name_entries_count = 1;
                    upload_session->name_entries = (struct webnet_upload_name_entry*)
                                                   rt_malloc(sizeof(struct webnet_upload_name_entry));
                }
                else
                {
                    upload_session->name_entries_count += 1;
                    upload_session->name_entries = (struct webnet_upload_name_entry*)
                                                   rt_realloc(upload_session->name_entries,
                                                           sizeof(struct webnet_upload_name_entry) * upload_session->name_entries_count);
                }

                upload_session->name_entries[upload_session->name_entries_count - 1].name = rt_strdup(name);
                upload_session->name_entries[upload_session->name_entries_count - 1].value = (0);
            }
...
static char* _next_possible_boundary(struct webnet_session* session, char* buffer, rt_size_t length)
{
    ...
    if (str_begin_with_strs(buffer, 2, "\r\n", upload_session->boundary)) return buffer;

    ptr = memstrs(buffer, length, 2, "\r\n", upload_session->boundary);
    if (ptr != (0)) return ptr;


    ptr = memrchr(buffer, '\r', length);
    if (ptr == (0) ) return (0);
    if (ptr - buffer == length - 1) return ptr;
    if (*(ptr + 1) == '\n' && ptr - buffer == length - 2) return (0);
...
static void _handle_section(struct webnet_session* session, char* buffer, rt_size_t length)
{
    ...
    else
    {
        ...
        if (ptr != (0))
        {
            ...
            (upload_session->name_entries[upload_session->name_entries_count - 1]).value = rt_malloc(value_size);
            memcpy((upload_session->name_entries[upload_session->name_entries_count - 1]).value, buffer, value_size - 1);
            (upload_session->name_entries[upload_session->name_entries_count - 1]).value[value_size - 1] = '\0';
        }
    }
}
...
static void _webnet_module_upload_handle(struct webnet_session* session, int event)
{
    ...
    if (memstrs((const char *)session->buffer, session->buffer_offset, 3, "\r\n", upload_session->boundary, "--\r\n"))
    {
    ...
    {
        if (str_begin_with_strs(upload_buffer, 3, "\r\n", upload_session->boundary, "--\r\n"))
        {
        ...
        if (end_ptr - upload_buffer < sizeof(session->buffer)/3 &&
                memstrs(upload_buffer, end_ptr - upload_buffer, 3, "\r\n", upload_session->boundary, "--\r\n") == (0))
        {
...
static void _webnet_module_upload_close(struct webnet_session* session)
{
    ...
    if (upload_session->content_type != (0))
        rt_free(upload_session->content_type);
    if (upload_session->boundary != (0))
        rt_free(upload_session->boundary);
    if (upload_session->entry != (0))
    {
        rt_uint32_t index;
        for (index = 0; index < upload_session->name_entries_count; index ++)
        {
            if (upload_session->name_entries[index].value != (0))
                rt_free(upload_session->name_entries[index].value);
            if (upload_session->name_entries[index].name != (0))
                rt_free(upload_session->name_entries[index].name);
        }
        rt_free(upload_session->name_entries);
        upload_session->name_entries = (0);
    }
    rt_free(upload_session);


    session->user_data = 0;
    session->session_ops = (0);
    session->session_phase = WEB_PHASE_CLOSE;
}
...
int webnet_module_upload_open(struct webnet_session* session)
{
    ...
    const struct webnet_module_upload_entry *entry = (0);
    struct webnet_module_upload_session *upload_session;
    ...
    upload_session = (struct webnet_module_upload_session*) rt_malloc (
                         sizeof (struct webnet_module_upload_session));
    if (upload_session == (0)) return 0;


    boundary = strstr(session->request->content_type, "boundary=");
    if (boundary != (0))
    {
        int boundary_size;


        boundary_size = strlen(boundary + sizeof("boundary=") - 1) + 3;
        upload_session->boundary = rt_malloc(boundary_size);
        rt_sprintf(upload_session->boundary, "--%s", boundary + sizeof("boundary=") - 1);
    }
    upload_session->filename = (0);
    upload_session->content_type = (0);
    upload_session->name_entries = (0);
    ...
    session->session_ops->session_handle(session, (1 << 6));
...
void webnet_upload_add(const struct webnet_module_upload_entry* entry)
{
    if (_upload_entries == (0))
    {
        _upload_entries_count = 1;


        _upload_entries = (const struct webnet_module_upload_entry**)
                          rt_malloc (sizeof(struct webnet_module_upload_entry));
    }
    else
    {
        _upload_entries_count += 1;
        _upload_entries = (const struct webnet_module_upload_entry**) rt_realloc (_upload_entries,
                          sizeof(void*) * _upload_entries_count);
    }
    if (!(_upload_entries != (0))) { rt_assert_handler("_upload_entries != RT_NULL", __FUNCTION__, 670); };
...
int webnet_upload_file_open(struct webnet_session* session)
{
    ...
    if (upload_session->filename != (0))
    {
        ...
        upload_session->user_data = open(upload_session->filename, 01, 0);
