# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
...
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 2
...
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 2
...
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 2





const struct dfs_filesystem_ops *filesystem_operation_table[4];
struct dfs_filesystem filesystem_table[4];
...
# 58 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
...
int dfs_init(void)
{
    ...
    rt_mutex_init(&fslock, "fslock", 0x00);
...

    {
        ...
        dfs_mount(
# 91 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                 (0)
# 91 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                     , "/dev", "devfs", 0, 0);
    }
...
const init_fn_t __rt_init_dfs_init __attribute__((section(".rti_fn.""2"))) = dfs_init;
...
void __attribute__((section(".fast"))) dfs_lock(void)
{
    rt_err_t result = -7;

    while (result == -7)
    {
        result = rt_mutex_take(&fslock, -1);
    }

    if (result != 0)
    {
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 115); };
    }
}
...
void __attribute__((section(".fast"))) dfs_unlock(void)
{
    rt_mutex_release(&fslock);
}

static int __attribute__((section(".fast"))) fd_alloc(struct dfs_fdtable *fdt, int startfd)
{
    int idx;
    ...
    if (idx == fdt->maxfd && fdt->maxfd < 12)
    {
        ...
        if (fds == 
# 153 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                  (0)
# 153 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                      ) goto __out;
        ...
        {
            fds[index] = 
# 158 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                        (0)
# 158 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                            ;
        }
    ...
    if (idx < fdt->maxfd &&fdt->fds[idx] == (0))
    {
        fdt->fds[idx] = rt_malloc(sizeof(struct dfs_fd));
        rt_memset(fdt->fds[idx], 0, sizeof(struct dfs_fd));
        if (fdt->fds[idx] == (0))
            idx = fdt->maxfd;
    }
...
# 222 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
struct dfs_fd * __attribute__((section(".fast"))) fd_get(int fd)
{
    struct dfs_fd *d;
    struct dfs_fdtable *fdt;
    ...
    if (fd < 0 || fd >= fdt->maxfd)
        return 
# 230 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
              (0)
# 230 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                  ;
    ...
    if (d->magic != 0xfdfd)
    {
        dfs_unlock();
        return 
# 239 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
              (0)
# 239 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                  ;
    }
...
void __attribute__((section(".fast"))) fd_put(struct dfs_fd *fd)
{
    if (!(fd != 
# 256 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
   (0)
# 256 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
   )) { rt_assert_handler("fd != NULL", __FUNCTION__, 256); };
...
# 291 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
int __attribute__((section(".fast"))) fd_is_open(const char *pathname)
{
    char *fullpath;
    unsigned int index;
...
# 300 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                                 (0)
# 300 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                                     , pathname);
    if (fullpath != 
# 301 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                   (0)
# 301 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                       )
    {
        char *mountpath;
        fs = dfs_filesystem_lookup(fullpath);
        if (fs == 
# 305 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                 (0)
# 305 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                     )
        {
        ...
        for (index = 0; index < fdt->maxfd; index++)
        {
            fd = fdt->fds[index];
            if (fd == 
# 324 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                     (0)
# 324 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                         ) continue;
...
# 351 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
const char *dfs_subdir(const char *directory, const char *filename)
{
    const char *dir;
    ...
    if (strlen(directory) == strlen(filename))
        return 
# 356 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
              (0)
# 356 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                  ;
...
;
# 377 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
char *dfs_normalize_path(const char *directory, const char *filename)
{
    char *fullpath;
    char *dst0, *dst, *src;
    ...
    if (!(filename != 
# 383 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
   (0)
# 383 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
   )) { rt_assert_handler("filename != NULL", __FUNCTION__, 383); };


    if (directory == 
# 386 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                    (0)
# 386 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                        )
        directory = &working_directory[0];
# 397 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
    if (filename[0] != '/')
    {
        fullpath = rt_malloc(strlen(directory) + strlen(filename) + 2);

        if (fullpath == 
# 401 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                       (0)
# 401 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                           )
            return 
# 402 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                  (0)
# 402 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                      ;
    ...
    {
        fullpath = rt_strdup(filename);

        if (fullpath == 
# 412 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                       (0)
# 412 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                           )
            return 
# 413 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                  (0)
# 413 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                      ;
    }
...
up_one:
        ...
        if (dst < dst0)
        {
            rt_free(fullpath);
            return 
# 478 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 3 4
                  (0)
# 478 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
                      ;
        }
...
struct dfs_fdtable* __attribute__((section(".fast"))) dfs_fdtable_get(void)
{
    struct dfs_fdtable *fdt;
# 517 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c"
    fdt = &_fdtab;
...
# 525 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/dfs.c" 2
int list_fd(void)
{
    int index;
    ...
    for (index = 0; index < fd_table->maxfd; index ++)
    {
        ...
        {
            rt_kprintf("%2d ", index);
            if (fd->type == 2) rt_kprintf("%-7.7s ", "dir");
            else if (fd->type == 0) rt_kprintf("%-7.7s ", "file");
            else if (fd->type == 1) rt_kprintf("%-7.7s ", "socket");
            else if (fd->type == 3) rt_kprintf("%-7.7s ", "user");
...
const char __fsym___cmd_list_fd_name[] __attribute__((section(".rodata.name"))) = "__cmd_list_fd"; const char __fsym___cmd_list_fd_desc[] __attribute__((section(".rodata.name"))) = "list file descriptor"; const struct finsh_syscall __fsym___cmd_list_fd __attribute__((section("FSymTab")))= { __fsym___cmd_list_fd_name, __fsym___cmd_list_fd_desc, (syscall_func)&list_fd };;
