...
int dfs_init(void)
{
...

    {
        ...
        dfs_mount(
# 91 "../../../components/dfs/src/dfs.c" 3 4
                 (0)
# 91 "../../../components/dfs/src/dfs.c"
                     , "/dev", "devfs", 0, 0);
    }
...
static int __attribute__((section(".fast"))) fd_alloc(struct dfs_fdtable *fdt, int startfd)
{
    ...
    if (idx == fdt->maxfd && fdt->maxfd < 12)
    {
        ...
        if (fds == 
# 153 "../../../components/dfs/src/dfs.c" 3 4
                  (0)
# 153 "../../../components/dfs/src/dfs.c"
                      ) goto __out;
        ...
        {
            fds[index] = 
# 158 "../../../components/dfs/src/dfs.c" 3 4
                        (0)
# 158 "../../../components/dfs/src/dfs.c"
                            ;
        }
...
struct dfs_fd * __attribute__((section(".fast"))) fd_get(int fd)
{
    ...
    if (fd < 0 || fd >= fdt->maxfd)
        return 
# 230 "../../../components/dfs/src/dfs.c" 3 4
              (0)
# 230 "../../../components/dfs/src/dfs.c"
                  ;
    ...
    if (d->magic != 0xfdfd)
    {
        dfs_unlock();
        return 
# 239 "../../../components/dfs/src/dfs.c" 3 4
              (0)
# 239 "../../../components/dfs/src/dfs.c"
                  ;
    }
...
{
    if (!(fd != 
# 256 "../../../components/dfs/src/dfs.c" 3 4
   (0)
# 256 "../../../components/dfs/src/dfs.c"
...
# 300 "../../../components/dfs/src/dfs.c" 3 4
                                 (0)
# 300 "../../../components/dfs/src/dfs.c"
                                     , pathname);
    if (fullpath != 
# 301 "../../../components/dfs/src/dfs.c" 3 4
                   (0)
# 301 "../../../components/dfs/src/dfs.c"
                       )
    {
        char *mountpath;
        fs = dfs_filesystem_lookup(fullpath);
        if (fs == 
# 305 "../../../components/dfs/src/dfs.c" 3 4
                 (0)
# 305 "../../../components/dfs/src/dfs.c"
                     )
        {
        ...
        for (index = 0; index < fdt->maxfd; index++)
        {
            fd = fdt->fds[index];
            if (fd == 
# 324 "../../../components/dfs/src/dfs.c" 3 4
                     (0)
# 324 "../../../components/dfs/src/dfs.c"
                         ) continue;
...
const char *dfs_subdir(const char *directory, const char *filename)
{
    ...
    if (strlen(directory) == strlen(filename))
        return 
# 356 "../../../components/dfs/src/dfs.c" 3 4
              (0)
# 356 "../../../components/dfs/src/dfs.c"
                  ;
...
char *dfs_normalize_path(const char *directory, const char *filename)
{
    ...
    if (!(filename != 
# 383 "../../../components/dfs/src/dfs.c" 3 4
   (0)
# 383 "../../../components/dfs/src/dfs.c"
   )) { rt_assert_handler("filename != NULL", __FUNCTION__, 383); };


    if (directory == 
# 386 "../../../components/dfs/src/dfs.c" 3 4
                    (0)
# 386 "../../../components/dfs/src/dfs.c"
                        )
        directory = &working_directory[0];
# 397 "../../../components/dfs/src/dfs.c"
    if (filename[0] != '/')
    {
        fullpath = rt_malloc(strlen(directory) + strlen(filename) + 2);

        if (fullpath == 
# 401 "../../../components/dfs/src/dfs.c" 3 4
                       (0)
# 401 "../../../components/dfs/src/dfs.c"
                           )
            return 
# 402 "../../../components/dfs/src/dfs.c" 3 4
                  (0)
# 402 "../../../components/dfs/src/dfs.c"
                      ;
    ...
    else
    {
        ...
        if (fullpath == 
# 412 "../../../components/dfs/src/dfs.c" 3 4
                       (0)
# 412 "../../../components/dfs/src/dfs.c"
                           )
            return 
# 413 "../../../components/dfs/src/dfs.c" 3 4
                  (0)
# 413 "../../../components/dfs/src/dfs.c"
                      ;
    }
...
up_one:
        ...
        if (dst < dst0)
        {
            rt_free(fullpath);
            return 
# 478 "../../../components/dfs/src/dfs.c" 3 4
                  (0)
# 478 "../../../components/dfs/src/dfs.c"
                      ;
        }
...
# 525 "../../../components/dfs/src/dfs.c" 2
int list_fd(void)
{
    int index;
