# 1 "../../../packages/webnet-2.0.0/src/wn_mimetype.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/src/wn_mimetype.c"
# 24 "../../../packages/webnet-2.0.0/src/wn_mimetype.c"
...
# 25 "../../../packages/webnet-2.0.0/src/wn_mimetype.c" 2
...
# 28 "../../../packages/webnet-2.0.0/src/wn_mimetype.c" 2
...
const char* mime_get_type(const char* url)
{
    ...
    while (mime_tables[index].name != (0))
    {
