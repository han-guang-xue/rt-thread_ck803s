# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
# 25 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
...
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2


# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/rsa.h" 1
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2


# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecp.h" 1
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2


# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdsa.h" 1
# 44 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 47 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 50 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
...
# 53 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c" 2
# 173 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
...
# 225 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
static int pk_group_from_specified( const mbedtls_asn1_buf *params, mbedtls_ecp_group *grp )
{
    ...
    end_field = p + len;
# 261 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    ...
    if( p != end_field )
        return( -0x3D00 +
                -0x0066 );
# 291 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
        return( ret );
...
# 442 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
...
# 481 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
...
# 508 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
...
# 546 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
                        ...
                        mbedtls_pk_context *pk )
{
    ...
    if( *p + len != end )
     ...
     if( ( pk_info = mbedtls_pk_info_from_type( MBEDTLS_PK_EC ) ) == ((void *)0) )
        return( -0x3C80 );
...
# 734 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
                                  ...
                                  size_t keylen )
{
    ...
    unsigned char *end2;
# 810 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
                                    ...
                                    size_t keylen )
{
    ...
    mbedtls_pk_type_t pk_alg = MBEDTLS_PK_NONE;
    const mbedtls_pk_info_t *pk_info;
# 942 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
                                    ...
                                    const unsigned char *pwd, size_t pwdlen )
{
    ...
    if( pwdlen == 0 )
        return( -0x3C00 );
# 1039 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
...
int mbedtls_gm_pk_parse_key( mbedtls_pk_context *pk,
                  const unsigned char *key, size_t keylen,
                  const unsigned char *pwd, size_t pwdlen )
{
    int ret;
    ...
    if( ret == 0 )
    {
        ...
        return( ret );
# 1263 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
                  ...
                  const unsigned char *pwd, size_t pwdlen )
{
    ...
    if( ret == 0 )
    {
        if( ( pk_info = mbedtls_pk_info_from_type( MBEDTLS_PK_ECKEY ) ) == ((void *)0) )
            return( -0x3C80 );
    ...
    if( ret == 0 )
    {
        ...
        return( ret );
# 1452 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkparse.c"
    if( ( ret = pk_parse_key_pkcs8_encrypted_der( pk, key, keylen,
                                                  pwd, pwdlen ) ) == 0 )
    {
        return( 0 );
