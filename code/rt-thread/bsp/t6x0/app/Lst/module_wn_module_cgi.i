# 1 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c"
# 24 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c"
...
# 25 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c" 2
...
# 27 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c" 2
...
# 28 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c" 2
...
# 29 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c" 2
...
# 32 "../../../packages/webnet-2.0.0/module/wn_module_cgi.c" 2
...
static char _cgi_root[64] = {0};
struct webnet_cgi_item
{
    const char* name;
    void (*handler)(struct webnet_session* session);
};
static struct webnet_cgi_item* _cgi_items = (0);
...
void webnet_cgi_set_root(const char* root)
{
    if (strlen(root) > 64)
    {
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 51); };
        return;
    }
...
void webnet_cgi_register(const char* name, void (*handler)(struct webnet_session* session))
{
    ...
    {
        _cgi_count = 1;
        _cgi_items = (struct webnet_cgi_item*) rt_malloc (sizeof(struct webnet_cgi_item) * _cgi_count);
    }
    else
    {
        _cgi_count += 1;
        _cgi_items = (struct webnet_cgi_item*) rt_realloc (_cgi_items, sizeof(struct webnet_cgi_item) * _cgi_count);
    }

    if (!(_cgi_items != (0))) { rt_assert_handler("_cgi_items != RT_NULL", __FUNCTION__, 77); };
...
int webnet_module_cgi(struct webnet_session* session, int event)
{
    ...
    else if (event == (1 << 1))
    {
        ...
        if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 100); };
