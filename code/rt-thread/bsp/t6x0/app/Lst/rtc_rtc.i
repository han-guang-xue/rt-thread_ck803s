# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c"
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c"
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c" 2
...
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c" 2
# 56 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c"
rt_err_t set_date(rt_uint32_t year, rt_uint32_t month, rt_uint32_t day)
{
    ...
    ret = rt_device_control(device, 0x11, &now);

    return ret;
}
# 106 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c"
...
int rt_rtc_ntp_sync_init(void)
{
    ...
    thread = rt_thread_create("ntp_sync", ntp_sync_thread_enrty, (0), 1536, 26, 2);
    if (thread)
    {
...
const init_fn_t __rt_init_rt_rtc_ntp_sync_init __attribute__((section(".rti_fn.""4"))) = rt_rtc_ntp_sync_init;
...
# 189 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c" 2
...
# 190 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/rtc.c" 2
...
const char __fsym_list_date_name[] __attribute__((section(".rodata.name"))) = "list_date"; const char __fsym_list_date_desc[] __attribute__((section(".rodata.name"))) = "show date and time."; const struct finsh_syscall __fsym_list_date __attribute__((section("FSymTab")))= { __fsym_list_date_name, __fsym_list_date_desc, (syscall_func)&list_date };

const char __fsym_set_date_name[] __attribute__((section(".rodata.name"))) = "set_date"; const char __fsym_set_date_desc[] __attribute__((section(".rodata.name"))) = "set date. e.g: set_date(2010,2,28)"; const struct finsh_syscall __fsym_set_date __attribute__((section("FSymTab")))= { __fsym_set_date_name, __fsym_set_date_desc, (syscall_func)&set_date };
const char __fsym_set_time_name[] __attribute__((section(".rodata.name"))) = "set_time"; const char __fsym_set_time_desc[] __attribute__((section(".rodata.name"))) = "set time. e.g: set_time(23,59,59)"; const struct finsh_syscall __fsym_set_time __attribute__((section("FSymTab")))= { __fsym_set_time_name, __fsym_set_time_desc, (syscall_func)&set_time };
...
const char __fsym___cmd_date_name[] __attribute__((section(".rodata.name"))) = "__cmd_date"; const char __fsym___cmd_date_desc[] __attribute__((section(".rodata.name"))) = "get date and time or set [year month day hour min sec]"; const struct finsh_syscall __fsym___cmd_date __attribute__((section("FSymTab")))= { __fsym___cmd_date_name, __fsym___cmd_date_desc, (syscall_func)&date };;
