# 1 "../../../components/net/lwip-2.0.2/src/core/raw.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/raw.c"
# 48 "../../../components/net/lwip-2.0.2/src/core/raw.c"
...
# 49 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 53 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 54 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 55 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 56 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/raw.h" 1
# 47 "../../../components/net/lwip-2.0.2/src/include/lwip/raw.h"
...
# 57 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 61 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 62 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
# 63 "../../../components/net/lwip-2.0.2/src/core/raw.c" 2
...
{
  (void)broadcast;
# 87 "../../../components/net/lwip-2.0.2/src/core/raw.c"
  if (1) {
    ...
    if (broadcast != 0) {
      ...
      {
        if ((((&pcb->local_ip)) == 
# 96 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
           0 
# 96 "../../../components/net/lwip-2.0.2/src/core/raw.c"
    ...
    if (((&pcb->local_ip) == 
# 103 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
       0 
# 103 "../../../components/net/lwip-2.0.2/src/core/raw.c"
       || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL))) ||
...
# 129 "../../../components/net/lwip-2.0.2/src/core/raw.c"
u8_t
__attribute__((section(".fast"))) raw_input(struct pbuf *p, struct netif *inp)
{
  ...
  (void)inp;
# 152 "../../../components/net/lwip-2.0.2/src/core/raw.c"
  {
  ...
  prev = 
# 157 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
        0
# 157 "../../../components/net/lwip-2.0.2/src/core/raw.c"
            ;
  pcb = raw_pcbs;


  while ((eaten == 0) && (pcb != 
# 161 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                                0
# 161 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                                    )) {
    if ((pcb->protocol == proto) && raw_input_match(pcb, broadcast)) {

      if (pcb->recv != 
# 164 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                      0
# 164 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                          ) {
        ...
        if (eaten != 0) {
          ...
          p = 
# 172 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
             0
# 172 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                 ;
          eaten = 1;
          if (prev != 
# 174 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                     0
# 174 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                         ) {
...
# 183 "../../../components/net/lwip-2.0.2/src/core/raw.c"
          ,
                                     184
# 183 "../../../components/net/lwip-2.0.2/src/core/raw.c"
          );}while(0); }} while(0)
...
# 211 "../../../components/net/lwip-2.0.2/src/core/raw.c"
err_t
raw_bind(struct raw_pcb *pcb, const ip_addr_t *ipaddr)
{
  if ((pcb == 
# 214 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
             0
# 214 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                 ) || (ipaddr == 
# 214 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                                 0
# 214 "../../../components/net/lwip-2.0.2/src/core/raw.c"
...
# 217 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
 0 
# 217 "../../../components/net/lwip-2.0.2/src/core/raw.c"
 ? 0 : (ipaddr)->addr));
  return ERR_OK;
}
# 235 "../../../components/net/lwip-2.0.2/src/core/raw.c"
err_t
raw_connect(struct raw_pcb *pcb, const ip_addr_t *ipaddr)
{
  if ((pcb == 
# 238 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
             0
# 238 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                 ) || (ipaddr == 
# 238 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                                 0
# 238 "../../../components/net/lwip-2.0.2/src/core/raw.c"
...
# 241 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
 0 
# 241 "../../../components/net/lwip-2.0.2/src/core/raw.c"
 ? 0 : (ipaddr)->addr));
  return ERR_OK;
}
# 256 "../../../components/net/lwip-2.0.2/src/core/raw.c"
void
...
# 277 "../../../components/net/lwip-2.0.2/src/core/raw.c"
err_t
__attribute__((section(".fast"))) raw_sendto(struct raw_pcb *pcb, struct pbuf *p, const ip_addr_t *ipaddr)
{
  ...
  if ((pcb == 
# 286 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
             0
# 286 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                 ) || (ipaddr == 
# 286 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                                 0
# 286 "../../../components/net/lwip-2.0.2/src/core/raw.c"
  ...
  if (pbuf_header(p, header_size)) {
    ...
    if (q == 
# 306 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
            0
# 306 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                ) {
      ;
      return ERR_MEM;
    }
    ...
    if (pbuf_header(q, -header_size)) {
      do { if (!(0)) { do {rt_kprintf("Can't restore header we just removed!"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/raw.c", 320);}while(0); }} while(0);
      return ERR_MEM;
    }
  }
  ...
  if (netif == 
# 332 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
              0
# 332 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                  ) {
    ;
    ;
  ...
  if (((&pcb->local_ip) == 
# 357 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
     0 
# 357 "../../../components/net/lwip-2.0.2/src/core/raw.c"
     || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL)))) {

    src_ip = (((netif) != 
# 359 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
            0
# 359 "../../../components/net/lwip-2.0.2/src/core/raw.c"
            ) ? ((const ip_addr_t*)&((netif)->ip_addr)) : 
# 359 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
            0
# 359 "../../../components/net/lwip-2.0.2/src/core/raw.c"
            );
# 368 "../../../components/net/lwip-2.0.2/src/core/raw.c"
  } else {

    src_ip = &pcb->local_ip;
  }
# 383 "../../../components/net/lwip-2.0.2/src/core/raw.c"
  ;
...
# 403 "../../../components/net/lwip-2.0.2/src/core/raw.c"
err_t
__attribute__((section(".fast"))) raw_send(struct raw_pcb *pcb, struct pbuf *p)
{
  return raw_sendto(pcb, p, &pcb->remote_ip);
}
# 418 "../../../components/net/lwip-2.0.2/src/core/raw.c"
void
...
# 428 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                                 0
# 428 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                                     ; pcb2 = pcb2->next) {

      if (pcb2->next != 
# 430 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                       0 
# 430 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                            && pcb2->next == pcb) {
...
# 451 "../../../components/net/lwip-2.0.2/src/core/raw.c"
struct raw_pcb *
raw_new(u8_t proto)
{
  struct raw_pcb *pcb;
  ...
  if (pcb != 
# 460 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
            0
# 460 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                ) {
...
# 486 "../../../components/net/lwip-2.0.2/src/core/raw.c"
struct raw_pcb *
...
void raw_netif_ip_addr_changed(const ip_addr_t* old_addr, const ip_addr_t* new_addr)
{
  ...
  if (!((old_addr) == 
# 511 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
      0 
# 511 "../../../components/net/lwip-2.0.2/src/core/raw.c"
...
# 512 "../../../components/net/lwip-2.0.2/src/core/raw.c" 3 4
                                 0
# 512 "../../../components/net/lwip-2.0.2/src/core/raw.c"
                                     ; rpcb = rpcb->next) {
