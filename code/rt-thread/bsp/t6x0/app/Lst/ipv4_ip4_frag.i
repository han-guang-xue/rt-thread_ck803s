# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
# 41 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
# 42 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 2



# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/ip4_frag.h" 1
# 42 "../../../components/net/lwip-2.0.2/src/include/lwip/ip4_frag.h"
...
# 46 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 2
...
# 48 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 2
...
# 51 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 2
# 97 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
# 114 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
# 130 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                                 0
# 130 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                                     ;

  r = reassdatagrams;
  while (r != 
# 133 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
             0
# 133 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                 ) {
...
# 163 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
static int
__attribute__((section(".fast"))) ip_reass_free_complete_datagram(struct ip_reassdata *ipr, struct ip_reassdata *prev)
{
  ...
  do { if (!(prev != ipr)) { do {rt_kprintf("prev != ipr"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 171);}while(0); }} while(0);
  if (prev != 
# 172 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
             0
# 172 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                 ) {
    do { if (!(prev->next == ipr)) { do {rt_kprintf("prev->next == ipr"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 173);}while(0); }} while(0);
  }
  ...
  if (iprh->start == 0) {
    ...
    clen = pbuf_clen(p);
    do { if (!(pbufs_freed + clen <= 0xffff)) { do {rt_kprintf("pbufs_freed + clen <= 0xffff"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 188);}while(0); }} while(0);
    pbufs_freed += clen;
    pbuf_free(p);
  }
  ...
  p = ipr->p;
  while (p != 
# 197 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
             0
# 197 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                 ) {
    struct pbuf *pcur;
    ...
    p = iprh->next_pbuf;
    clen = pbuf_clen(pcur);
    do { if (!(pbufs_freed + clen <= 0xffff)) { do {rt_kprintf("pbufs_freed + clen <= 0xffff"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 204);}while(0); }} while(0);
    pbufs_freed += clen;
    pbuf_free(pcur);
  }

  ip_reass_dequeue_datagram(ipr, prev);
  do { if (!(ip_reass_pbufcount >= pbufs_freed)) { do {rt_kprintf("ip_reass_pbufcount >= clen"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 210);}while(0); }} while(0);
  ip_reass_pbufcount -= pbufs_freed;

  return pbufs_freed;
}
# 226 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
static int
__attribute__((section(".fast"))) ip_reass_remove_oldest_datagram(struct ip_hdr *fraghdr, int pbufs_needed)
{
  ...
  do {
    oldest = 
# 239 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
            0
# 239 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                ;
    prev = 
# 240 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
          0
# 240 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
              ;
    oldest_prev = 
# 241 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                 0
# 241 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                     ;
    other_datagrams = 0;
    r = reassdatagrams;
    while (r != 
# 244 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
               0
# 244 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                   ) {
      if (!(((&(&r->iphdr)->src)->addr == (&(fraghdr)->src)->addr) && ((&(&r->iphdr)->dest)->addr == (&(fraghdr)->dest)->addr) && ((&r->iphdr)->_id) == ((fraghdr)->_id)) ? 1 : 0) {

        other_datagrams++;
        if (oldest == 
# 248 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                     0
# 248 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                         ) {
          oldest = r;
          oldest_prev = prev;
      ...
      if (r->next != 
# 257 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                    0
# 257 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                        ) {
        prev = r;
      }
      r = r->next;
    ...
    if (oldest != 
# 262 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                 0
# 262 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                     ) {
...
# 277 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
__attribute__((section(".fast"))) ip_reass_enqueue_new_datagram(struct ip_hdr *fraghdr, int clen)
{
  ...
  if (ipr == 
# 287 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
            0
# 287 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                ) {
    ...
    if (ipr == 
# 292 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
              0
# 292 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                  )

    {
      ...
      ;
      return 
# 297 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
            0
# 297 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                ;
    }
  }
...
__attribute__((section(".fast"))) ip_reass_dequeue_datagram(struct ip_reassdata *ipr, struct ip_reassdata *prev)
{
  ...
  if (reassdatagrams == ipr) {
    ...
    do { if (!(prev != 
# 325 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
   0
# 325 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
   )) { do {rt_kprintf("sanity check linked list"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 325);}while(0); }} while(0);
    prev->next = ipr->next;
  }
...
# 343 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
static int
...
# 346 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                                                     0
# 346 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                                                         ;
  struct pbuf *q;
  u16_t offset, len;
...
# 360 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
  ,
                                                       361
# 360 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
  );}while(0); }} while(0)
  ...
  iprh->next_pbuf = 
# 363 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                   0
# 363 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                       ;
  iprh->start = offset;
  iprh->end = offset + len;
  ...
  for (q = ipr->p; q != 
# 369 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                       0
# 369 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                           ;) {
    ...
    if (iprh->start < iprh_tmp->start) {
      ...
      iprh->next_pbuf = q;
      if (iprh_prev != 
# 374 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                      0
# 374 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                          ) {
      ...
      if (iprh_prev != 
# 409 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                      0
# 409 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                          ) {
  ...
  if (q == 
# 422 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
          0
# 422 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
              ) {
    if (iprh_prev != 
# 423 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                    0
# 423 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                        ) {



      do { if (!(iprh_prev->end <= iprh->start)) { do {rt_kprintf("check fragments don't overlap"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 427);}while(0); }} while(0);
      ...
      do { if (!(ipr->p == 
# 435 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
     0
# 435 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
# 435 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
  ...
  if (is_last || ((ipr->flags & 0x01) != 0)) {
    ...
    if (valid) {
      ...
      if ((ipr->p == 
# 450 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                    0
# 450 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
        ...
        q = iprh->next_pbuf;
        while (q != 
# 456 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                   0
# 456 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                       ) {
        ...
        if (valid) {
          do { if (!(ipr->p != 
# 468 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
         0
# 468 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
         )) { do {rt_kprintf("sanity check"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 468);}while(0); }} while(0);
          do { if (!(((struct ip_reass_helper*)ipr->p->payload) != iprh)) { do {rt_kprintf("sanity check"); sys_arch_assert(
                                                              "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
# 469 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
          ,
                                                              470
# 469 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
          );}while(0); }} while(0)
...
# 471 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
         0
# 471 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
# 542 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                                   0
# 542 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                                       ; ipr = ipr->next) {
  ...
  if (ipr == 
# 554 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
            0
# 554 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                ) {

    ipr = ip_reass_enqueue_new_datagram(fraghdr, clen);

    if (ipr == 
# 558 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
              0
# 558 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                  ) {
      goto nullreturn;
    }
  } else {
  ...
  if (valid == 1) {
    ...
    while (r != 
# 630 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
               0
# 630 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                   ) {
    ...
    if (ipr == reassdatagrams) {
      ipr_prev = 
# 641 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                0
# 641 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                    ;
    } else {
      for (ipr_prev = reassdatagrams; ipr_prev != 
# 643 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                                                 0
# 643 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
  ...
  ;
  return 
# 663 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
        0
# 663 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
            ;
...
nullreturn:
  ...
  pbuf_free(p);
  return 
# 669 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
        0
# 669 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
            ;
}
# 717 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
err_t
__attribute__((section(".fast"))) ip4_frag(struct pbuf *p, struct netif *netif, const ip4_addr_t *dest)
{
  ...
  do { if (!(((iphdr)->_v_hl & 0x0f) * 4 == 20)) { do {rt_kprintf("ip4_frag() does not support IP options"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 737);}while(0); return ERR_VAL;}} while(0);


  tmp = lwip_htons(((iphdr)->_offset));
  ofo = tmp & 0x1fffU;
  do { if (!((tmp & 0x2000U) == 0)) { do {rt_kprintf("ip_frag(): MF already set"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c", 742);}while(0); return ERR_VAL;}} while(0);
  ...
  while (left) {
    ...
    if (rambuf == 
# 752 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
                 0
# 752 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
                     ) {
      goto memerr;
    }
    do { if (!((rambuf->len == rambuf->tot_len) && (rambuf->next == 
# 755 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c" 3 4
   0
# 755 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
...
# 823 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
    ...
    (iphdr)->_chksum = (0);
# 842 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
    netif->output(netif, rambuf, dest);
    ;
# 852 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_frag.c"
    pbuf_free(rambuf);
    left -= fragsize;
    ofo += nfb;
  }
