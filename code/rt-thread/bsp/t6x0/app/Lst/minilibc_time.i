# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/time.c"
...
# 2 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/time.c" 2
...
# 3 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/time.c" 2
...
int __attribute__((section(".fast"))) __isleap(int year)
{
...
struct tm * __attribute__((section(".fast"))) gmtime_r(const time_t *timep, struct tm *r)
{
 time_t i;
...
struct tm* __attribute__((section(".fast"))) localtime_r(const time_t* t, struct tm* r)
{
 time_t tmp;
...
struct tm* __attribute__((section(".fast"))) localtime(const time_t* t)
{
 static struct tm tmp;
 return localtime_r(t, &tmp);
}

time_t __attribute__((section(".fast"))) mktime(struct tm * const t)
{
 register time_t day;
 register time_t i;
...
static void __attribute__((section(".fast"))) num2str(char *c, int i)
{
 c[0] = i / 10 + '0';
 c[1] = i % 10 + '0';
}

char * __attribute__((section(".fast"))) asctime_r(const struct tm *t, char *buf)
{
...
char * __attribute__((section(".fast"))) asctime(const struct tm *timeptr)
{
 static char buf[25];
 return asctime_r(timeptr, buf);
}

char * __attribute__((section(".fast"))) ctime(const time_t *timep)
{
 return asctime(localtime(timep));
}


int __attribute__((section(".fast"))) gettimeofday(struct timeval *tp, void *ignore)
{
 time_t time;
 rt_device_t device;
...
int __attribute__((section(".fast"))) _gettimeofday( struct timeval *tv, void *ignore)
{
    tv->tv_sec = 0;
    tv->tv_usec = 0;
    return 0;
}
# 245 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/time.c"
time_t __attribute__((section(".fast"))) time(time_t *t)

{
    ...
    if (device != (0))
    {
        ...
        {
            rt_device_control(device, 0x10, &time_now);
...
__attribute__((weak)) clock_t __attribute__((section(".fast"))) clock(void)
{
    return rt_tick_get();
}
