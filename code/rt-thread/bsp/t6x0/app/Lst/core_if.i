# 1 "../../../components/net/lwip-2.0.2/src/core/if.c"
...
# 2 "../../../components/net/lwip-2.0.2/src/core/if.c" 2
...
# 4 "../../../components/net/lwip-2.0.2/src/core/if.c" 2
...
unsigned int if_nametoindex(const char *ifname)
{
    ...
    if (ifname != 
# 13 "../../../components/net/lwip-2.0.2/src/core/if.c" 3 4
                 0
# 13 "../../../components/net/lwip-2.0.2/src/core/if.c"
                     ) {

        net_if = netif_find_nonum(ifname);
        if (net_if != 
# 16 "../../../components/net/lwip-2.0.2/src/core/if.c" 3 4
                     0
# 16 "../../../components/net/lwip-2.0.2/src/core/if.c"
                         ) {
...
char *if_indextoname(unsigned int if_index, char *ifname)
{
    ...
    if (net_if != 
# 36 "../../../components/net/lwip-2.0.2/src/core/if.c" 3 4
                 0
# 36 "../../../components/net/lwip-2.0.2/src/core/if.c"
                     ) {
        if (ifname != 
# 37 "../../../components/net/lwip-2.0.2/src/core/if.c" 3 4
                     0
# 37 "../../../components/net/lwip-2.0.2/src/core/if.c"
                         ) {
    ...
    return 
# 43 "../../../components/net/lwip-2.0.2/src/core/if.c" 3 4
          0
# 43 "../../../components/net/lwip-2.0.2/src/core/if.c"
              ;
}
