# 1 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
# 21 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
...
# 22 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
...
# 28 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2




# 1 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h" 1
# 32 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
...
# 33 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h" 2
# 65 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
typedef struct
{
    int fd;
}mbedtls_net_context;
...
# 93 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_connect( mbedtls_net_context *ctx, const char *host, const char *port, int proto );
# 112 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_bind( mbedtls_net_context *ctx, const char *bind_ip, const char *port, int proto );
# 129 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_accept( mbedtls_net_context *bind_ctx,
                        mbedtls_net_context *client_ctx,
                        void *client_ip, size_t buf_size, size_t *ip_len );
# 140 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_set_block( mbedtls_net_context *ctx );
# 149 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_set_nonblock( mbedtls_net_context *ctx );
# 159 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
void mbedtls_net_usleep( unsigned long usec );
# 173 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_recv( void *ctx, unsigned char *buf, size_t len );
# 187 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
int mbedtls_net_send( void *ctx, const unsigned char *buf, size_t len );
# 210 "../../../packages/mbedtls-2.6.0/ports/inc/tls_net.h"
...
# 33 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
...
# 35 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
# 62 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
...
# 63 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
...
# 64 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
...
int getaddrinfo(const char *nodename,
       ...
       const struct addrinfo *hints,
       struct addrinfo **res);
# 65 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
...
# 66 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
# 103 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
...
# 104 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 2
# 112 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"

# 112 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
static int net_prepare( void )
{
# 130 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
    return( 0 );
}
...
int mbedtls_net_bind( mbedtls_net_context *ctx, const char *bind_ip, const char *port, int proto )
{
    ...
    for( cur = addr_list; cur != ((void *)0); cur = cur->ai_next )
    {
        ...
        n = 1;
        if( setsockopt( ctx->fd, 0xfff, 0x0004,
...
# 279 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
static int net_would_block( const mbedtls_net_context *ctx )
{
# 299 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
    if( ( fcntl( ctx->fd, 
# 299 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 3 4
                         3
# 299 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
                                ) & 
# 299 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c" 3 4
                        ...
                        void *client_ip, size_t buf_size, size_t *ip_len )
{
    ...
    else
    {
        ...
        ret = (int) recvfrom( bind_ctx->fd, buf, sizeof( buf ), 0x01,
                        (struct sockaddr *) &client_addr, &n );
# 359 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
    }
...
int net_set_block(int fd)
{
    ...
    long n = 0;
    return (ioctlsocket(fd, ( ((1U)<<30) | ((('f'))<<8) | ((126)) | ((sizeof(int))<<16) ), &n));
...
int mbedtls_net_recv( void *ctx, unsigned char *buf, size_t len )
{
    ...
    if( ret < 0 )
    {
        ...
        if( *_rt_errno() == 4 )
            return( -0x6900 );
# 512 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
        return( -0x004C );
    }
...
int mbedtls_net_send( void *ctx, const unsigned char *buf, size_t len )
{
    ...
    if( ret < 0 )
    {
        ...
        if( *_rt_errno() == 4 )
            return( -0x6900 );
# 597 "../../../packages/mbedtls-2.6.0/ports/src/tls_net.c"
        return( -0x004E );
    }
