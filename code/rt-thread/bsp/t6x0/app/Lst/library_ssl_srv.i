# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 25 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
# 39 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ssl.h" 1
# 40 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
...
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
...
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pk.h" 1
# 43 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
...
# 45 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2


# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecp.h" 1
# 48 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c" 2
# 56 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                     ...
                                     size_t len )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 101, "parse ServerName extension" );

    servername_list_size = ( ( buf[0] << 8 ) | ( buf[1] ) );
    if( servername_list_size + 2 != len )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 106, "bad client hello message" );
    ...
    while( servername_list_size > 0 )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 118, "bad client hello message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            50 );
            return( -0x7900 );
        }
        ...
        if( p[0] == 0 )
        {
            ...
            if( ret != 0 )
            {
                mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 130, "ssl_sni_wrapper", ret );
                mbedtls_ssl_send_alert_message( ssl, 2,
                        112 );
                return( -0x7900 );
            }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 144, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        47 );
        return( -0x7900 );
    }
                                         ...
                                         size_t len )
{
    ...
    if( ssl->renego_status != 0 )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 167, "non-matching renegotiation info" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            40 );
            return( -0x7900 );
        }
...

    {
        if( len != 1 || buf[0] != 0x0 )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 178, "non-zero length renegotiation info" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            40 );
            return( -0x7900 );
        }
...
# 205 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                               ...
                                               size_t len )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 221, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
# 236 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    for( p = buf + 2; p < end; p += 2 )
    {
        ...
        if( ( sig_cur = mbedtls_ssl_pk_alg_from_sig( p[1] ) ) == MBEDTLS_PK_NONE )
        {
            mbedtls_debug_print_msg( ssl, 3,
                                                                               "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 242 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                               243
# 242 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "client hello v3, signature_algorithm ext" " unknown sig alg encoding %d", p[1] )
                                                                                ;
            continue;
        }
        ...
        if( md_cur == MBEDTLS_MD_NONE )
        {
            mbedtls_debug_print_msg( ssl, 3,
                                                                                "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 251 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                                252
# 251 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "client hello v3, signature_algorithm ext:" " unknown hash alg encoding %d", p[0] )
                                                                                 ;
            continue;
        }
        ...
        if( mbedtls_ssl_check_sig_hash( ssl, md_cur ) == 0 )
        {
            ...
            mbedtls_debug_print_msg( ssl, 3,
                                                          ...
                                                          "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 259 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,

                                                          261
# 259 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "client hello v3, signature_algorithm ext:" " match sig %d and hash %d", sig_cur, md_cur )
        ...
        else
        {
            mbedtls_debug_print_msg( ssl, 3,
                                                                              "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 265 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                              266
# 265 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "client hello v3, signature_algorithm ext: " "hash alg %d not supported", md_cur )
                                                                               ;
        }
    }
                                                ...
                                                size_t len )
{
    ...
    if( list_size + 2 != len ||
        list_size % 2 != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 289, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 298, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
                                              ...
                                              size_t len )
{
    ...
    if( list_size + 1 != len )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 347, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
    ...
    while( list_size > 0 )
    {
            ...
            p[0] == 1 )
        {
            ...
            mbedtls_debug_print_msg( ssl, 4, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 365, "point format selected: %d", p[0] );
            return( 0 );
        }
...
# 408 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                              ...
                                              size_t len )
{
    if( len != 1 || buf[0] >= 5 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 414, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        47 );
        return( -0x7900 );
    }
                                         ...
                                         size_t len )
{
    if( len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 433, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
                                      ...
                                      size_t len )
{
    if( len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 455, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
                                      ...
                                      size_t len )
{
    if( len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 480, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
                                         ...
                                         size_t len )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 517, "ticket length: %d", len );
    ...
    if( ssl->renego_status != 0 )
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 525, "ticket rejected: renegotiating" );
        return( 0 );
    }
                                           ...
                                           buf, len ) ) != 0 )
    {
        ...
        if( ret == -0x7180 )
            mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 539, "ticket is not authentic" );
        else if( ret == -0x6D80 )
            mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 541, "ticket is expired" );
        else
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 543, "mbedtls_ssl_ticket_parse", ret );
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 561, "session successfully restored from ticket" );
                               ...
                               const unsigned char *buf, size_t len )
{
    ...
    if( ssl->conf->alpn_list == ((void *)0) )
        return( 0 );
# 593 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( len < 4 )
    {
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
...
# 661 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                          ...
                          const mbedtls_ssl_ciphersuite_t * ciphersuite_info )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 708, "ciphersuite requires certificate" );

    if( list == ((void *)0) )
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 712, "server has no certificate" );
        return( -1 );
    }

    for( cur = list; cur != ((void *)0); cur = cur->next )
    {
        mbedtls_debug_print_crt( ssl, 3,
                                    "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 718 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                    719
# 718 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        {
            mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 723, "certificate mismatch: key type" );
            continue;
        }
# 735 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        if( mbedtls_ssl_check_cert_usage( cur->cert, ciphersuite_info,
                                  1, &flags ) != 0 )
        {
            mbedtls_debug_print_msg( ssl, 3,
                                                                   "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 738 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                   739
# 738 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        {
            mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 747, "certificate mismatch: elliptic curve" );
            continue;
        }
            ...
            cur->cert->sig_md != MBEDTLS_MD_SHA1 )
        {
                ...
                fallback = cur;
            {
                mbedtls_debug_print_msg( ssl, 3,
                                                                      "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 763 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                ,
                                                                      764
# 763 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    if( cur != ((void *)0) )
    {
        ...
        mbedtls_debug_print_crt( ssl, 3,
                                                         "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 780 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                                         781
# 780 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                  ...
                                  const mbedtls_ssl_ciphersuite_t **ciphersuite_info )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 806, "should never happen" );
        return( -0x6C00 );
    }

    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 810, "trying ciphersuite: %s", suite_info->name );

    if( suite_info->min_minor_ver > ssl->minor_ver ||
        suite_info->max_minor_ver < ssl->minor_ver )
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 815, "ciphersuite mismatch: version" );
        return( 0 );
    }
    ...
    if( ssl->conf->transport == 1 &&
        ...
        return( 0 );
# 846 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
          ...
          ssl->handshake->curves[0] == ((void *)0) ) )
    {
        mbedtls_debug_print_msg( ssl, 3,
                                                         "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 850 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                                         851
# 850 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    if( mbedtls_ssl_ciphersuite_uses_psk( suite_info ) &&
        ssl->conf->f_psk == ((void *)0) &&
        ( ssl->conf->psk == ((void *)0) || ssl->conf->psk_identity == ((void *)0) ||
          ssl->conf->psk_identity_len == 0 || ssl->conf->psk_len == 0 ) )
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 864, "ciphersuite mismatch: no pre-shared key" );
        return( 0 );
    }
    ...
    if( ssl->minor_ver == 3 )
    {
            ...
            mbedtls_ssl_sig_hash_set_find( &ssl->handshake->hash_algs, sig_type ) == MBEDTLS_MD_NONE )
        {
            mbedtls_debug_print_msg( ssl, 3,
                                                                                 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 879 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                                 880
# 879 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "ciphersuite mismatch: no suitable hash algorithm " "for signature algorithm %d", sig_type )
                                                                                  ;
            return( 0 );
        }
    }
# 896 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ssl_pick_cert( ssl, suite_info ) != 0 )
    {
        mbedtls_debug_print_msg( ssl, 3,
                                                        "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 898 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                                        899
# 898 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
# 1174 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
static int ssl_parse_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1201, "=> parse client hello" );
...
read_record_header:
...

    {
        if( ( ret = mbedtls_ssl_fetch_input( ssl, 5 ) ) != 0 )
        {
            ...
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1218, "mbedtls_ssl_fetch_input", ret );
            return( ret );
        }
    }

    buf = ssl->in_hdr;
# 1233 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    mbedtls_debug_print_buf( ssl, 4, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1233, "record header", buf, mbedtls_ssl_hdr_len( ssl ) );
# 1244 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    mbedtls_debug_print_msg( ssl, 3,
                            "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1244 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
...
# 1244 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    if( buf[0] != 22 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1249, "bad client hello message" );
        return( -0x7900 );
    }

    mbedtls_debug_print_msg( ssl, 3,
                                                              "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1253 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                              1254
# 1253 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    mbedtls_debug_print_msg( ssl, 3,
                                    "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1256 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                    1257
# 1256 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    if( major < 3 )
    {
        ...
        if( ssl->protocol != 0 )
        {
            ...
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1282, "bad client hello message" );
            return( -0x7900 );
        ...
        )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1301, "bad client hello message" );
            return( -0x7900 );
        }
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1310, "replayed record, discarding" );
...

    {
        if( msg_len > 8192 )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1335, "bad client hello message" );
            return( -0x7900 );
        }
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1342, "mbedtls_ssl_fetch_input", ret );
            return( ret );
        }
    ...
    mbedtls_debug_print_buf( ssl, 4, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1357, "record contents", buf, msg_len );

    ssl->handshake->update_checksum( ssl, buf, msg_len );
# 1369 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( msg_len < mbedtls_ssl_hs_hdr_len( ssl ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1371, "bad client hello message" );
        return( -0x7900 );
    }

    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1375, "client hello v3, handshake type: %d", buf[0] );

    if( buf[0] != 1 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1379, "bad client hello message" );
        return( -0x7900 );
    }

    mbedtls_debug_print_msg( ssl, 3,
                                                                 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1383 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                                 1384
# 1383 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1390, "bad client hello message" );
        return( -0x7900 );
    }
        ...
        if( ssl->renego_status == 1 )
        {
            ...
            if( cli_msg_seq != ssl->handshake->in_msg_seq )
            {
                mbedtls_debug_print_msg( ssl, 1,
                                                                 ...
                                                                 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1410 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                ,

                                                                 1412
# 1410 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                , "bad client hello message_seq: " "%d (expected %d)", cli_msg_seq, ssl->handshake->in_msg_seq )
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1434, "ClientHello fragmentation not supported" );
            return( -0x7080 );
        }
    }
...
# 1464 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( msg_len < 38 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1466, "bad client hello message" );
        return( -0x7900 );
    }
    ...
    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1473, "client hello, version", buf, 2 );
        ...
        ssl->minor_ver < ssl->conf->min_minor_ver )
    {
        ...
        if( ssl->major_ver == 1 && ssl->minor_ver == 1 ){
            ...
            mbedtls_debug_print_msg( ssl, 1,
                                                                                     ...
                                                                                     "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1489 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
...
# 1489 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1512, "client hello, random bytes", buf + 2, 32 );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1524, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }

    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1530, "client hello, session id", buf + 35, sess_len );
    ...
    if( ssl->conf->transport == 1 )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1549, "bad client hello message" );
            mbedtls_ssl_send_alert_message( ssl, 2,
                                            70 );
            return( -0x7900 );
        }
        ...
        mbedtls_debug_print_buf( ssl, 3,
                                                           "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1555 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                                           1556
# 1555 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ...
            )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1569, "cookie verification failed" );
                ssl->handshake->verify_cookie_len = 1;
            }
            else
            {
                mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1574, "cookie verification passed" );
...

        {
            ...
            if( cookie_len != 0 )
            {
                ...
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1585, "bad client hello message" );
                return( -0x7900 );
            }

            mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1589, "cookie verification skipped" );
        }
    ...
    if( ciph_len < 2 ||
        ...
        ( ciph_len % 2 ) != 0 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1608, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
    ...
    mbedtls_debug_print_buf( ssl, 3,
                                                    "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1614 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                    1615
# 1614 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1628, "bad client hello message" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
        return( -0x7900 );
    }
    ...
    mbedtls_debug_print_buf( ssl, 3,
                                                      "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1634 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                      1635
# 1634 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
# 1651 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ssl->conf->transport == 1 )
        ssl->session_negotiate->compression = 0;
# 1663 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ext_offset = comp_offset + 1 + comp_len;
        if( msg_len > ext_offset )
        {
            if( msg_len < ext_offset + 2 )
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1668, "bad client hello message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                50 );
                return( -0x7900 );
            }
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1680, "bad client hello message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                50 );
                return( -0x7900 );
            }
        ...
        mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1690, "client hello extensions", ext, ext_len );
        ...
        while( ext_len != 0 )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1701, "bad client hello message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                50 );
                return( -0x7900 );
            }
            ...
            case 0:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1710, "found ServerName extension" );
            ...
            case 0xFF01:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1721, "found renegotiation extension" );
            ...
            case 13:
                    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1734, "found signature_algorithms extension" );
            ...
            case 10:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1751, "found supported elliptic curves extension" );
            ...
            case 11:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1759, "found supported point formats extension" );
                ...
                if( ret != 0 )
                    return( ret );
                break;
# 1780 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            case 1:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1781, "found max fragment length extension" );
            ...
            case 4:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1791, "found truncated hmac extension" );
            ...
            case 22:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1801, "found encrypt then mac extension" );
            ...
            case 0x0017:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1811, "found extended master secret extension" );
            ...
            case 35:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1821, "found session ticket extension" );
            ...
            case 16:
                mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1831, "found alpn extension" );
            ...
            default:
                mbedtls_debug_print_msg( ssl, 3,
                                        "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1840 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                ,
                                        1841
# 1840 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ...
            if( ext_len > 0 && ext_len < 4 )
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1849, "bad client hello message" );
                mbedtls_ssl_send_alert_message( ssl, 2,
                                                50 );
                return( -0x7900 );
            }
    ...
    for( i = 0, p = buf + ciph_offset + 2; i < ciph_len; i += 2, p += 2 )
    {
        ...
        {
            mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1865, "received FALLBACK_SCSV" );

            if( ssl->minor_ver < ssl->conf->max_minor_ver )
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1869, "inapropriate fallback" );
...
# 1889 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    for( i = 0, p = buf + ciph_offset + 2; i < ciph_len; i += 2, p += 2 )
    {
        if( p[0] == 0 && p[1] == 0xFF )
        {
            mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1909, "received TLS_EMPTY_RENEGOTIATION_INFO " );

            if( ssl->renego_status == 1 )
            {
                mbedtls_debug_print_msg( ssl, 1,
                                                                     "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 1913 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                ,
                                                                     1914
# 1913 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1931, "legacy renegotiation, breaking off handshake" );
        handshake_failure = 1;
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1939, "renegotiation_info extension missing (secure)" );
        handshake_failure = 1;
    }
    else if( ssl->renego_status == 1 &&
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1946, "legacy renegotiation not allowed" );
        handshake_failure = 1;
    }
    else if( ssl->renego_status == 1 &&
             ssl->secure_renegotiation == 0 &&
             renegotiation_info_seen == 1 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 1953, "renegotiation_info extension present (legacy)" );
        handshake_failure = 1;
    }
...
# 2024 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    if( got_common_suite )
    {
        mbedtls_debug_print_msg( ssl, 1,
                                                        "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2045 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                                        2046
# 2045 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2053, "got no ciphersuites in common" );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        40 );
        return( -0x7380 );
    }
...
have_ciphersuite:
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2060, "selected ciphersuite: %s", ciphersuite_info->name );
    ...
    if( ssl->minor_ver == 3 )
    {
        ...
        if( sig_alg != MBEDTLS_PK_NONE )
        {
            ...
            mbedtls_debug_print_msg( ssl, 3,
                                                                                 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2083 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                                 2084
# 2083 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        else
        {
            mbedtls_debug_print_msg( ssl, 3,
                                                                            "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2088 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                                            2089
# 2088 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "no hash algorithm for signature algorithm " "%d - should not happen", sig_alg )
                                                                             ;
        }
    }


    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2094, "<= parse client hello" );
                                          ...
                                          size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2112, "server hello, adding truncated hmac extension" );
                                            ...
                                            size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2155, "server hello, adding encrypt then mac extension" );
                                       ...
                                       size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3,
                                      "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2181 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                      2182
# 2181 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                          ...
                                          size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2207, "server hello, adding session ticket extension" );
                                         ...
                                         size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2231, "server hello, secure renegotiation extension" );
                                               ...
                                               size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2272, "server hello, max_fragment_length extension" );
                                                   ...
                                                   size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2302, "server hello, supported_point_formats extension" );
...
# 2362 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                ...
                                unsigned char *buf, size_t *olen )
{
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2371, "server hello, adding alpn extension" );
# 2380 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
static int ssl_write_hello_verify_request( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2404, "=> write hello verify request" );
# 2415 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    mbedtls_ssl_write_version( ssl->major_ver, ssl->minor_ver,
                       ssl->conf->transport, p );
    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2417, "server version", p, 2 );
    p += 2;


    if( ssl->conf->f_cookie_write == ((void *)0) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2423, "inconsistent cookie callbacks" );
        return( -0x6C00 );
    }
    ...
    if( ( ret = ssl->conf->f_cookie_write( ssl->conf->p_cookie,
                                     &p, ssl->out_buf + ( 8192 + 0 + 29 + 32 + 256 ),
                                     ssl->cli_id, ssl->cli_id_len ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2434, "f_cookie_write", ret );
        return( ret );
    }

    *cookie_len_byte = (unsigned char)( p - ( cookie_len_byte + 1 ) );

    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2440, "cookie sent", cookie_len_byte + 1, *cookie_len_byte );
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2450, "mbedtls_ssl_write_record", ret );
        return( ret );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2454, "<= write hello verify request" );
...
static int ssl_write_server_hello( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2469, "=> write server hello" );


    if( ssl->conf->transport == 1 &&
        ssl->handshake->verify_cookie_len != 0 )
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2475, "client hello was not authenticated" );
        mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2476, "<= write server hello" );
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2484, "no RNG provided" );
        return( -0x7400 );
    }
# 2495 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    buf = ssl->out_msg;
    p = buf + 4;
    ...
    mbedtls_debug_print_msg( ssl, 3,
                                         "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2502 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                         2503
# 2502 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    *p++ = (unsigned char)( t );
    ...
    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2512, "server hello, current time: %lu", t );
    ...
    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2527, "server hello, random bytes", buf + 6, 32 );
    ...
    {
        mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2542, "session successfully restored from cache" );
        ssl->handshake->resume = 1;
    }
    ...
    else
    {
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2583, "mbedtls_ssl_derive_keys", ret );
            return( ret );
        }
    }
# 2596 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    *p++ = (unsigned char) ssl->session_negotiate->id_len;
    memcpy( p, ssl->session_negotiate->id, ssl->session_negotiate->id_len );
    p += ssl->session_negotiate->id_len;

    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2600, "server hello, session id len.: %d", n );
    mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2601, "server hello, session id", buf + 39, n );
    mbedtls_debug_print_msg( ssl, 3,
                                                         "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2602 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                         2603
# 2602 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    *p++ = (unsigned char)( ssl->session_negotiate->compression );
    ...
    mbedtls_debug_print_msg( ssl, 3,
                                                                                     "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2609 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                                                     2610
# 2609 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    mbedtls_debug_print_msg( ssl, 3,
                                                         "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 2611 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ,
                                                         2612
# 2611 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    , "server hello, compress alg.: 0x%02X", ssl->session_negotiate->compression )
                                                          ;
# 2624 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ssl->protocol != 0 )
    {
    ...
    ext_len += olen;
# 2668 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ssl_write_alpn_ext( ssl, p + 2 + ext_len, &olen );
    ext_len += olen;


    mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2672, "server hello, total extension length: %d", ext_len );
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2694, "<= write server hello" );

    return( ret );
}
# 2727 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
static int ssl_write_certificate_request( mbedtls_ssl_context *ssl )
{
    ...
    unsigned char *buf, *p;
    const unsigned char * const end = ssl->out_msg + 8192;
    const mbedtls_x509_crt *crt;
    int authmode;

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2739, "=> write certificate request" );
    ...
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_PSK ||
        ...
        authmode == 0 )
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2757, "<= skip write certificate request" );
        return( 0 );
    }
# 2773 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    buf = ssl->out_msg;
    p = buf + 4;
    ...
    sa_len = 0;
# 2809 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ssl->minor_ver == 3 )
    {
        const int *cur;
    ...
    if( ssl->conf->cert_req_ca_list == 1 )
    {
        ...
        while( crt != ((void *)0) && crt->version != 0 )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2872, "skipping CAs: buffer too short" );
                break;
            }
            ...
            *p++ = (unsigned char)( dn_size );
            ...
            mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2881, "requested DN", p - dn_size, dn_size );
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2896, "<= write certificate request" );

    return( ret );
}
# 2909 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
static int ssl_get_ecdh_params_from_cert( mbedtls_ssl_context *ssl )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2915, "server key not ECDH capable" );
        return( -0x6D00 );
    }
    ...
    if( ( ret = mbedtls_ecdh_get_params( &ssl->handshake->ecdh_ctx,
                                 ...
                                 MBEDTLS_ECDH_OURS ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2923, ( "mbedtls_ecdh_get_params" ), ret );
        return( ret );
    }
...
static int ssl_write_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2948, "=> write server key exchange" );
# 2960 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 2971, "<= skip write server key exchange" );
        ssl->state++;
        return( 0 );
    }
# 3011 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
# 3077 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( mbedtls_ssl_ciphersuite_uses_ecdhe( ciphersuite_info ) )
    {
# 3087 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
...
curve_matching_done:
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3099, "no matching curve for ECDHE" );
            return( -0x7380 );
        }

        mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3103, "ECDHE curve: %s", (*curve)->name );

        if( ( ret = mbedtls_ecp_group_load( &ssl->handshake->ecdh_ctx.grp,
                                       (*curve)->grp_id ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3108, "mbedtls_ecp_group_load", ret );
            return( ret );
        }
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3116, "mbedtls_ecdh_make_params", ret );
            return( ret );
        }
        ...
        mbedtls_debug_print_ecp( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3128, "ECDH: Q ", &ssl->handshake->ecdh_ctx.Q );
    }
# 3144 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ssl->protocol == 0 )
    {

        mbedtls_x509_crt *cur = ssl->conf->gm_key_cert->cert;
        ...
        while( cur )
        {
            ...
            {
                dig_signed = cur->raw.p;
                dig_signed_len = cur->raw.len;
                break;
            }
            cur = cur->next;
        }
...
# 3181 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        mbedtls_md_type_t md_alg;
        ...
        if( ssl->minor_ver == 3 )
        {
            ...
            {
                mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3194, "should never happen" );
        ...
        mbedtls_debug_print_msg( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3222, "pick hash algorithm %d for signing", md_alg );
...
# 3251 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        if( md_alg != MBEDTLS_MD_NONE )
        {
            ...
            hashlen = 0;
# 3290 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            if( ( ret = mbedtls_md_setup( &ctx, md_info, ((1 << 16)) ) ) != 0 )
            {
                mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3292, "mbedtls_md_setup", ret );
                return( ret );
            }
            ...
            {
                unsigned char len[3];
                if( ( ret = mbedtls_pk_z_get( mbedtls_ssl_own_key( ssl ), md_alg, hash, 32 ) ) != 0 )
                {
                    mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3302, "mbedtls_pk_sign", ret );
                    return( ret );
                }
                ...
                len[0] = dig_signed_len>>16&0x00ff;
                len[1] = dig_signed_len>>8&0x00ff;
                len[2] = dig_signed_len&0x00ff;
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3331, "should never happen" );
            return( -0x6C00 );
        }

        mbedtls_debug_print_buf( ssl, 3,
                                                                                          "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 3335 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ,
                                                                                          3336
# 3335 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3343, "got no private key" );
            return( -0x7600 );
        }
        ...
        if( ssl->minor_ver == 3 )
        {
# 3366 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3376, "mbedtls_pk_sign", ret );
            return( ret );
        }
        ...
        *(p++) = (unsigned char)( signature_len );
        ...
        mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3384, "my signature", p, signature_len );
    ...
    if( ( ret = mbedtls_ssl_write_record( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3400, "mbedtls_ssl_write_record", ret );
        return( ret );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3404, "<= write server key exchange" );
...
static int ssl_write_server_hello_done( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3413, "=> write server hello done" );
    ...
    if( ( ret = mbedtls_ssl_write_record( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3428, "mbedtls_ssl_write_record", ret );
        return( ret );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3432, "<= write server hello done" );

    return( 0 );
}
# 3480 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
static int gmssl_parse_encrypted_pms( mbedtls_ssl_context *ssl,
                                    const unsigned char *p )
{
    ...
    size_t len = p[0]*256 + p[1];

    if( ! mbedtls_pk_can_do( mbedtls_ssl_own_key_enc( ssl ), MBEDTLS_PK_EC ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3492, "got no RSA private key" );
        return( -0x7600 );
    }

    ret = mbedtls_pk_decrypt( mbedtls_ssl_own_key_enc( ssl ), p + 2, len,
    ...
    memcpy(ssl->handshake->premaster,peer_pms,ssl->handshake->pmslen);
                                    ...
                                    size_t pms_offset )
{
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3528, "got no RSA private key" );
        return( -0x7600 );
    }
    ...
    if( ssl->minor_ver != 0 )
    {
        if( *p++ != ( ( len >> 8 ) & 0xFF ) ||
            *p++ != ( ( len ) & 0xFF ) )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3542, "bad client key exchange message" );
            return( -0x7C00 );
        }
    }
    ...
    if( p + len != end )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3550, "bad client key exchange message" );
        return( -0x7C00 );
    }
...
# 3565 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3587, "should never happen" );
        return( -0x6C00 );
    }
    ssl->handshake->pmslen = 48;
# 3599 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                                          ...
                                          const unsigned char *end )
{
    ...
    if( ssl->conf->f_psk == ((void *)0) &&
        ( ssl->conf->psk == ((void *)0) || ssl->conf->psk_identity == ((void *)0) ||
          ssl->conf->psk_identity_len == 0 || ssl->conf->psk_len == 0 ) )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3623, "got no pre-shared key" );
        return( -0x7600 );
    }
    ...
    if( *p + 2 > end )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3632, "bad client key exchange message" );
        return( -0x7C00 );
    }
    ...
    *p += 2;
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3641, "bad client key exchange message" );
        return( -0x7C00 );
    }
    ...
    if( ret == -0x6C80 )
    {
        mbedtls_debug_print_buf( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3663, "Unknown PSK identity", *p, n );
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        115 );
        return( -0x6C80 );
    }
...
static int ssl_parse_client_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3683, "=> parse client key exchange" );

    if( ( ret = mbedtls_ssl_read_record( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3687, "mbedtls_ssl_read_record", ret );
        return( ret );
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3696, "bad client key exchange message" );
        return( -0x7C00 );
    }

    if( ssl->in_msg[0] != 16 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3702, "bad client key exchange message" );
        return( -0x7C00 );
    }
# 3739 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA )
    {
        if( ( ret = mbedtls_ecdh_read_public( &ssl->handshake->ecdh_ctx,
                                      p, end - p) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3747, "mbedtls_ecdh_read_public", ret );
            return( -0x7C80 );
        }

        mbedtls_debug_print_ecp( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3751, "ECDH: Qp ", &ssl->handshake->ecdh_ctx.Qp );
        ...
        mbedtls_debug_print_mpi( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3763, "ECDH: z  ", &ssl->handshake->ecdh_ctx.z );
    }
    else
    ...
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_PSK )
    {
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3775, ( "ssl_parse_client_psk_identity" ), ret );
            return( ret );
        }

        if( p != end )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3781, "bad client key exchange" );
            return( -0x7C00 );
        }
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3788, "mbedtls_ssl_psk_derive_premaster", ret );
            return( ret );
        }
    }
    else
    ...
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_RSA_PSK )
    {
        if( ( ret = ssl_parse_client_psk_identity( ssl, &p, end ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3799, ( "ssl_parse_client_psk_identity" ), ret );
            return( ret );
        }

        if( ( ret = ssl_parse_encrypted_pms( ssl, p, end, 2 ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3805, ( "ssl_parse_encrypted_pms" ), ret );
            return( ret );
        }
        ...
        if( ( ret = mbedtls_ssl_psk_derive_premaster( ssl,
                        ciphersuite_info->key_exchange ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3812, "mbedtls_ssl_psk_derive_premaster", ret );
            return( ret );
        }
    }
    else
# 3848 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_ECDHE_PSK )
    {
        if( ( ret = ssl_parse_client_psk_identity( ssl, &p, end ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3852, ( "ssl_parse_client_psk_identity" ), ret );
            return( ret );
        }
        ...
        if( ( ret = mbedtls_ecdh_read_public( &ssl->handshake->ecdh_ctx,
                                       p, end - p ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3859, "mbedtls_ecdh_read_public", ret );
            return( -0x7C80 );
        }

        mbedtls_debug_print_ecp( ssl, 3, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3863, "ECDH: Qp ", &ssl->handshake->ecdh_ctx.Qp );

        if( ( ret = mbedtls_ssl_psk_derive_premaster( ssl,
                        ciphersuite_info->key_exchange ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3868, "mbedtls_ssl_psk_derive_premaster", ret );
            return( ret );
        }
    }
    else
    ...
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_RSA )
    {
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3879, ( "ssl_parse_parse_encrypted_pms_secret" ), ret );
            return( ret );
        }
    }
    else
    ...
    {
        if( ( ret = gmssl_parse_encrypted_pms( ssl, p ) ) != 0 )
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3891, ( "ssl_parse_parse_encrypted_pms_secret" ), ret );
            return( ret );
        }
    }
    else
# 3921 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3922, "should never happen" );
        return( -0x6C00 );
    }

    if( ( ret = mbedtls_ssl_derive_keys( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3928, "mbedtls_ssl_derive_keys", ret );
        return( ret );
    }

    ssl->state++;

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3934, "<= parse client key exchange" );

    return( 0 );
}
# 3967 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
static int ssl_parse_certificate_verify( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3981, "=> parse certificate verify" );
    ...
    {
        mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 3990, "<= skip parse certificate verify" );
        ssl->state++;
        return( 0 );
    }
    ...
    do {
        ...
        {
            mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4000, ( "mbedtls_ssl_read_record_layer" ), ret );
            return( ret );
        }
    ...
    if( 0 != ret )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4010, ( "mbedtls_ssl_handle_message_type" ), ret );
        return( ret );
    }
    ...
    if( ssl->in_msgtype != 22 ||
        ssl->in_msg[0] != 15 )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4020, "bad certificate verify message" );
        return( -0x7D80 );
    }

    i = mbedtls_ssl_hs_hdr_len( ssl );
# 4034 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    ...
    if( ssl->minor_ver == 3 || ssl->protocol == 0x0 )
    {
        if( i + 2 > ssl->in_hslen )
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4057, "bad certificate verify message" );
            return( -0x7D80 );
        }
        ...
        if( md_alg == MBEDTLS_MD_NONE || mbedtls_ssl_set_calc_verify_md( ssl, ssl->in_msg[i] ) )
        {
            mbedtls_debug_print_msg( ssl, 1,
                                                        "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 4068 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                        4069
# 4068 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
                        ...
                        == MBEDTLS_PK_NONE )
        {
            mbedtls_debug_print_msg( ssl, 1,
                                                        "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
# 4089 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            ,
                                                        4090
# 4089 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
            , "peer not adhering to requested sig_alg" " for verify message" )
        ...
        {
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4099, "sig_alg doesn't match cert key" );
            return( -0x7D80 );
        }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4108, "should never happen" );
        return( -0x6C00 );
    }

    if( i + 2 > ssl->in_hslen )
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4114, "bad certificate verify message" );
        return( -0x7D80 );
    }
    ...
    {
        mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4123, "bad certificate verify message" );
        return( -0x7D80 );
    }
    ...
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4134, "mbedtls_pk_verify", ret );
        return( ret );
    }

    mbedtls_ssl_update_handshake_status( ssl );

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4140, "<= parse certificate verify" );

    return( ret );
}
# 4152 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
static int ssl_write_new_session_ticket( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4158, "=> write new session ticket" );

    ssl->out_msgtype = 22;
    ssl->out_msg[0] = 4;
# 4174 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
    if( ( ret = ssl->conf->f_ticket_write( ssl->conf->p_ticket,
                                ...
                                &tlen, &lifetime ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4180, "mbedtls_ssl_ticket_write", ret );
        tlen = 0;
    }
    ...
    if( ( ret = mbedtls_ssl_write_record( ssl ) ) != 0 )
    {
        mbedtls_debug_print_ret( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4202, "mbedtls_ssl_write_record", ret );
        return( ret );
    }

    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4206, "<= write new session ticket" );
...
int mbedtls_ssl_handshake_server_step( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4222, "server state: %d", ssl->state );
    ...
    switch( ssl->state )
    {
        ...
        case MBEDTLS_SSL_SERVER_HELLO_VERIFY_REQUEST_SENT:
            return( -0x6A80 );
# 4261 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        case MBEDTLS_SSL_SERVER_HELLO_DONE:
            ...
            break;
# 4288 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c"
        ...
        case MBEDTLS_SSL_FLUSH_BUFFERS:
            mbedtls_debug_print_msg( ssl, 2, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4327, "handshake: done" );
        ...
        default:
            mbedtls_debug_print_msg( ssl, 1, "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_srv.c", 4336, "invalid state %d", ssl->state );
            return( -0x7100 );
    }
