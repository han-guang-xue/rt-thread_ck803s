# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/ringbuffer.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/ringbuffer.c"
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/ringbuffer.c"
...
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/ringbuffer.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/ringbuffer.c" 2
...
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/ringbuffer.c" 2

static __inline enum rt_ringbuffer_state __attribute__((section(".fast"))) rt_ringbuffer_status(struct rt_ringbuffer *rb)
{
...
void rt_ringbuffer_init(struct rt_ringbuffer *rb,
                        ...
                        rt_int16_t size)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 47); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_put(struct rt_ringbuffer *rb,
                            const rt_uint8_t *ptr,
                            rt_uint16_t length)
{
    rt_uint16_t size;

    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 69); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_put_force(struct rt_ringbuffer *rb,
                            const rt_uint8_t *ptr,
                            rt_uint16_t length)
{
    rt_uint16_t space_length;

    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 118); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_get(struct rt_ringbuffer *rb,
                            rt_uint8_t *ptr,
                            rt_uint16_t length)
{
    rt_size_t size;

    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 172); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_putchar(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 215); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_putchar_force(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    enum rt_ringbuffer_state old_state;

    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 247); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_getchar(struct rt_ringbuffer *rb, rt_uint8_t *ch)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 280); };
...
rt_size_t __attribute__((section(".fast"))) rt_ringbuffer_data_len(struct rt_ringbuffer *rb)
{
...
void __attribute__((section(".fast"))) rt_ringbuffer_reset(struct rt_ringbuffer *rb)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 329); };
...
struct rt_ringbuffer* rt_ringbuffer_create(rt_uint16_t size)
{
 ...
 if (!(size > 0)) { rt_assert_handler("size > 0", __FUNCTION__, 345); };
...
void rt_ringbuffer_destroy(struct rt_ringbuffer *rb)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 368); };
