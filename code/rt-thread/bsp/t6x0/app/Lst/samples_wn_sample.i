# 1 "../../../packages/webnet-2.0.0/samples/wn_sample.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/samples/wn_sample.c"
# 24 "../../../packages/webnet-2.0.0/samples/wn_sample.c"
...
# 25 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2
...
# 26 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2
...
# 27 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2
...
# 29 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2
...
# 30 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2
# 40 "../../../packages/webnet-2.0.0/samples/wn_sample.c"
...
# 41 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2


static void asp_var_version(struct webnet_session* session)
{
    if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 45); };
    ...
    webnet_session_printf(session, version, 3L, 1L, 0L);
}
...
static void cgi_calc_handler(struct webnet_session* session)
{
    ...
    if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 65); };
    request = session->request;
    if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 67); };
...
static void cgi_hello_handler(struct webnet_session* session)
{
    ...
    if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 98); };
...
# 1 "../../../components/dfs/filesystems/ramfs/dfs_ramfs.h" 1
# 35 "../../../components/dfs/filesystems/ramfs/dfs_ramfs.h"
struct ramfs_dirent
{
    rt_list_t list;
    struct dfs_ramfs *fs;
...
# 134 "../../../packages/webnet-2.0.0/samples/wn_sample.c" 2

    rt_uint8_t *ramfs_pool = (0);
    struct dfs_ramfs* ramfs;

    ramfs_pool = rt_malloc(0x1000);
    if(ramfs_pool)
    {
        ramfs =(struct dfs_ramfs*) dfs_ramfs_create((rt_uint8_t*)ramfs_pool, 0x1000);
        if (ramfs != (0))
        {
            if (dfs_mount((0), "/ram", "ram", 0, ramfs) == 0)
            {
...
const char __fsym___cmd_webnet_test_name[] __attribute__((section(".rodata.name"))) = "__cmd_webnet_test"; const char __fsym___cmd_webnet_test_desc[] __attribute__((section(".rodata.name"))) = "wenbet test"; const struct finsh_syscall __fsym___cmd_webnet_test __attribute__((section("FSymTab")))= { __fsym___cmd_webnet_test_name, __fsym___cmd_webnet_test_desc, (syscall_func)&webnet_test };;
