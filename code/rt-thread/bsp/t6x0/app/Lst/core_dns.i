# 1 "../../../components/net/lwip-2.0.2/src/core/dns.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/dns.c"
# 85 "../../../components/net/lwip-2.0.2/src/core/dns.c"
...
# 86 "../../../components/net/lwip-2.0.2/src/core/dns.c" 2
...
# 90 "../../../components/net/lwip-2.0.2/src/core/dns.c" 2
...
# 91 "../../../components/net/lwip-2.0.2/src/core/dns.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 94 "../../../components/net/lwip-2.0.2/src/core/dns.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/prot/dns.h" 1
# 101 "../../../components/net/lwip-2.0.2/src/include/lwip/prot/dns.h"
...
# 95 "../../../components/net/lwip-2.0.2/src/core/dns.c" 2
# 192 "../../../components/net/lwip-2.0.2/src/core/dns.c"
struct dns_query {
...
# 288 "../../../components/net/lwip-2.0.2/src/core/dns.c"
...
# 317 "../../../components/net/lwip-2.0.2/src/core/dns.c"
void
dns_init(void)
{
...
# 327 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  ,
                                                328
# 327 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  );}while(0); }} while(0)
  ...
  do { if (!(sizeof(struct dns_answer) <= 12)) { do {rt_kprintf("sanity check SIZEOF_DNS_ANSWER"); sys_arch_assert(
                                                         "../../../components/net/lwip-2.0.2/src/core/dns.c"
# 329 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  ,
                                                         330
# 329 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  );}while(0); }} while(0)
  ...
  ;
# 354 "../../../components/net/lwip-2.0.2/src/core/dns.c"
}
# 363 "../../../components/net/lwip-2.0.2/src/core/dns.c"
void
dns_setserver(u8_t numdns, const ip_addr_t *dnsserver)
{
  if (numdns < 2) {
    if (dnsserver != 
# 367 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                    0
# 367 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                        ) {
...
# 383 "../../../components/net/lwip-2.0.2/src/core/dns.c"
const ip_addr_t*
...
# 604 "../../../components/net/lwip-2.0.2/src/core/dns.c"
static err_t
dns_lookup(const char *name, ip_addr_t *addr )
{
  u8_t i;
# 622 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  for (i = 0; i < 4; ++i) {
...
# 650 "../../../components/net/lwip-2.0.2/src/core/dns.c"
static u16_t
...
# 697 "../../../components/net/lwip-2.0.2/src/core/dns.c"
static u16_t
...
dns_send(u8_t idx)
{
  ...
  struct dns_table_entry* entry = &dns_table[idx];
                                                       ...
                                                       ;
  do { if (!(entry->server_idx < 2)) { do {rt_kprintf("dns server out of array"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/dns.c", 749);}while(0); }} while(0);
  if (((dns_servers[entry->server_idx]).addr == ((u32_t)0x00000000UL))
    ...
    dns_call_found(idx, 
# 757 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                       0
# 757 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                           );
  ...
  p = pbuf_alloc(PBUF_TRANSPORT, (u16_t)(12 + strlen(entry->name) + 2 +
                 4), PBUF_RAM);
  if (p != 
# 766 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
          0
# 766 "../../../components/net/lwip-2.0.2/src/core/dns.c"
              ) {
    const ip_addr_t* dst;
    u16_t dst_port;
    ...
    pcb_idx = entry->pcb_idx;
                                                   ...
                                                   ;
# 830 "../../../components/net/lwip-2.0.2/src/core/dns.c"
    {
      dst_port = 53;
...
dns_alloc_random_port(void)
{
  ...
  if (ret == 
# 853 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
            0
# 853 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                ) {

    return 
# 855 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
          0
# 855 "../../../components/net/lwip-2.0.2/src/core/dns.c"
              ;
  }
  do {
  ...
  if (err != ERR_OK) {
    udp_remove(ret);
    return 
# 868 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
          0
# 868 "../../../components/net/lwip-2.0.2/src/core/dns.c"
              ;
  }
  udp_recv(ret, dns_recv, 
# 870 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                         0
# 870 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                             );
  return ret;
}
...
dns_alloc_pcb(void)
{
  ...
  for (i = 0; i < 4; i++) {
    if (dns_pcbs[i] == 
# 887 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                      0
# 887 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                          ) {
      break;
    }
  }
  if (i < 4) {
    ...
    if (dns_pcbs[i] != 
# 893 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                      0
# 893 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                          ) {
  ...
  for (i = 0, idx = dns_last_pcb_idx + 1; i < 4; i++, idx++) {
    ...
    if (dns_pcbs[idx] != 
# 905 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                        0
# 905 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                            ) {
...
# 922 "../../../components/net/lwip-2.0.2/src/core/dns.c"
static void
dns_call_found(u8_t idx, ip_addr_t* addr)
{

  u8_t i;
# 943 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  for (i = 0; i < 4; i++) {
    if (dns_requests[i].found && (dns_requests[i].dns_table_idx == idx)) {
      (*dns_requests[i].found)(dns_table[idx].name, addr, dns_requests[i].arg);

      dns_requests[i].found = 
# 947 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                             0
# 947 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                                 ;
    }
  }
# 958 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  for (i = 0; i < 4; i++) {
    if (i == idx) {
      continue;
    }
...
# 973 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                                      0
# 973 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                                          ;
    dns_table[idx].pcb_idx = 4;
  }
...
# 1010 "../../../components/net/lwip-2.0.2/src/core/dns.c"
static void
dns_check_entry(u8_t i)
{
  ...
  do { if (!(i < 4)) { do {rt_kprintf("array index out of bounds"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/dns.c", 1016);}while(0); }} while(0);
      ...
      if (--entry->tmr == 0) {
        if (++entry->retries == 4) {
          if ((entry->server_idx + 1 < 2) && !((dns_servers[entry->server_idx + 1]).addr == ((u32_t)0x00000000UL))
            ...
            dns_call_found(i, 
# 1049 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                             0
# 1049 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                                 );
    ...
    case DNS_STATE_UNUSED:
      ...
      break;
    default:
      do { if (!(0)) { do {rt_kprintf("unknown dns_table entry state:"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/dns.c", 1079);}while(0); }} while(0);
      break;
  }
}
...
# 1266 "../../../components/net/lwip-2.0.2/src/core/dns.c"
            }
...
# 1290 "../../../components/net/lwip-2.0.2/src/core/dns.c"
          ;
        }

        pbuf_free(p);
        dns_call_found(i, 
# 1294 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                         0
# 1294 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                             );
...
# 1316 "../../../components/net/lwip-2.0.2/src/core/dns.c"
static err_t
...
# 1322 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                                 0
# 1322 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                                     ;
  size_t namelen;
  ...
  for (i = 0; i < 4; i++) {
    if ((dns_table[i].state == DNS_STATE_ASKING) &&
        (lwip_strnicmp(name, dns_table[i].name, sizeof(dns_table[i].name)) == 0)) {
# 1341 "../../../components/net/lwip-2.0.2/src/core/dns.c"
      for (r = 0; r < 4; r++) {
  ...
  req = 
# 1390 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
       0
# 1390 "../../../components/net/lwip-2.0.2/src/core/dns.c"
           ;
  for (r = 0; r < 4; r++) {
    if (dns_requests[r].found == 
# 1392 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                                0
# 1392 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                                    ) {
      req = &dns_requests[r];
      break;
    }
  ...
  if (req == 
# 1397 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
            0
# 1397 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                ) {
  ...
  if (entry->pcb_idx >= 4) {
    ...
    entry->state = DNS_STATE_UNUSED;
    req->found = 
# 1428 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
                0
# 1428 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                    ;
    return ERR_MEM;
  }
  ;
...
# 1467 "../../../components/net/lwip-2.0.2/src/core/dns.c"
err_t
...
# 1488 "../../../components/net/lwip-2.0.2/src/core/dns.c"
err_t
                           ...
                           void *callback_arg, u8_t dns_addrtype)
{
  ...
  if ((addr == 
# 1498 "../../../components/net/lwip-2.0.2/src/core/dns.c" 3 4
              0
# 1498 "../../../components/net/lwip-2.0.2/src/core/dns.c"
                  ) ||
      (!hostname) || (!hostname[0])) {
    return ERR_ARG;
  }
...
# 1522 "../../../components/net/lwip-2.0.2/src/core/dns.c"
...
# 1549 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  (void)dns_addrtype;
# 1561 "../../../components/net/lwip-2.0.2/src/core/dns.c"
  {
