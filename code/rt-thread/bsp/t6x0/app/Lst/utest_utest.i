...
# 12 "../../../components/utilities/utest/utest.c" 2
...
# 13 "../../../components/utilities/utest/utest.c" 2
...
# 14 "../../../components/utilities/utest/utest.c" 2

# 1 "../../../components/utilities/utest/utest.h" 1
# 15 "../../../components/utilities/utest/utest.h"
# 1 "../../../components/utilities/utest/utest_log.h" 1
# 27 "../../../components/utilities/utest/utest_log.h"
# 1 "../../../include/rtdbg.h" 1
# 28 "../../../components/utilities/utest/utest_log.h" 2





# 32 "../../../components/utilities/utest/utest_log.h"
void utest_log_lv_set(rt_uint8_t lv);
# 16 "../../../components/utilities/utest/utest.h" 2
# 1 "../../../components/utilities/utest/utest_assert.h" 1
# 14 "../../../components/utilities/utest/utest_assert.h"
# 1 "../../../components/utilities/utest/utest.h" 1
# 15 "../../../components/utilities/utest/utest_assert.h" 2
...
# 17 "../../../components/utilities/utest/utest.h" 2
# 28 "../../../components/utilities/utest/utest.h"
enum utest_error
{
    UTEST_PASSED = 0,
    UTEST_FAILED = 1,
...
# 46 "../../../components/utilities/utest/utest.h"
struct utest
{
    utest_err_e error;
    uint32_t passed_num;
...
# 67 "../../../components/utilities/utest/utest.h"
...
# 96 "../../../components/utilities/utest/utest.h"
void utest_unit_run(test_unit_func func, const char *unit_func_name);
# 109 "../../../components/utilities/utest/utest.h"
utest_t utest_handle_get(void);
# 16 "../../../components/utilities/utest/utest.c" 2
# 1 "../../../components/utilities/utest/utest_log.h" 1
# 17 "../../../components/utilities/utest/utest.c" 2
# 49 "../../../components/utilities/utest/utest.c"
static rt_uint8_t utest_log_lv = (1u);
static utest_tc_export_t tc_table = (0);
...
int utest_init(void)
{
# 79 "../../../components/utilities/utest/utest.c"
...
const init_fn_t __rt_init_utest_init __attribute__((section(".rti_fn.""4"))) = utest_init;
...
const char __fsym___cmd_utest_list_name[] __attribute__((section(".rodata.name"))) = "__cmd_utest_list"; const char __fsym___cmd_utest_list_desc[] __attribute__((section(".rodata.name"))) = "output all utest testcase"; const struct finsh_syscall __fsym___cmd_utest_list __attribute__((section("FSymTab")))= { __fsym___cmd_utest_list_name, __fsym___cmd_utest_list_desc, (syscall_func)&utest_tc_list };;
...
static const char *file_basename(const char *file)
{
    ...
    if (!((end_ptr = strrchr(file, '\\')) != (0) ||
        (end_ptr = strrchr(file, '/')) != (0)) ||
        (rt_strlen(file) < 2))
    {
        rst = (char *)file;
    }
...
const char __fsym___cmd_utest_run_name[] __attribute__((section(".rodata.name"))) = "__cmd_utest_run"; const char __fsym___cmd_utest_run_desc[] __attribute__((section(".rodata.name"))) = "utest_run [-thread or -help] [testcase name] [loop num]"; const struct finsh_syscall __fsym___cmd_utest_run __attribute__((section("FSymTab")))= { __fsym___cmd_utest_run_name, __fsym___cmd_utest_run_desc, (syscall_func)&utest_testcase_run };;
