...
# 1 "<command-line>"
# 1 "../../../components/drivers/i2c/i2c_core.c"
# 25 "../../../components/drivers/i2c/i2c_core.c"
...
# 26 "../../../components/drivers/i2c/i2c_core.c" 2
                          ...
                          rt_uint32_t num)
{
    ...
    {
# 76 "../../../components/drivers/i2c/i2c_core.c"
                             ...
                             rt_uint32_t count)
{
    rt_err_t ret;
    struct rt_i2c_msg msg;
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 117); };
...
const init_fn_t __rt_init_rt_i2c_core_init __attribute__((section(".rti_fn.""4"))) = rt_i2c_core_init;
