# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c"
# 23 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c"
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 24 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
...
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
# 1 "../libraries/inc/tih/interrupt.h" 1
...
int intr_hw_init(void);
int intr_connect(unsigned int nintr, unsigned int prio, void *isr);
int intr_disconnect(unsigned int nintr);
int intr_is_connected(unsigned int nintr);
void intr_enable(unsigned int nintr);
void intr_disable(unsigned int nintr);
void intr_clear(unsigned int nintr);
unsigned int intr_status_get(void);
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
...
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
# 1 "../libraries/inc/tih/uart.h" 1
...
#define UART_INTR_RX_ERROR (1 << 0)
#define UART_INTR_TX_EMPTY (1 << 1)
#define UART_INTR_RX_READY (1 << 2)
...
#define UART_WORD_SIZE_5BIT 0
#define UART_WORD_SIZE_6BIT 1
#define UART_WORD_SIZE_7BIT 2
#define UART_WORD_SIZE_8BIT 3


#define UART_STOP_BIT_EQ_1 0
#define UART_STOP_BIT_GT_1 1
...
int uart_hw_init(unsigned int uart, uart_config_t *config);
void uart_fifo_init(unsigned int uart);
void uart_intr_enable(unsigned int uart, unsigned int intr_src);
void uart_intr_disable(unsigned int uart, unsigned int intr_src);
unsigned int uart_intr_status(unsigned int uart);
void uart_intr_clear(unsigned int uart, unsigned int intr_src);


void uart_putc(unsigned int uart, unsigned char data);
unsigned char uart_getc(unsigned int uart);
void uart_send(unsigned int uart, unsigned char *buf, unsigned int nbytes);
void uart_recv(unsigned int uart, unsigned char *buf, unsigned int nbytes);
void console_putc(unsigned char data);
unsigned char console_getc(void);


int uart_tx_ready(unsigned int uart);
void uart_ndelay_putc(unsigned int uart, unsigned char data);
int uart_rx_ready(unsigned int uart);
unsigned char uart_ndelay_getc(unsigned int uart);
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
# 1 "../libraries/inc/tih/norflash.h" 1

#define __NORFLASH_H__ 



int norflash_hw_init(void);
unsigned char norflash_byte_read(unsigned int offset);
int norflash_byte_write(unsigned int offset,unsigned char data);
int norflash_read(unsigned int offset, unsigned char *buf, unsigned int nbytes);
int norflash_write(unsigned int offset, unsigned char *buf, unsigned int nbytes);
int norflash_sector_erase(unsigned int offset);
int norflash_block_erase(unsigned int offset);
int norflash_chip_erase(void);
unsigned int norflash_capacity_get(void);
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
# 1 "../libraries/inc/tih/core_ck803.h" 1
# 32 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
# 1 "../drivers/drv_ctimer.h" 1

#define __DRV_CTIMER_H__ 



void core_timer_init(unsigned int us);
# 33 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c" 2
# 41 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c"
int system_clock = 200000000;
...
void console_init(void)
{
    ...
    uart_hw_init(0, &config);
}

void __attribute__((section(".fast"))) norflash_init(void)
{
    norflash_hw_init();
}
...
void sys_hw_init(void)
{
    ...
    clock_source_set(CLOCK_PLL, 600000000);
    clock_freq_set(MODULE_AHB, 200000000);
    clock_freq_set(MODULE_AXI, 200000000);
...
# 116 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/system.c"
    ...
    csi_cache_set_range(0, 0, 0x10, 1);
    csi_cache_set_range(1, 0x01000000, 0x12, 1);
    csi_icache_enable();
...
void __attribute__((section(".fast"))) system_init(void)
{
...
void __attribute__((section(".fast"))) rt_hw_us_delay(rt_uint32_t us)
{
    unsigned int s;
...
uint32_t __attribute__((section(".fast"))) rt_hw_hardclock_get(void)
{
    return scu_sw_cnt_get();
}

rt_bool_t __attribute__((section(".fast"))) rt_hw_dtcm_addr_check(rt_uint32_t addr)
{
