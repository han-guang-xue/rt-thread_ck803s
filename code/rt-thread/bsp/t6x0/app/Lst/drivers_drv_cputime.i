...
static float drv_cputime_getres(void)
{
    ...
    if (!(ahb_freq != 0)) { rt_assert_handler("ahb_freq != 0", __FUNCTION__, 16); };
...
const init_fn_t __rt_init_drv_cputime_init __attribute__((section(".rti_fn.""1"))) = drv_cputime_init;
