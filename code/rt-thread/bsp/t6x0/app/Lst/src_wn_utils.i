...
# 25 "../../../packages/webnet-2.0.0/src/wn_utils.c" 2
...
# 26 "../../../packages/webnet-2.0.0/src/wn_utils.c" 2
...
# 28 "../../../packages/webnet-2.0.0/src/wn_utils.c" 2
# 1 "../../../packages/webnet-2.0.0/inc/wn_utils.h" 1
# 27 "../../../packages/webnet-2.0.0/inc/wn_utils.h"
...
# 28 "../../../packages/webnet-2.0.0/inc/wn_utils.h" 2
...
# 29 "../../../packages/webnet-2.0.0/src/wn_utils.c" 2

static __inline int tohex(char c)
{
    if (c >= '0' && c <= '9')
        return c - '0';
    if (c >= 'a' && c <= 'f')
...
char * urlencode(const char *str, int len, int *new_length)
{
    ...
    start = to = (char *) rt_malloc(3 * len + 1);
    if(start == (0))
    {
        return (0);
    }
