...
# 1 "<command-line>"
# 1 "../../../components/drivers/serial/serial.c"
# 40 "../../../components/drivers/serial/serial.c"
# 1 "../../../include/rthw.h" 1
# 32 "../../../include/rthw.h"
...
void xmem_init(void);
# 41 "../../../components/drivers/serial/serial.c" 2
...
# 43 "../../../components/drivers/serial/serial.c" 2
...
# 1 "../../../include/rtdbg.h" 1
# 49 "../../../components/drivers/serial/serial.c" 2
...
# 52 "../../../components/drivers/serial/serial.c" 2
...
# 53 "../../../components/drivers/serial/serial.c" 2
# 67 "../../../components/drivers/serial/serial.c"
...
# 375 "../../../components/drivers/serial/serial.c"
...
# 922 "../../../components/drivers/serial/serial.c"
                                  ...
                                  void *args)
{
    ...
    switch (cmd)
    {
        ...
        case 0x03:
            ...
            break;
# 1057 "../../../components/drivers/serial/serial.c"
        case ( ((2U)<<30) | ((('f'))<<8) | ((127)) | ((sizeof(int))<<16) ):
            {
                rt_size_t recved = 0;
                rt_base_t level;
...
# 1094 "../../../components/drivers/serial/serial.c"
rt_err_t rt_hw_serial_register(struct rt_serial_device *serial,
                               const char *name,
                               rt_uint32_t flag,
                               void *data)
