# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
# 40 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 41 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c" 2
...
# 43 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c" 2
...
# 49 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c" 2
...
# 52 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c" 2
...
# 53 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c" 2
# 67 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
static rt_err_t serial_fops_rx_ind(rt_device_t dev, rt_size_t size)
{
    rt_wqueue_wakeup(&(dev->wait_queue), (void*)(0x01));
...
static int serial_fops_open(struct dfs_fd *fd)
{
    ...
    if (!(device != (0))) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 82); };
...
static int serial_fops_close(struct dfs_fd *fd)
{
    ...
    rt_device_set_rx_indicate(device, (0));
...
static int serial_fops_read(struct dfs_fd *fd, void *buf, size_t count)
{
    ...
    do
    {
        ...
        if (size <= 0)
        {
            ...
            rt_wqueue_wait(&(device->wait_queue), 0, -1);
        }
    }while (size <= 0);
...
static int serial_fops_poll(struct dfs_fd *fd, struct rt_pollreq *req)
{
    ...
    device = (rt_device_t)fd->data;
    if (!(device != (0))) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 180); };

    serial = (struct rt_serial_device *)device;


    flags = fd->flags & (03|010000000);
    if (flags == 00 || flags == 02)
    {
        rt_base_t level;
        ...
        if ((rx_fifo->get_index != rx_fifo->put_index) || (rx_fifo->get_index == rx_fifo->put_index && rx_fifo->is_full == 1))
            mask |= (0x01);
...
static __inline int _serial_poll_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 226); };
    size = length;
...
{
    int size;
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 246); };
...
static __inline int _serial_int_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 277); };
    size = length;

    rx_fifo = (struct rt_serial_rx_fifo*) serial->serial_rx;
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 281); };
...
static __inline int _serial_int_tx(struct rt_serial_device *serial, const rt_uint8_t *data, int length)
{
    ...
    if (!(tx != (0))) { rt_assert_handler("tx != RT_NULL", __FUNCTION__, 329); };
...
static rt_size_t _serial_fifo_calc_recved_len(struct rt_serial_device *serial)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 349); };
...
# 375 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
...
static void rt_dma_recv_update_get_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 390); };
    if (!(len <= rt_dma_calc_recved_len(serial))) { rt_assert_handler("len <= rt_dma_calc_recved_len(serial)", __FUNCTION__, 391); };
...
static void rt_dma_recv_update_put_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 412); };
...
static __inline int _serial_dma_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    if (!((serial != (0)) && (data != (0)))) { rt_assert_handler("(serial != RT_NULL) && (data != RT_NULL)", __FUNCTION__, 458); };
    ...
    if (serial->config.bufsz == 0)
    {
        ...
        if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 468); };

        if (rx_dma->activated != 1)
        {
            rx_dma->activated = 1;
            if (!(serial->ops->dma_transmit != (0))) { rt_assert_handler("serial->ops->dma_transmit != RT_NULL", __FUNCTION__, 473); };
    ...
    else
    {
        ...
        if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 489); };
...
static rt_err_t rt_serial_init(struct rt_device *dev)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 554); };
...
static rt_err_t rt_serial_open(struct rt_device *dev, rt_uint16_t oflag)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 573); };
    serial = (struct rt_serial_device *)dev;
    ...
    if (serial->serial_rx == (0))
    {
        if (oflag & 0x200)
        {
            if (serial->config.bufsz == 0) {
                ...
                if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 604); };
                rx_dma->activated = 0;
                ...
                rx_fifo = (struct rt_serial_rx_fifo*) rt_malloc (sizeof(struct rt_serial_rx_fifo) +
                    serial->config.bufsz);
                if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 613); };
        ...
        else if (oflag & 0x100)
        {
            ...
            rx_fifo = (struct rt_serial_rx_fifo*) rt_malloc (sizeof(struct rt_serial_rx_fifo) +
                serial->config.bufsz);
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 631); };
            rx_fifo->buffer = (rt_uint8_t*) (rx_fifo + 1);
            rt_memset(rx_fifo->buffer, 0, serial->config.bufsz);
            rx_fifo->put_index = 0;
            rx_fifo->get_index = 0;
    ...
    if (serial->serial_tx == (0))
    {
        if (oflag & 0x800)
        {
            ...
            if (!(tx_dma != (0))) { rt_assert_handler("tx_dma != RT_NULL", __FUNCTION__, 663); };
            tx_dma->activated = 0;
        ...
        else if (oflag & 0x400)
        {
            ...
            if (!(tx_fifo != (0))) { rt_assert_handler("tx_fifo != RT_NULL", __FUNCTION__, 676); };
...
static rt_err_t rt_serial_close(struct rt_device *dev)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 708); };
    serial = (struct rt_serial_device *)dev;
    ...
    if (dev->open_flag & 0x100)
    {
        ...
        rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
        if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 719); };
    ...
    else if (dev->open_flag & 0x200)
    {
        if (serial->config.bufsz == 0) {
            ...
            rx_dma = (struct rt_serial_rx_dma*)serial->serial_rx;
            if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 733); };
            ...
            rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 740); };
    ...
    if (dev->open_flag & 0x400)
    {
        ...
        if (!(tx_fifo != (0))) { rt_assert_handler("tx_fifo != RT_NULL", __FUNCTION__, 755); };
    ...
    else if (dev->open_flag & 0x800)
    {
        ...
        tx_dma = (struct rt_serial_tx_dma*)serial->serial_tx;
        if (!(tx_dma != (0))) { rt_assert_handler("tx_dma != RT_NULL", __FUNCTION__, 768); };
                                 ...
                                 rt_size_t size)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 809); };
    if (size == 0) return 0;
...
# 922 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
                                  ...
                                  void *args)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 929); };
    serial = (struct rt_serial_device *)dev;
    ...
    switch (cmd)
    {
        ...
        case 0x03:
            ...
            break;
# 1057 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
        case ( ((2U)<<30) | ((('f'))<<8) | ((127)) | ((sizeof(int))<<16) ):
            {
                rt_size_t recved = 0;
                rt_base_t level;
...
# 1094 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/serial/serial.c"
rt_err_t rt_hw_serial_register(struct rt_serial_device *serial,
                               const char *name,
                               rt_uint32_t flag,
                               void *data)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 1101); };
...
void rt_hw_serial_isr(struct rt_serial_device *serial, int event)
{
    switch (event & 0xff)
    {
        case 0x01:
        {
            ...
            rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 1145); };
        ...
        case 0x03:
        {
            ...
            if (serial->config.bufsz == 0)
            {
                ...
                rx_dma = (struct rt_serial_rx_dma*) serial->serial_rx;
                if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 1236); };

                if (!(serial->parent.rx_indicate != (0))) { rt_assert_handler("serial->parent.rx_indicate != RT_NULL", __FUNCTION__, 1238); };
