# 1 "../../../packages/mbedtls-2.6.0/ports/src/threading_alt.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/ports/src/threading_alt.c"
# 23 "../../../packages/mbedtls-2.6.0/ports/src/threading_alt.c"
...
# 24 "../../../packages/mbedtls-2.6.0/ports/src/threading_alt.c" 2
...
# 29 "../../../packages/mbedtls-2.6.0/ports/src/threading_alt.c" 2
...
void threading_mutex_init_rtt( mbedtls_threading_mutex_t *mutex )
{
    ...
    rt_snprintf(tname, 8, "%s%d", "tlsm", counter);
    counter ++;

    rt_mutex_init(&mutex->mutex, tname, 0x00);
    mutex->is_valid = 1;
}

void threading_mutex_free_rtt( mbedtls_threading_mutex_t *mutex )
{
    if( mutex == ((void *)0) || !mutex->is_valid )
    {
        return;
    }
...
int threading_mutex_lock_rtt( mbedtls_threading_mutex_t *mutex )
{
    ...
    if( rt_mutex_take(&mutex->mutex, -1) != 0 )
    {
        return -0x001E;
    }
