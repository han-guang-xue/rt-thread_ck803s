# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c"
# 29 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c"
...
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c" 2
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ssl_cookie.h" 1
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ssl_cookie.h"
...
# 27 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ssl_cookie.h" 2
# 52 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ssl_cookie.h"
typedef struct
{
...
int mbedtls_ssl_cookie_setup( mbedtls_ssl_cookie_ctx *ctx,
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng );
# 87 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ssl_cookie.h"
...
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c" 2
...
# 43 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c" 2
...
# 45 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c" 2
...
# 79 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_cookie.c"
void mbedtls_ssl_cookie_init( mbedtls_ssl_cookie_ctx *ctx )
{
                      ...
                      void *p_rng )
{
    ...
    ret = mbedtls_md_setup( &ctx->hmac_ctx, mbedtls_md_info_from_type( MBEDTLS_MD_SHA224 ), ((1 << 0) | (1 << 16)) );
    if( ret != 0 )
        return( ret );
                            ...
                            const unsigned char *cli_id, size_t cli_id_len )
{
    ...
    if( hmac_ctx == ((void *)0) || hmac_ctx->md_info == ((void *)0) || hmac_ctx->hmac_ctx == ((void *)0) )
        return( -0x6C00 );

    mbedtls_md_hmac_reset( hmac_ctx );
    mbedtls_md_hmac_update( hmac_ctx, time, 4 );
    mbedtls_md_hmac_update( hmac_ctx, cli_id, cli_id_len );
    mbedtls_md_hmac_finish( hmac_ctx, hmac_out );
