# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c"
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c"
...
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
#define LWIP_PERF 0
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
void lwip_init(void);
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
# 32 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
# 33 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
# 35 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
# 36 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
# 37 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
# 38 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 39 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2
...
static err_t ping_send(int s, ip_addr_t *addr, int size)
{
    ...
    do { if (!(ping_size <= 0xffff)) { do {rt_kprintf("ping_size is too big"); sys_arch_assert("E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c", 103);}while(0); }} while(0);
...
rt_err_t ping(char* target_name, rt_uint32_t times, rt_size_t size)
{
    ...
    struct timeval timeout = { (2*100) / 100, (2*100) % 100 };
    ...
    struct addrinfo hint, *res = ((void *)0);
    struct sockaddr_in *h = ((void *)0);
    struct in_addr ina;
    ...
    if (lwip_getaddrinfo(target_name, ((void *)0), &hint, &res) != 0)
    {
    ...
    while (1)
    {
        ...
        if (ping_send(s, &target_addr, size) == ERR_OK)
        {
            ...
            {
                elapsed_time = (rt_tick_get() - recv_start_tick) * 1000UL / 100;
                rt_kprintf("%d bytes from %s icmp_seq=%d ttl=%d time=%d ms\n", recv_len, ip4addr_ntoa((const ip4_addr_t*)&(ina)), send_times,
                        ttl, elapsed_time);
            }
            else
            {
                rt_kprintf("From %s icmp_seq=%d timeout\n", ip4addr_ntoa((const ip4_addr_t*)&(ina)), send_times);
            }
        }
        else
        {
            rt_kprintf("Send %s - error\n", ip4addr_ntoa((const ip4_addr_t*)&(ina)));
        }
...
# 242 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ping/ping.c" 2

const char __fsym_ping_name[] __attribute__((section(".rodata.name"))) = "ping"; const char __fsym_ping_desc[] __attribute__((section(".rodata.name"))) = "ping network host"; const struct finsh_syscall __fsym_ping __attribute__((section("FSymTab")))= { __fsym_ping_name, __fsym_ping_desc, (syscall_func)&ping };;
...
const char __fsym___cmd_ping_name[] __attribute__((section(".rodata.name"))) = "__cmd_ping"; const char __fsym___cmd_ping_desc[] __attribute__((section(".rodata.name"))) = "ping network host"; const struct finsh_syscall __fsym___cmd_ping __attribute__((section("FSymTab")))= { __fsym___cmd_ping_name, __fsym___cmd_ping_desc, (syscall_func)&cmd_ping };;
