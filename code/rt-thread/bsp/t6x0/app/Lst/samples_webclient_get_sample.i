# 1 "../../../packages/webclient-2.0.1/samples/webclient_get_sample.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webclient-2.0.1/samples/webclient_get_sample.c"
# 10 "../../../packages/webclient-2.0.1/samples/webclient_get_sample.c"
...
# 11 "../../../packages/webclient-2.0.1/samples/webclient_get_sample.c" 2
...
# 13 "../../../packages/webclient-2.0.1/samples/webclient_get_sample.c" 2
...
int webclient_get_test(int argc, char **argv)
{
    ...
    if (argc == 1)
    {
        URI = rt_strdup("https://192.168.100.167/test.txt");
        if(URI == (0))
        {
...
# 203 "../../../packages/webclient-2.0.1/samples/webclient_get_sample.c" 2
const char __fsym___cmd_web_get_test_name[] __attribute__((section(".rodata.name"))) = "__cmd_web_get_test"; const char __fsym___cmd_web_get_test_desc[] __attribute__((section(".rodata.name"))) = "web_get_test [URI] webclient GET request test"; const struct finsh_syscall __fsym___cmd_web_get_test __attribute__((section("FSymTab")))= { __fsym___cmd_web_get_test_name, __fsym___cmd_web_get_test_desc, (syscall_func)&webclient_get_test };;
