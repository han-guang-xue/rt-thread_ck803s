# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c"
# 25 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c"
...
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pem.h" 1
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pem.h"
...
# 27 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pem.h" 2
...
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
...
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
...
# 34 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
...
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
...
int mbedtls_cipher_auth_decrypt( mbedtls_cipher_context_t *ctx,
                         ...
                         unsigned char *output, size_t *olen,
                         const unsigned char *tag, size_t tag_len );
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
...
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c" 2
# 49 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c"
                               ...
                               const unsigned char *pwd, size_t pwdlen )
{
    ...
    mbedtls_des_crypt_cbc( &des_ctx, 0, buflen,
                     des_iv, buf, buf );
                               ...
                               const unsigned char *pwd, size_t pwdlen )
{
    ...
    mbedtls_des3_crypt_cbc( &des3_ctx, 0, buflen,
                     des3_iv, buf, buf );
...
# 370 "../../../packages/mbedtls-2.6.0/mbedtls/library/pem.c"
                      ...
                      unsigned char *buf, size_t buf_len, size_t *olen )
{
    ...
    if( ( encode_buf = calloc( 1, use_len ) ) == ((void *)0) )
        return( -0x1180 );
