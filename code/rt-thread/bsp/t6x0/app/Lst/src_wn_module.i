...
# 26 "../../../packages/webnet-2.0.0/src/wn_module.c" 2
...
# 27 "../../../packages/webnet-2.0.0/src/wn_module.c" 2
...
# 30 "../../../packages/webnet-2.0.0/src/wn_module.c" 2
...
# 31 "../../../packages/webnet-2.0.0/src/wn_module.c" 2
...
# 32 "../../../packages/webnet-2.0.0/src/wn_module.c" 2
...
# 35 "../../../packages/webnet-2.0.0/src/wn_module.c" 2


static int _webnet_module_system_init(struct webnet_session *session, int event)
{
# 48 "../../../packages/webnet-2.0.0/src/wn_module.c"
...
static int _webnet_module_system_uri_physical(struct webnet_session *session, int event)
{
    ...
    if (result == 1) return result;
# 88 "../../../packages/webnet-2.0.0/src/wn_module.c"
...
static void _webnet_dofile_handle(struct webnet_session *session, int event)
{
    ...
    if (event & (1 << 7))
    {
        ...
        if(session->request->Range)
        {
           ...
           lseek(fd, session->request->pos_start, 
# 116 "../../../packages/webnet-2.0.0/src/wn_module.c" 3 4
                                                 0
# 116 "../../../packages/webnet-2.0.0/src/wn_module.c"
                                                         );
...
int webnet_module_system_dofile(struct webnet_session *session)
{
    ...
    if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 158); };
    request = session->request;
    if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 160); };
# 222 "../../../packages/webnet-2.0.0/src/wn_module.c"
    mimetype = mime_get_type(request->path);
# 245 "../../../packages/webnet-2.0.0/src/wn_module.c"
    if (fd < 0)
    {
        fd = open(request->path, 00, 0);
    }
    ...
    file_length = lseek(fd, 0, 
# 257 "../../../packages/webnet-2.0.0/src/wn_module.c" 3 4
                              2
# 257 "../../../packages/webnet-2.0.0/src/wn_module.c"
                                      );

    lseek(fd, 0, 
# 259 "../../../packages/webnet-2.0.0/src/wn_module.c" 3 4
                0
# 259 "../../../packages/webnet-2.0.0/src/wn_module.c"
                        );
    ...
    if (request->Range)
    {
        ...
        if (lseek(fd, pos_start, 
# 303 "../../../packages/webnet-2.0.0/src/wn_module.c" 3 4
                                0
# 303 "../../../packages/webnet-2.0.0/src/wn_module.c"
                                        ) != pos_start)
        {
...
# 343 "../../../packages/webnet-2.0.0/src/wn_module.c"
...
# 380 "../../../packages/webnet-2.0.0/src/wn_module.c"
    ...
    if (request->method != WEBNET_HEADER)
    {
        ...
        session->session_event_mask = (1 << 7);
...
static int _webnet_module_system_uri_post(struct webnet_session *session, int event)
{
    int result;
    result = 0;
# 427 "../../../packages/webnet-2.0.0/src/wn_module.c"
    ...
    if (result == 1) return result;
# 442 "../../../packages/webnet-2.0.0/src/wn_module.c"
...
int webnet_module_handle_event(struct webnet_session *session, int event)
{
    ...
    default:
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 484); };
        break;
    }
...
int webnet_module_handle_uri(struct webnet_session *session)
{
    ...
    if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 513); };

    request = session->request;
    if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 516); };


    result = webnet_module_handle_event(session, (1 << 1));
    if (result == 1) return result;


    full_path = (char *) rt_malloc(256);
    if (!(full_path != (0))) { rt_assert_handler("full_path != RT_NULL", __FUNCTION__, 524); };
    ...
    index = 0;
    while (default_files[index] != (0))
    {

        rt_snprintf(full_path, 256, "%s/%s%s",
                    webnet_get_root(), request->path, default_files[index]);

        str_normalize_path(full_path);

        fd = open(full_path, 00, 0);
        if (fd >= 0)
        {
...
_end_default_files:
    ...
    if (default_files[index] == (0))
    {

        rt_snprintf(full_path, 256, "%s/%s", webnet_get_root(), request->path);
    ...
    return webnet_module_handle_event(session, (1 << 2));
}
