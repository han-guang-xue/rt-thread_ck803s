# 1 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
# 48 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
...
# 49 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c" 2

# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/inet_chksum.h" 1
# 42 "../../../components/net/lwip-2.0.2/src/include/lwip/inet_chksum.h"
...
# 51 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c" 2
# 61 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
u16_t lwip_standard_chksum(const void *dataptr, int len);
# 132 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
u16_t
...
# 259 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
static u16_t
__attribute__((section(".fast"))) inet_cksum_pseudo_base(struct pbuf *p, u8_t proto, u16_t proto_len, u32_t acc)
{
  ...
  for (q = p; q != 
# 266 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c" 3 4
                  0
# 266 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
                      ; q = q->next) {
...
# 309 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
u16_t
...
# 378 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
u16_t
__attribute__((section(".fast"))) ip_chksum_pseudo(struct pbuf *p, u8_t proto, u16_t proto_len,
       const ip_addr_t *src, const ip_addr_t *dest)
{
# 391 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
  {
       ...
       u16_t chksum_len, u32_t acc)
{
  ...
  for (q = p; (q != 
# 407 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c" 3 4
                   0
# 407 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
    ...
    chksum_len -= chklen;
    do { if (!(chksum_len < 0x7fff)) { do {rt_kprintf("delete me"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/inet_chksum.c", 416);}while(0); }} while(0);
...
# 455 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
u16_t
...
# 567 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
u16_t
__attribute__((section(".fast"))) inet_chksum_pbuf(struct pbuf *p)
{
  ...
  swapped = 0;
  for (q = p; q != 
# 576 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c" 3 4
                  0
# 576 "../../../components/net/lwip-2.0.2/src/core/inet_chksum.c"
                      ; q = q->next) {
    acc += lwip_standard_chksum(q->payload, q->len);
    acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
    if (q->len % 2 != 0) {
