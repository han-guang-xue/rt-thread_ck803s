...
# 43 "../../../components/finsh/shell.c" 2
# 1 "../../../components/finsh/shell.h" 1
# 49 "../../../components/finsh/shell.h"
...
# 47 "../../../components/finsh/shell.c" 2
# 59 "../../../components/finsh/shell.c"
...
const char *finsh_get_prompt()
{
    ...
    static char finsh_prompt[256 + 1] = {0};
    ...
    getcwd(&finsh_prompt[rt_strlen(finsh_prompt)], 256 - rt_strlen(finsh_prompt));
...
# 131 "../../../components/finsh/shell.c"
rt_uint32_t finsh_get_prompt_mode(void)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 133); };
    return shell->prompt_mode;
}
# 146 "../../../components/finsh/shell.c"
void finsh_set_prompt_mode(rt_uint32_t prompt_mode)
{
...
static char finsh_getchar(void)
{
    ...
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 156); };
...
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 165); };
...
# 180 "../../../components/finsh/shell.c"
void finsh_set_device(const char *device_name)
{
    rt_device_t dev = (0);

    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 184); };
...
# 221 "../../../components/finsh/shell.c"
const char *finsh_get_device()
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 223); };
    return shell->device->parent.name;
}
# 236 "../../../components/finsh/shell.c"
void finsh_set_echo(rt_uint32_t echo)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 238); };
    shell->echo_mode = (rt_uint8_t)echo;
}
# 249 "../../../components/finsh/shell.c"
...
# 411 "../../../components/finsh/shell.c"
static rt_bool_t shell_handle_history(struct finsh_shell *shell)
{
# 422 "../../../components/finsh/shell.c"
    rt_kprintf("\033[2K\r");
...
# 511 "../../../components/finsh/shell.c"
    rt_kprintf(finsh_get_prompt());

    while (1)
    {
        ch = finsh_getchar();
# 524 "../../../components/finsh/shell.c"
        if (ch == 0x1b)
        {
...
# 835 "../../../components/finsh/shell.c"
    ...
    tid = rt_thread_create("tshell",
                           ...
                           4096, 20, 10);
# 854 "../../../components/finsh/shell.c"
    rt_sem_init(&(shell->rx_sem), "shrx", 0, 0);
    finsh_set_prompt_mode(1);

    if (tid != ((void *)0) && result == 0)
        rt_thread_startup(tid);
    return 0;
}
const init_fn_t __rt_init_finsh_system_init __attribute__((section(".rti_fn.""6"))) = finsh_system_init;
