# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c"
# 14 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c"
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 15 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c" 2

# 1 "../libraries/inc/tih/wdt.h" 1
...
int wdt_hw_init(wdt_config_t *config);
void wdt_intr_enable(void);
void wdt_intr_disable(void);
unsigned int wdt_intr_status(void);
void wdt_intr_clear(unsigned int intr_status);
void wdt_start(void);
void wdt_stop(void);
void wdt_feed(void);


void chip_reset(unsigned int target);
# 17 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c" 2
# 1 "../libraries/inc/tih/core_ck803.h" 1
# 18 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c" 2
...
# 112 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/libcpu/c-sky/ck803/cpuport.c"
    }
    chip_reset(0);
    while (1);
}
...
void rt_hw_cpu_shutdown(void)
{
    ...
    if (!(0)) { rt_assert_handler("0", __FUNCTION__, 124); };
}
