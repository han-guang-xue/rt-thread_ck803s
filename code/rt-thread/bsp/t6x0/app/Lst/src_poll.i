# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c"
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c"
...
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
void xmem_init(void);
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
# 32 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
# 33 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
# 34 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
# 35 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/src/poll.c" 2
...
static int __attribute__((section(".fast"))) __wqueue_pollwake(struct rt_wqueue_node *wait, void *key)
{
    ...
    pn = ((struct rt_poll_node *)((char *)(wait) - (unsigned long)(&((struct rt_poll_node *)0)->wqn)));
    pn->pt->triggered = 1;

    return __wqueue_default_wake(wait, key);
}

static void __attribute__((section(".fast"))) _poll_add(rt_wqueue_t *wq, rt_pollreq_t *req)
{
    struct rt_poll_table *pt;
    ...
    pt = ((struct rt_poll_table *)((char *)(req) - (unsigned long)(&((struct rt_poll_table *)0)->req)));
...
static void __attribute__((section(".fast"))) poll_table_init(struct rt_poll_table *pt)
{
...
static int __attribute__((section(".fast"))) poll_wait_timeout(struct rt_poll_table *pt, int msec)
{
    rt_int32_t timeout;
    int ret = 0;
...
static int __attribute__((section(".fast"))) do_pollfd(struct pollfd *pollfd, rt_pollreq_t *req)
{
    int mask = 0;
    int fd;
    ...
    if (fd >= 0)
    {
        ...
        if (f)
        {
            mask = ((0x01) | (0x02) | (0x01) | (0x02));
            if (f->fops->poll)
            {
                req->_key = pollfd->events | (0x04)| (0x08);

                mask = f->fops->poll(f, req);
            }

            mask &= pollfd->events | (0x04) | (0x08);
            fd_put(f);
        }
    }
    pollfd->revents = mask;
...
static int __attribute__((section(".fast"))) poll_do(struct pollfd *fds, nfds_t nfds, struct rt_poll_table *pt, int msec)
{
    int num;
    int istimeout = 0;
    int n;
...
static void __attribute__((section(".fast"))) poll_teardown(struct rt_poll_table *pt)
{
...
int __attribute__((section(".fast"))) poll(struct pollfd *fds, nfds_t nfds, int timeout)
{
    int num;
