# 1 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
# 45 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
...
# 46 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 2
...
# 50 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 2
...
# 51 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 2
# 62 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
struct
netbuf * __attribute__((section(".fast"))) netbuf_new(void)
{
  ...
  if (buf != 
# 68 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
            0
# 68 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                ) {
...
{
  if (buf != 
# 83 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
            0
# 83 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                ) {
    if (buf->p != 
# 84 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
                 0
# 84 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                     ) {
      pbuf_free(buf->p);
      buf->p = buf->ptr = 
# 86 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
                         0
# 86 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                             ;
    }
    memp_free(MEMP_NETBUF, buf);
  }
}
# 101 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
void *
__attribute__((section(".fast"))) netbuf_alloc(struct netbuf *buf, u16_t size)
{
  do { if (!((buf != 
# 104 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 104 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_alloc: invalid buf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 104);}while(0); return 
# 104 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 104 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ;;}} while(0);
  ...
  if (buf->p != 
# 107 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
               0
# 107 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                   ) {
    pbuf_free(buf->p);
  }
  buf->p = pbuf_alloc(PBUF_TRANSPORT, size, PBUF_RAM);
  if (buf->p == 
# 111 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
               0
# 111 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                   ) {
     return 
# 112 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
           0
# 112 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
               ;
  }
...
# 114 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
  ,
                                  115
# 114 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
  );}while(0); }} while(0)
...
{
  do { if (!((buf != 
# 129 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 129 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_free: invalid buf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 129);}while(0); return;;}} while(0);
  if (buf->p != 
# 130 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
               0
# 130 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                   ) {
    pbuf_free(buf->p);
  }
  buf->p = buf->ptr = 
# 133 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
                     0
# 133 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                         ;
}
# 146 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
err_t
__attribute__((section(".fast"))) netbuf_ref(struct netbuf *buf, const void *dataptr, u16_t size)
{
  do { if (!((buf != 
# 149 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 149 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_ref: invalid buf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 149);}while(0); return ERR_ARG;;}} while(0);
  if (buf->p != 
# 150 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
               0
# 150 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                   ) {
    pbuf_free(buf->p);
  }
  buf->p = pbuf_alloc(PBUF_TRANSPORT, 0, PBUF_REF);
  if (buf->p == 
# 154 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
               0
# 154 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                   ) {
    buf->ptr = 
# 155 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
              0
# 155 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                  ;
    return ERR_MEM;
  }
...
# 171 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
void
__attribute__((section(".fast"))) netbuf_chain(struct netbuf *head, struct netbuf *tail)
{
  do { if (!((head != 
# 174 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 174 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_chain: invalid head"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 174);}while(0); return;;}} while(0);
  do { if (!((tail != 
# 175 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 175 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_chain: invalid tail"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 175);}while(0); return;;}} while(0);
  pbuf_cat(head->p, tail->p);
  head->ptr = head->p;
  memp_free(MEMP_NETBUF, tail);
}
# 191 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
err_t
netbuf_data(struct netbuf *buf, void **dataptr, u16_t *len)
{
  do { if (!((buf != 
# 194 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 194 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_data: invalid buf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 194);}while(0); return ERR_ARG;;}} while(0);
  do { if (!((dataptr != 
# 195 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 195 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_data: invalid dataptr"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 195);}while(0); return ERR_ARG;;}} while(0);
  do { if (!((len != 
# 196 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 196 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_data: invalid len"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 196);}while(0); return ERR_ARG;;}} while(0);

  if (buf->ptr == 
# 198 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
                 0
# 198 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                     ) {
    return ERR_BUF;
  }
...
# 217 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
s8_t
netbuf_next(struct netbuf *buf)
{
  do { if (!((buf != 
# 220 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 220 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_next: invalid buf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 220);}while(0); return -1;;}} while(0);
  if (buf->ptr->next == 
# 221 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
                       0
# 221 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                           ) {
    return -1;
  }
  buf->ptr = buf->ptr->next;
  if (buf->ptr->next == 
# 225 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
                       0
# 225 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
                           ) {
    return 1;
  }
  return 0;
}
# 239 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
void
netbuf_first(struct netbuf *buf)
{
  do { if (!((buf != 
# 242 "../../../components/net/lwip-2.0.2/src/api/netbuf.c" 3 4
 0
# 242 "../../../components/net/lwip-2.0.2/src/api/netbuf.c"
 ))) { do {rt_kprintf("netbuf_first: invalid buf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netbuf.c", 242);}while(0); return;;}} while(0);
  buf->ptr = buf->p;
}
