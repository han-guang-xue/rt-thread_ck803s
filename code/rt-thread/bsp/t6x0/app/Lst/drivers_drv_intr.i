# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_intr.c"
...
# 2 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_intr.c" 2
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 3 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_intr.c" 2
# 1 "../libraries/inc/tih/core_ck803.h" 1
# 4 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_intr.c" 2
...
# 5 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_intr.c" 2


struct rt_irq_desc irqs[32U];
...
void rt_hw_interrupt_init(void)
{
    ...
    rt_memset((void *)((unsigned int)&irq_stack_offset - 0xfff), 0x23, 0x10);
}

void __attribute__((section(".fast"))) rt_hw_interrupt_mask(int vector)
{
    intr_disable(vector);
}

void __attribute__((section(".fast"))) rt_hw_interrupt_umask(int vector)
{
    intr_enable(vector);
}

void __attribute__((section(".fast"))) rt_hw_interrupt_clear(int vevtor)
{
    csi_vic_clear_pending_irq(vevtor);
}

rt_isr_handler_t __attribute__((section(".fast"))) rt_hw_interrupt_install(int vector,
                                                rt_isr_handler_t handler,
                                                void *param,
                                                char *name)
{
...
void __attribute__((section(".fast"))) rt_hw_interrupt_dispatch(unsigned int nintr)
{
    rt_isr_handler_t handler;
