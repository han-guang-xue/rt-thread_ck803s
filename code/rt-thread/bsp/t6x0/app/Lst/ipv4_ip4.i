# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
# 41 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
...
# 42 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 46 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 49 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 50 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 52 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
void igmp_tmr(void);
# 53 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 54 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 55 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 56 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/autoip.h" 1
# 57 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
...
# 59 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 2
# 107 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
static u16_t ip_id;
...
# 151 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
struct netif *
...
# 164 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                                   0
# 164 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                       ; netif = netif->next) {
...
# 209 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
  if ((netif_default == 
# 209 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                       0
# 209 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
    ...
    for (netif = netif_list; netif != 
# 215 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                                     0
# 215 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                         ; netif = netif->next) {
    ...
    if (netif == 
# 222 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                0
# 222 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                    ) {
      for (netif = netif_list; netif != 
# 223 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                                       0
# 223 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                           ; netif = netif->next) {
    ...
    ;
    return 
# 236 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
          0
# 236 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
              ;
  }

  return netif_default;
}
# 250 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
static int
...
# 286 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
static void
__attribute__((section(".fast"))) ip4_forward(struct pbuf *p, struct ip_hdr *iphdr, struct netif *inp)
{
  ...
  if (netif == 
# 308 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
              0
# 308 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                  ) {
...
# 347 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
...
# 394 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
err_t
...
# 428 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
...
# 481 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
...
# 492 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
         0 
# 492 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
      ...
      netif = 
# 497 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
             0
# 497 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                 ;
    }
...
# 544 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
      }
      if (first) {
        ...
        if (((((&ip_data.current_iphdr_dest))->addr & ((((0xff000000) & 0x000000ffUL) << 24) | (((0xff000000) & 0x0000ff00UL) << 8) | (((0xff000000) & 0x00ff0000UL) >> 8) | (((0xff000000) & 0xff000000UL) >> 24))) == ((((((u32_t)127) << 24) & 0x000000ffUL) << 24) | (((((u32_t)127) << 24) & 0x0000ff00UL) << 8) | (((((u32_t)127) << 24) & 0x00ff0000UL) >> 8) | (((((u32_t)127) << 24) & 0xff000000UL) >> 24)))) {
          netif = 
# 551 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                 0
# 551 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                     ;
          break;
        }
...
# 563 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                     0
# 563 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                         );
  }
# 576 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
  if (netif == 
# 576 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
              0
# 576 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                  ) {
  ...
  if (netif == 
# 615 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
              0
# 615 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                  ) {
  ...
  if ((((iphdr)->_offset) & ((((0x1fffU | 0x2000U) & 0x00ffUL) << 8) | (((0x1fffU | 0x2000U) & 0xff00UL) >> 8))) != 0) {
    ...
    if (p == 
# 641 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
            0
# 641 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                ) {
      return ERR_OK;
    }
    iphdr = (struct ip_hdr *)p->payload;
# 655 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
  }
# 676 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
  ;
  ;
  ;
...
# 740 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                         0
# 740 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                             ;
  ip_data.current_input_netif = 
# 741 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                               0
# 741 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                   ;
  ip_data.current_ip4_header = 
# 742 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                              0
# 742 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                  ;
...
# 775 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
err_t
...
# 781 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                                                                0
# 781 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                                                    , 0);
}
       ...
       u16_t optlen)
{
  ...
  if (dest != 
# 797 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
             0
# 797 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                            ) {
    if (((src) == 
# 798 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
       0 
# 798 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
...
# 821 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                                                                    0
# 821 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                                                        , 0);
}
       ...
       u16_t optlen)
{
  ...
  do { if (!((p)->ref == 1)) { do {rt_kprintf("p->ref == 1"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c", 840);}while(0); }} while(0);

  ;


  if (dest != 
# 845 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
             0
# 845 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                            ) {
    u16_t ip_hlen = 20;
...
# 885 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
    ,
                                                886
# 885 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
    );}while(0); }} while(0)
    ...
    if (src == 
# 917 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
              0
# 917 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                  ) {
...
# 939 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
    (iphdr)->_chksum = (0);
  ...
  ;
  ;
# 975 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
  if (netif->mtu && (p->tot_len > netif->mtu)) {
...
# 1001 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
err_t
          ...
          u8_t ttl, u8_t tos, u8_t proto)
{
  ...
  do { if (!((p)->ref == 1)) { do {rt_kprintf("p->ref == 1"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c", 1007);}while(0); }} while(0);

  if ((netif = ip4_route(dest)) == 
# 1009 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c" 3 4
                                           0
# 1009 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4.c"
                                               ) {
