# 1 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
# 42 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
...
# 43 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2

# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/timeouts.h" 1
# 42 "../../../components/net/lwip-2.0.2/src/include/lwip/timeouts.h"
...
# 45 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
# 46 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
# 50 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
# 52 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
# 53 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
# 54 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/autoip.h" 1
# 55 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
void igmp_tmr(void);
# 56 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 57 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/nd6.h" 1
# 58 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/ip6_frag.h" 1
# 59 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/mld6.h" 1
# 60 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 2
# 71 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
const struct lwip_cyclic_timer lwip_cyclic_timers[] = {
  ...
  {1000, dns_tmr},
# 107 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
};
...
# 134 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                                                  0
# 134 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                                                      );
  } else {
...
__attribute__((section(".fast"))) tcp_timer_needed(void)
{
  ...
  if (!tcpip_tcp_timer_active && (tcp_active_pcbs || tcp_tw_pcbs)) {
    ...
    sys_timeout(250, tcpip_tcp_timer, 
# 153 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                                                  0
# 153 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                                                      );
  }
}
...
# 203 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
void
...

{
  ...
  if (timeout == 
# 211 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                0
# 211 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                    ) {
    do { if (!(timeout != 
# 212 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
   0
# 212 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
   )) { do {rt_kprintf("sys_timeout: timeout != NULL, pool MEMP_SYS_TIMEOUT is empty"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/timeouts.c", 212);}while(0); }} while(0);
    return;
  }

  now = sys_now();
  if (next_timeout == 
# 217 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                     0
# 217 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                         ) {
    diff = 0;
  ...
  timeout->next = 
# 224 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                 0
# 224 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                     ;
  timeout->h = handler;
  timeout->arg = arg;
  ...
  if (next_timeout == 
# 234 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                     0
# 234 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                         ) {
...
# 244 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                               0
# 244 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                                   ; t = t->next) {
      timeout->time -= t->time;
      if (t->next == 
# 246 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                    0 
# 246 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                         || t->next->time > timeout->time) {
        if (t->next != 
# 247 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                      0
# 247 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                          ) {
          t->next->time -= timeout->time;
...
# 272 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
void
__attribute__((section(".fast"))) sys_untimeout(sys_timeout_handler handler, void *arg)
{
  ...
  if (next_timeout == 
# 277 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                     0
# 277 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                         ) {
    return;
  }

  for (t = next_timeout, prev_t = 
# 281 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                                 0
# 281 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                                     ; t != 
# 281 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                                            0
# 281 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
    ...
    if ((t->h == handler) && (t->arg == arg)) {
      ...
      if (prev_t == 
# 285 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                   0
# 285 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                       ) {
        next_timeout = t->next;
      } else {
        prev_t->next = t->next;
      ...
      if (t->next != 
# 291 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                    0
# 291 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                        ) {
        t->next->time += t->time;
      }
...
# 310 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
static
  ...
  if (next_timeout) {
    ...
    do {
      ...
      if (tmptimeout && (tmptimeout->time <= diff)) {
        ...
        if (handler != 
# 345 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                      0
# 345 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                          ) {
...
__attribute__((section(".fast"))) sys_timeouts_sleeptime(void)
{
  u32_t diff;
  if (next_timeout == 
# 384 "../../../components/net/lwip-2.0.2/src/core/timeouts.c" 3 4
                     0
# 384 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
                         ) {
    return 0xffffffff;
  }
...
# 404 "../../../components/net/lwip-2.0.2/src/core/timeouts.c"
void
