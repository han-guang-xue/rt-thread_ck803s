# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c"
# 25 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c"
...
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2



# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pk_internal.h" 1
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pk_internal.h"
...
# 28 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md.h"
...
# 29 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md.h" 2
...
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/rsa.h"
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/rsa.h" 2
...
# 34 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pk_internal.h" 2
...
struct mbedtls_pk_info_t
{
    ...
    void (*debug_func)( const void *ctx, mbedtls_pk_debug_item *items );
     ...
     int (*z_get_func)( void *ctx, unsigned char *z, size_t z_len );
...
extern const mbedtls_pk_info_t mbedtls_ecdsa_sm2_info;
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
...
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2

# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/rsa.h" 1
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/bignum.h" 1
# 34 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2


# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecp.h" 1
# 39 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2



# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdsa.h" 1
# 43 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
...
# 10 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sm2.h"
...
# 47 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 51 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
# 61 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c"
# 1 "d:\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\lib\\gcc\\csky-elfabiv2\\6.3.0\\include-fixed\\limits.h" 1 3 4
# 62 "../../../packages/mbedtls-2.6.0/mbedtls/library/pk_wrap.c" 2
                   ...
                   int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    int ret;
    size_t len;
    const unsigned char *end = ((void *)0);
    ...
    if( ( ret = mbedtls_asn1_get_tag( p, end, &C3.len, 0x04 ) ) != 0 )
        goto cleanup;
    ...
    *p += C3.len;
    ...
    if( ( ret = mbedtls_asn1_get_tag( p, end, &C2.len, 0x04 ) ) != 0 )
        goto cleanup;
                   ...
                   int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    ...
    if( ret == 0 && data_len > 0 )
    {
        ...
        do { if( ( ret = mbedtls_asn1_write_raw_buffer( p, start, C3, data_len ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        do { if( ( ret = mbedtls_asn1_write_len( p, start, len ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x04 ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        total_len += len;
        len = 0;

        do { if( ( ret = mbedtls_asn1_write_raw_buffer( p, start, C2, 32 ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        do { if( ( ret = mbedtls_asn1_write_len( p, start, len ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x04 ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        ...
        do { if( ( ret = mbedtls_asn1_write_mpi( p, start, &Y) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;

        total_len += len;
        len = 0;

        mbedtls_mpi_read_binary( &X, x, 32 );
        do { if( ( ret = mbedtls_asn1_write_mpi( p, start, &X ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        total_len += len;
        len = 0;

        do { if( ( ret = mbedtls_asn1_write_len( p, start, total_len ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );;
        total_len += len;
        len = 0;
        do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x20 | 0x10 ) ) < 0 ) {ret = -1; goto cleanup;} else {len += ret;ret = 0;} } while( 0 );
                                                                                               ;
...
{
    void *ctx = calloc( 1, sizeof( mbedtls_ecdsa_sm2_context ) );
