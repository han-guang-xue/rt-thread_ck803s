# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.c"
# 19 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.c"
...
# 20 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.c" 2



# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.h" 1
# 15 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.h"
#define __STRING_H__ 
...
# 24 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/string.c" 2


char __attribute__((section(".fast"))) *strcpy(char *dest, const char *src)
{
 return (char *)rt_strncpy(dest, src, rt_strlen(src) + 1);
}

char __attribute__((section(".fast"))) *strncpy(char *dest, const char *src, size_t siz)
{
 return (char *)rt_strncpy(dest, src, siz);
}

size_t __attribute__((section(".fast"))) strlcpy(char *dst, const char *src, size_t siz)
{
 register char *d = dst;
...
int __attribute__((section(".fast"))) strcmp (const char *s1, const char *s2)
{
 while (*s1 && *s1 == *s2)
  s1++, s2++;
 return (*s1 - *s2);
...
int __attribute__((section(".fast"))) strncmp(const char *cs,const char *ct, size_t count)
{
...
char __attribute__((section(".fast"))) *strcat(char * dest, const char * src)
{
 char *tmp = dest;
...
char __attribute__((section(".fast"))) *strncat(char *dest, const char *src, size_t count)
{
 char *tmp = dest;
...
char __attribute__((section(".fast"))) *strrchr(const char *t, int c)
{
 register char ch;
...
int __attribute__((section(".fast"))) strncasecmp ( const char* s1, const char* s2, size_t len )
{
...
static __inline int __attribute__((section(".fast"))) divide(int *n, int base)
{
 rt_int32_t res;
...
{
 register int i=0;
 while (((unsigned)((**s) - '0') < 10)) i = i*10 + *((*s)++) - '0';
...
static inline unsigned char __attribute__((section(".fast"))) __tolower(unsigned char c)
{
...
static inline unsigned char __attribute__((section(".fast"))) __toupper(unsigned char c)
{
...
int __attribute__((section(".fast"))) tolower(int c)
{
 return __tolower(c);
}

int __attribute__((section(".fast"))) toupper(int c)
{
 return __toupper(c);
}
...
unsigned long __attribute__((section(".fast"))) simple_strtoul(const char *cp,char **endp,unsigned int base)
{
 ...
 if (!base) {
  ...
  if (*cp == '0') {
   base = 8;
   cp++;
   if ((toupper(*cp) == 'X') && (((_ctype[(int)(unsigned char)(cp[1])])&(0x04|0x40)) != 0)) {
    cp++;
    base = 16;
   }
  }
 ...
 while ((((_ctype[(int)(unsigned char)(*cp)])&(0x04|0x40)) != 0) &&
        (value = ((unsigned)((*cp) - '0') < 10) ? *cp-'0' : toupper(*cp)-'A'+10) < base) {
...
long __attribute__((section(".fast"))) simple_strtol(const char *cp,char **endp,unsigned int base)
{
 if(*cp=='-')
...
unsigned long long __attribute__((section(".fast"))) simple_strtoull(const char *cp,char **endp,unsigned int base)
{
 ...
 while ((((_ctype[(int)(unsigned char)(*cp)])&(0x04|0x40)) != 0) && (value = ((unsigned)((*cp) - '0') < 10)
    ? *cp - '0'
    : ((((_ctype[(int)(unsigned char)(*cp)])&(0x02)) != 0) ? toupper (*cp) : *cp) - 'A' + 10) < base) {
  result = result * base + value;
  cp++;
 }
 if (endp)
...
long long __attribute__((section(".fast"))) simple_strtoll(const char *cp,char **endp,unsigned int base)
{
 if(*cp=='-')
...
int __attribute__((section(".fast"))) vsscanf(const char * buf, const char * fmt, va_list args)
{
 const char *str = buf;
 char *next;
 int num = 0;
 ...
 while(*fmt && *str) {
  ...
  case 'Z':
  {
   unsigned long *s = (unsigned long*) __builtin_va_arg(args,unsigned long*);
...
int __attribute__((section(".fast"))) sscanf(const char * buf, const char * fmt, ...)
{
 va_list args;
 int i;
...
size_t __attribute__((section(".fast"))) strspn(const char *s, const char *accept)
{
 size_t l=0;
...
size_t __attribute__((section(".fast"))) strcspn(const char *s, const char *reject)
{
 size_t l=0;
...
char * __attribute__((section(".fast"))) strtok_r(char*s,const char*delim,char**ptrptr)
{
 char*tmp=0;
...
char * __attribute__((section(".fast"))) strtok(char *s, const char *delim)
{
 static char *strtok_pos;
 return strtok_r(s,delim,&strtok_pos);
}

char * __attribute__((section(".fast"))) strchr(const char *s1, int i)
{
...
long __attribute__((section(".fast"))) strtol(const char *str, char **endptr, int base)
{
    return simple_strtol(str, endptr, base);
}

long long __attribute__((section(".fast"))) strtoll(const char *str, char **endptr, int base)
{
