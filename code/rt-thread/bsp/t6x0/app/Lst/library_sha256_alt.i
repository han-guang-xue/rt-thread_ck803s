# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
...
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sha256.h" 1
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sha256.h"
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sha256.h" 2
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c" 2
...
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c" 2
...
# 44 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c" 2
# 53 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
...
int tih_mpi_inv_mod(const unsigned int *modulus, const unsigned int *a, unsigned int *ainv,
                      unsigned int mod_nword, unsigned int a_nword);
# 54 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c" 2
...
# 84 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
void mbedtls_sha256_init( mbedtls_sha256_context *ctx )
{
...
# 204 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
void mbedtls_sha256_process( mbedtls_sha256_context *ctx, const unsigned char data[64] )
{
    ...
    for( i = 0; i < 8; i++ )
        A[i] = ctx->state[i];
# 227 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha256_alt.c"
    for( i = 0; i < 16; i++ )
                    ...
                    size_t ilen )
{
    ...
    else
    {
        if ( ctx->is224 )
        {
            tih_sha224_update( (unsigned char *)input, ilen );
        }
        else
        {
            tih_sha256_update( (unsigned char *)input, ilen );
        }
    }
}
...
void mbedtls_sha256_finish( mbedtls_sha256_context *ctx, unsigned char output[32] )
{
    ...
    else
    {
        if ( ctx->is224 )
        {
            tih_sha224_final( output );
        }
        else
        {
            tih_sha256_final( output );
        }
    }
}
