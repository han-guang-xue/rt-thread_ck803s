# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c"
...
# 2 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
...
# 3 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
...
# 4 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
...
int getaddrinfo(const char *nodename,
       ...
       const struct addrinfo *hints,
       struct addrinfo **res);
# 5 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
...
# 6 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
# 1 "../../../components/dfs/filesystems/net/select/sys/select.h" 1
# 26 "../../../components/dfs/filesystems/net/select/sys/select.h"
#define SELECT_H__ 
...
# 7 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
# 1 "../../../components/dfs/filesystems/net/netinet/in.h" 1
# 26 "../../../components/dfs/filesystems/net/netinet/in.h"
#define IN_H__ 
...
# 8 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
# 1 "../../../components/dfs/filesystems/net/netinet/udp.h" 1
# 48 "../../../components/dfs/filesystems/net/netinet/udp.h"
...
#define SOL_UDP 17
# 9 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
# 1 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h" 1
# 19 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h"
#define __NETINET_IP_ICMP_H 1

# 1 "d:\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\sys\\cdefs.h" 1 3 4

#define _SYS_STAT_H 1
# 22 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h" 2
...
# 125 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h"
# 1 "../../../components/dfs/filesystems/net/netinet/ip.h" 1
# 19 "../../../components/dfs/filesystems/net/netinet/ip.h"
#define __NETINET_IP_H 1
# 29 "../../../components/dfs/filesystems/net/netinet/ip.h"
struct ip
{
...
# 132 "../../../components/dfs/filesystems/net/netinet/ip.h"
...
#define IP_MSS 576
# 126 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h" 2
...
# 210 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h"
...
# 224 "../../../components/dfs/filesystems/net/netinet/ip_icmp.h"
...
# 10 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
# 1 "../../../components/dfs/filesystems/net/arpa/inet.h" 1
# 26 "../../../components/dfs/filesystems/net/arpa/inet.h"
#define INET_H__ 
# 11 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
...
int iprawtest(int argc, char **argv)
{
    ...
    hints.ai_family = 2;
    hints.ai_socktype = 1;
    hints.ai_flags = hints.ai_flags | 0x02;


    if (getaddrinfo(url, 
# 86 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 3 4
                        (0)
# 86 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c"
                            , &hints, &res) != 0)
    {
    ...
    while (count--)
    {
        ...
        {
            bytes_read = recv(sock, recvbuf, 512, 0);
            if (bytes_read > 0)
            {
        ...
        else if (strcmp(argv[3], "recvfrom") == 0)
        {
            ...
            bytes_read = recvfrom(sock, recvbuf, 512, 0, (struct sockaddr *)&server_addr, &len);
            if (bytes_read > 0)
            {
                data_print(recvbuf, bytes_read);
            }
        ...
        {
            _types_fd_set readset, writeset, excepttset;
            struct timeval timeout;
            int status;

            memset((void*)(&readset), 0, sizeof(*(&readset)));
            memset((void*)(&writeset), 0, sizeof(*(&writeset)));
            memset((void*)(&excepttset), 0, sizeof(*(&excepttset)));
            ((&readset)->fds_bits[(sock)/(sizeof (fd_mask) * 8)] |= (1L << ((sock) % (sizeof (fd_mask) * 8))));

            timeout.tv_sec = 1;
            timeout.tv_usec = 0;
            printf("select() startup! tick=%ld\n", rt_tick_get() * (1000/100));
...
# 193 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/app/entry/ipraw.c" 2
const char __fsym___cmd_iprawtest_name[] __attribute__((section(".rodata.name"))) = "__cmd_iprawtest"; const char __fsym___cmd_iprawtest_desc[] __attribute__((section(".rodata.name"))) = "startup AP_INET raw socket"; const struct finsh_syscall __fsym___cmd_iprawtest __attribute__((section("FSymTab")))= { __fsym___cmd_iprawtest_name, __fsym___cmd_iprawtest_desc, (syscall_func)&iprawtest };;
