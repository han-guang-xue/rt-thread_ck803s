# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c"
# 21 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c"
...
# 22 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 32 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 33 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 36 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
#define LWIP_PERF 0
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/inet.h" 2
...
# 43 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 44 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 45 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 56 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
# 61 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
...
static int sendto_ntp_server(int sockfd, const char *host_name, struct sockaddr_in *serv_addr)
{
    ...
    else
    {
        ...
        serv_addr->sin_port = lwip_htons(portno);
...
# 166 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c"
...
#define NTP_SERVER_NUM 3
    ...
    time_t new_time = 0;
    socklen_t addr_len = sizeof(struct sockaddr_in);
    const char *const host_name_buf[3] = {"cn.ntp.org.cn", "ntp.rt-thread.org", "edu.ntp.org.cn"};
...
#define NTP_INTERNET_DATE_LEN 16
        ...
        rt_snprintf(date, 16, "%s", "Nov 17 2020");
...
#define netdev_default netif_default
            ...
            extern struct netif *netif_default;
            struct netif *dev = netif_default;
        ...
        for (index = 0; index < 14 - sizeof(check); index++)
        {
            check += (uint8_t)send_data[index];
        }
        send_data[14 - 2] = check >> 8;
        send_data[14 - 1] = check & 0xFF;

        rt_memcpy(((char *)&packet + 4), send_data, 14);
    }
    ...
    else
    {
        ...
        for (i = 0; i < 3; i++)
        {
            if (host_name_buf[i] == ((void *)0) || strlen(host_name_buf[i]) == 0)
                continue;
    ...
    start = rt_tick_get();
    while (rt_tick_get() <= start + 5 * 100)
    {
        for (i = 0; i < server_num; i++)
        {

            n = recvfrom(sockfd, (char *) &packet, sizeof(ntp_packet), 0x08, (struct sockaddr *)&serv_addr[i], &addr_len);
            if (n <= 0)
            {
                ;
            }
...
__exit:
    ...
    if (rt_tick_get() <= start + 5 * 100)
    {



        packet.txTm_s = lwip_htonl(packet.txTm_s);
        packet.txTm_f = lwip_htonl(packet.txTm_f);





        new_time = (time_t)(packet.txTm_s - 2208988800ull);
    }
    else
    {
        ;
...
# 340 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c"
...
# 361 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c"
...
# 416 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/packages/netutils-1.0.0/ntp/ntp.c" 2
const char __fsym_ntp_sync_name[] __attribute__((section(".rodata.name"))) = "ntp_sync"; const char __fsym_ntp_sync_desc[] __attribute__((section(".rodata.name"))) = "Update time by NTP(Network Time Protocol): ntp_sync(host_name)"; const struct finsh_syscall __fsym_ntp_sync __attribute__((section("FSymTab")))= { __fsym_ntp_sync_name, __fsym_ntp_sync_desc, (syscall_func)&ntp_sync };;
const char __fsym___cmd_ntp_sync_name[] __attribute__((section(".rodata.name"))) = "__cmd_ntp_sync"; const char __fsym___cmd_ntp_sync_desc[] __attribute__((section(".rodata.name"))) = "Update time by NTP(Network Time Protocol): ntp_sync [host_name]"; const struct finsh_syscall __fsym___cmd_ntp_sync __attribute__((section("FSymTab")))= { __fsym___cmd_ntp_sync_name, __fsym___cmd_ntp_sync_desc, (syscall_func)&cmd_ntp_sync };;
