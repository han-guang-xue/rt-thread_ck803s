# 1 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
# 39 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
...
# 40 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 2
...
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/tcpip.h"
...
# 44 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 2
...
void lwip_init(void);
# 48 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 2
...
# 49 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 2
...
# 51 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 2
...
# 52 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 2
...
# 86 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
static void
__attribute__((section(".fast"))) tcpip_thread(void *arg)
{
  ...
  if (tcpip_init_done != 
# 92 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 3 4
                        0
# 92 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
                            ) {
  ...
  while (1) {
    ...
    sys_mutex_lock(&lock_tcpip_core);
    if (msg == 
# 103 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 3 4
              0
# 103 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
                  ) {
      ;
      do { if (!(0)) { do {rt_kprintf("tcpip_thread: invalid message"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/tcpip.c", 105);}while(0); }} while(0);
      continue;
    }
    switch (msg->type) {
# 142 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
    ...
    default:
      ;
      do { if (!(0)) { do {rt_kprintf("tcpip_thread: invalid message"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/tcpip.c", 155);}while(0); }} while(0);
      break;
    }
  }
}
# 168 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
__attribute__((section(".fast"))) tcpip_inpkt(struct pbuf *p, struct netif *inp, netif_input_fn input_fn)
{
  ...
  sys_mutex_unlock(&lock_tcpip_core);
  return ret;
# 198 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
}
# 211 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
...
# 233 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
__attribute__((section(".fast"))) tcpip_callback_with_block(tcpip_callback_fn function, void *ctx, u8_t block)
{
  struct tcpip_msg *msg;

  do { if (!(sys_mbox_valid(&(mbox)))) { do {rt_kprintf("Invalid mbox"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/tcpip.c", 238);}while(0); }} while(0);

  msg = (struct tcpip_msg *)memp_malloc(MEMP_TCPIP_MSG_API);
  if (msg == 
# 241 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 3 4
            0
# 241 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
                ) {
    return ERR_MEM;
  }
...
# 328 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
__attribute__((section(".fast"))) tcpip_send_msg_wait_sem(tcpip_callback_fn fn, void *apimsg, sys_sem_t* sem)
{
  ...
  sys_mutex_unlock(&lock_tcpip_core);
  return ERR_OK;
# 352 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
}
# 364 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
__attribute__((section(".fast"))) tcpip_api_call(tcpip_api_call_fn fn, struct tcpip_api_call_data *call)
{
  ...
  sys_mutex_unlock(&lock_tcpip_core);
  return err;
# 404 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
}
# 414 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
struct tcpip_callback_msg*
tcpip_callbackmsg_new(tcpip_callback_fn function, void *ctx)
{
  struct tcpip_msg *msg = (struct tcpip_msg *)memp_malloc(MEMP_TCPIP_MSG_API);
  if (msg == 
# 418 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 3 4
            0
# 418 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
                ) {
    return 
# 419 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 3 4
          0
# 419 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
              ;
  }
...
# 445 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
tcpip_trycallback(struct tcpip_callback_msg* msg)
{
  do { if (!(sys_mbox_valid(&(mbox)))) { do {rt_kprintf("Invalid mbox"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/tcpip.c", 448);}while(0); }} while(0);
  return sys_mbox_trypost(&mbox, msg);
}
# 461 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
void
tcpip_init(tcpip_init_done_fn initfunc, void *arg)
{
  ...
  if (sys_mbox_new(&mbox, 8) != ERR_OK) {
    do { if (!(0)) { do {rt_kprintf("failed to create tcpip_thread mbox"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/tcpip.c", 469);}while(0); }} while(0);
  }

  if (sys_mutex_new(&lock_tcpip_core) != ERR_OK) {
    do { if (!(0)) { do {rt_kprintf("failed to create lock_tcpip_core"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/tcpip.c", 473);}while(0); }} while(0);
  }


  sys_thread_new("tcpip", tcpip_thread, 
# 477 "../../../components/net/lwip-2.0.2/src/api/tcpip.c" 3 4
                                                 0
# 477 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
                                                     , 2048, 10);
}
...
# 512 "../../../components/net/lwip-2.0.2/src/api/tcpip.c"
err_t
