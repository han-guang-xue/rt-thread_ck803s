# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c"
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c"
...
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sha1.h" 1
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sha1.h"
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sha1.h" 2
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c" 2
...
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c" 2
...
# 44 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c" 2
...
int tih_mpi_inv_mod(const unsigned int *modulus, const unsigned int *a, unsigned int *ainv,
                      unsigned int mod_nword, unsigned int a_nword);
# 51 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c" 2
...
# 81 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c"
void mbedtls_sha1_init( mbedtls_sha1_context *ctx )
{
    if( ((void *)0) == ctx )
        return;
...
# 166 "../../../packages/mbedtls-2.6.0/mbedtls/library/sha1_alt.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
...
void mbedtls_sha1_update( mbedtls_sha1_context *ctx, const unsigned char *input, size_t ilen )
{
    ...
    {
        tih_sha1_update( (unsigned char *)input, ilen );
    }
}
