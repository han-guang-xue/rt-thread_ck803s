...
# 1 "<command-line>"
# 1 "../../../components/drivers/cputime/cputime.c"
# 25 "../../../components/drivers/cputime/cputime.c"
...
# 26 "../../../components/drivers/cputime/cputime.c" 2


static const struct rt_clock_cputime_ops *_cputime_ops = (0);
...
# 67 "../../../components/drivers/cputime/cputime.c"
uint32_t clock_cpu_microsecond(uint32_t cpu_tick)
{
...
# 82 "../../../components/drivers/cputime/cputime.c"
uint32_t clock_cpu_millisecond(uint32_t cpu_tick)
{
    float unit = clock_cpu_getres();
...
int clock_cpu_setops(const struct rt_clock_cputime_ops *ops)
{
    ...
    if (ops)
    {
        if (!(ops->cputime_getres != (0))) { rt_assert_handler("ops->cputime_getres != RT_NULL", __FUNCTION__, 99); };
        if (!(ops->cputime_gettime != (0))) { rt_assert_handler("ops->cputime_gettime != RT_NULL", __FUNCTION__, 100); };
    }
