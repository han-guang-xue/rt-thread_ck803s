# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
# 35 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
...
# 36 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c" 2
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 37 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c" 2


static rt_list_t rt_timer_list[1];
# 58 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
extern void (*rt_object_take_hook)(struct rt_object *object);
extern void (*rt_object_put_hook)(struct rt_object *object);
static void (*rt_timer_timeout_hook)(struct rt_timer *timer);
# 74 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
void __attribute__((section(".fast"))) rt_timer_timeout_sethook(void (*hook)(struct rt_timer *timer))
{
...
static void __attribute__((section(".fast"))) _rt_timer_init(rt_timer_t timer,
                           void (*timeout)(void *parameter),
                           void *parameter,
                           rt_tick_t time,
                           rt_uint8_t flag)
...
static rt_tick_t __attribute__((section(".fast"))) rt_timer_list_next_timeout(rt_list_t timer_list[])
{
...
static __inline void __attribute__((section(".fast"))) _rt_timer_remove(rt_timer_t timer)
{
    int i;
...
# 180 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
void __attribute__((section(".fast"))) rt_timer_init(rt_timer_t timer,
                   const char *name,
                   void (*timeout)(void *parameter),
                   void *parameter,
                   rt_tick_t time,
...
;
# 204 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
rt_err_t __attribute__((section(".fast"))) rt_timer_detach(rt_timer_t timer)
{
...
;
# 237 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
rt_timer_t __attribute__((section(".fast"))) rt_timer_create(const char *name,
                           void (*timeout)(void *parameter),
                           void *parameter,
                           rt_tick_t time,
                           rt_uint8_t flag)
...
;
# 265 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
rt_err_t __attribute__((section(".fast"))) rt_timer_delete(rt_timer_t timer)
{
    register rt_base_t level;
...
;
# 294 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
rt_err_t __attribute__((section(".fast"))) rt_timer_start(rt_timer_t timer)
{
    ...
    level = rt_hw_interrupt_disable();
# 334 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
    {
    ...
    rt_hw_interrupt_enable(level);
# 408 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
    return -0;
}
;
# 419 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
rt_err_t __attribute__((section(".fast"))) rt_timer_stop(rt_timer_t timer)
{
    register rt_base_t level;
...
;
# 454 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
rt_err_t __attribute__((section(".fast"))) rt_timer_control(rt_timer_t timer, int cmd, void *arg)
{
...
void __attribute__((section(".fast"))) rt_timer_check(void)
{
    struct rt_timer *t;
...
rt_tick_t __attribute__((section(".fast"))) rt_timer_next_timeout_tick(void)
{
    return rt_timer_list_next_timeout(rt_timer_list);
}
# 671 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
void __attribute__((section(".fast"))) rt_system_timer_init(void)
{
    int i;
...
void rt_system_timer_thread_init(void)
{
# 711 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/timer.c"
}
