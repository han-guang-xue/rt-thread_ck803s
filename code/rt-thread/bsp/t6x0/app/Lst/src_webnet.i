...
# 26 "../../../packages/webnet-2.0.0/src/webnet.c" 2
...
# 27 "../../../packages/webnet-2.0.0/src/webnet.c" 2
...
# 28 "../../../packages/webnet-2.0.0/src/webnet.c" 2
...
# 30 "../../../packages/webnet-2.0.0/src/webnet.c" 2
...
# 31 "../../../packages/webnet-2.0.0/src/webnet.c" 2



# 1 "../../../components/dfs/filesystems/net/select/sys/select.h" 1
# 28 "../../../components/dfs/filesystems/net/select/sys/select.h"
# 1 "../../../components/dfs/include/dfs_select.h" 1



# 1 "../../../include/libc/libc_fdset.h" 1
# 5 "../../../components/dfs/include/dfs_select.h" 2





int select(int nfds, _types_fd_set *readfds, _types_fd_set *writefds, _types_fd_set *exceptfds, struct timeval *timeout);
# 29 "../../../components/dfs/filesystems/net/select/sys/select.h" 2
# 35 "../../../packages/webnet-2.0.0/src/webnet.c" 2
...
# 41 "../../../packages/webnet-2.0.0/src/webnet.c" 2
# 53 "../../../packages/webnet-2.0.0/src/webnet.c"
# 1 "../../../include/rtdbg.h" 1
# 54 "../../../packages/webnet-2.0.0/src/webnet.c" 2

static rt_uint16_t webnet_port = 443;
static char webnet_root[64] = "/rom/webnet";
...
void webnet_set_port(int port)
{
    if (!(init_ok == 0)) { rt_assert_handler("init_ok == RT_FALSE", __FUNCTION__, 65); };
    webnet_port = port;
}
...
{
    int listenfd = -1;
    _types_fd_set readset, tempfds;
    _types_fd_set writeset, tempwrtfds;
    int sock_fd, maxfdp1;


    char port[10];
    rt_sprintf(port, "%d", webnet_port);
    if ((wn_tls_context = tls_srv_create((0), port, 0)) == 
# 98 "../../../packages/webnet-2.0.0/src/webnet.c" 3 4
                                                                                (0)
# 98 "../../../packages/webnet-2.0.0/src/webnet.c"
                                                                                    )
    {
        if ((3) >= 1) { switch(3) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn" "Create SSL socket failed."); rt_kprintf("\033[""0""m"); }; if ((3) >= 1) { rt_kprintf("\n"); };
        goto __exit;
    }

    if ((listenfd = tls_srv_listen(wn_tls_context)) < 0 )
    {
        if ((3) >= 1) { switch(3) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn" "SSL socket bind failed."); rt_kprintf("\033[""0""m"); }; if ((3) >= 1) { rt_kprintf("\n"); };
        goto __exit;
    }
# 139 "../../../packages/webnet-2.0.0/src/webnet.c"
    webnet_module_handle_event((0), (1 << 0));
    ...
    for (;;)
    {
        ...
        ((&readset)->fds_bits[(listenfd)/(sizeof (fd_mask) * 8)] |= (1L << ((listenfd) % (sizeof (fd_mask) * 8))));
        ...
        if (((&tempfds)->fds_bits[(listenfd)/(sizeof (fd_mask) * 8)] & (1L << ((listenfd) % (sizeof (fd_mask) * 8)))))
        {
            ...
            if (accept_session == (0))
            {
# 190 "../../../packages/webnet-2.0.0/src/webnet.c"
            }
            else
            {

                ((&readset)->fds_bits[(accept_session->socket)/(sizeof (fd_mask) * 8)] |= (1L << ((accept_session->socket) % (sizeof (fd_mask) * 8))));
            }
        }
...
int webnet_init(void)
{
    ...
    if (init_ok == 1)
    {
        if ((1) >= 1) { switch(1) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn" "RT-Thread webnet package is already initialized."); rt_kprintf("\033[""0""m"); }; if ((1) >= 1) { rt_kprintf("\n"); };
        return 0;
    }

    tid = rt_thread_create("webnet",
                           webnet_thread, (0),
                           (8 * 1024), 20, 5);
    ...
    if (tid != (0))
    {
        ...
        init_ok = 1;
        if ((1) >= 1) { switch(1) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn" "RT-Thread webnet package (V%s) initialize success.","2.0.0"); rt_kprintf("\033[""0""m"); }; if ((1) >= 1) { rt_kprintf("\n"); };
    }
    else
    {
        if ((3) >= 1) { switch(3) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn" "RT-Thread webnet package (V%s) initialize failed.","2.0.0"); rt_kprintf("\033[""0""m"); }; if ((3) >= 1) { rt_kprintf("\n"); };
        return -1;
    }
