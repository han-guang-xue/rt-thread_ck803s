# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
# 27 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
...
# 28 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c" 2
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c" 2
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/rsa.h" 1
# 34 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c" 2
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c" 2
...
# 37 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c" 2
# 45 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/x509.h" 1
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c" 2
# 159 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
typedef struct {
...
static const oid_x520_attr_t oid_x520_attr_type[] =
{
    ...
    {
        { "\x2B\x06\x01\x04\x01\x82\x37\x3C\x02\x01\x03", (sizeof("\x2B\x06\x01\x04\x01\x82\x37\x3C\x02\x01\x03") - 1), "id-at-jurisdictionCountryName", "jurisdictionCountryName" },
        "jurisdictionC",
    },
    {
        { "\x2B\x06\x01\x04\x01\x82\x37\x3C\x02\x01\x02", (sizeof("\x2B\x06\x01\x04\x01\x82\x37\x3C\x02\x01\x02") - 1), "id-at-jurisdictionStateOrProvinceName", "jurisdictionStateOrProvinceName" },
        "jurisdictionST",
    },
    {
        { "\x2B\x06\x01\x04\x01\x82\x37\x3C\x02\x01\x01", (sizeof("\x2B\x06\x01\x04\x01\x82\x37\x3C\x02\x01\x01") - 1), "id-at-jurisdictionLocalityName", "jurisdictionLocalityName" },
        "jurisdictionL",
    },
    {
        { "\x55\x04\x0F", (sizeof("\x55\x04\x0F") - 1), "id-at-businessCategory", "businessCategory" },
        "businessCategory",
    },
    {
        { "\x55\x04\x09", (sizeof("\x55\x04\x09") - 1), "id-at-street", "streetAddress" },
        "street",
    },
    {
...
{
# 351 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
    {
...
# 383 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
    {
...
# 418 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
    {
    ...
    {
        { "\x2a\x81\x1c\xcf\x55\x01\x83\x75", (sizeof("\x2a\x81\x1c\xcf\x55\x01\x83\x75") - 1), "SM2_with_SM3", "SM2 with SM3" },
        MBEDTLS_MD_SM3, MBEDTLS_PK_EC,
    },
...
static const oid_pk_alg_t oid_pk_alg[] =
{
    ...
    {
        { "\x2a" "\x86\x48" "\xce\x3d" "\x02\01", (sizeof("\x2a" "\x86\x48" "\xce\x3d" "\x02\01") - 1), "id-ecPublicKey", "EC key" },
        MBEDTLS_PK_EC,
    },
    {
        { ((void *)0), 0, ((void *)0), ((void *)0) },
...
# 523 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
    {
...
# 560 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
{
    { "\x2A\x81\x1C\xCF\x55\x01\x82\x2D", (sizeof("\x2A\x81\x1C\xCF\x55\x01\x82\x2D") - 1), "sm2p256v1","sm2p256v1" },
            MBEDTLS_ECP_DP_SM2P256V1,
    },
...
{
# 631 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
    {
...
# 662 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
    {
        { ((void *)0), 0, ((void *)0), ((void *)0) },
        MBEDTLS_MD_NONE,
    },
...
# 713 "../../../packages/mbedtls-2.6.0/mbedtls/library/oid.c"
