# 1 "../../../components/net/lwip-2.0.2/src/core/init.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/init.c"
# 38 "../../../components/net/lwip-2.0.2/src/core/init.c"
...
# 42 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 43 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 46 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 47 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 48 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 49 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 50 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 51 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 52 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
void igmp_tmr(void);
# 53 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 54 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 55 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 56 "../../../components/net/lwip-2.0.2/src/core/init.c" 2

# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/nd6.h" 1
# 58 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/mld6.h" 1
# 59 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 60 "../../../components/net/lwip-2.0.2/src/core/init.c" 2

# 1 "../../../components/net/lwip-2.0.2/src/include/netif/ppp/ppp_opts.h" 1
# 62 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/netif/ppp/ppp_impl.h" 1
# 63 "../../../components/net/lwip-2.0.2/src/core/init.c" 2
...
# 336 "../../../components/net/lwip-2.0.2/src/core/init.c"
void
lwip_init(void)
{
  ...
  int a;
  (void)a;
  do { if (!(((void*)((ptrdiff_t)&a)) == &a)) { do {rt_kprintf("LWIP_CONST_CAST not implemented correctly. Check your lwIP port."); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/init.c", 342);}while(0); }} while(0);


  do { if (!(sizeof(struct packed_struct_test) == 5)) { do {rt_kprintf("Struct packing not implemented correctly. Check your lwIP port."); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/init.c", 345);}while(0); }} while(0);
