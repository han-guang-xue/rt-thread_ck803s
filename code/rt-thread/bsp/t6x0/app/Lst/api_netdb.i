# 1 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
# 38 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 39 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 2
...
# 44 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 2
...
# 45 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 2
...
# 47 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 48 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 2
...
int h_errno;
# 86 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
struct hostent*
lwip_gethostbyname(const char *name)
{
  ...
  if (err != ERR_OK) {
    ...
    h_errno = 210;
    return 
# 104 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
          0
# 104 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
              ;
  }
  ...
  s_phostent_addr[1] = 
# 110 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                      0
# 110 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                          ;
  strncpy(s_hostname, name, 256);
  s_hostname[256] = 0;
  s_hostent.h_name = s_hostname;
  s_aliases = 
# 114 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
             0
# 114 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                 ;
  s_hostent.h_aliases = &s_aliases;
  s_hostent.h_addrtype = 2;
  s_hostent.h_length = sizeof(ip_addr_t);
  s_hostent.h_addr_list = (char**)&s_phostent_addr;
# 141 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
  return &s_hostent;

}
# 161 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
int
                ...
                size_t buflen, struct hostent **result, int *h_errnop)
{
  ...
  if (h_errnop == 
# 171 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 171 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) {
  ...
  if (result == 
# 176 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
               0
# 176 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                   ) {
  ...
  *result = 
# 182 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
           0
# 182 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
               ;
  if ((name == 
# 183 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
              0
# 183 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                  ) || (ret == 
# 183 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                               0
# 183 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
...
# 183 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
  ...
  h->addr_list[1] = 
# 213 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                   0
# 213 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                       ;
  h->aliases = 
# 214 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
              0
# 214 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                  ;
  ret->h_name = hostname;
...
# 235 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
void
lwip_freeaddrinfo(struct addrinfo *ai)
{
  ...
  while (ai != 
# 240 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
              0
# 240 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                  ) {
    next = ai->ai_next;
...
# 268 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
int
...
# 275 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                               0
# 275 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                                   ;
  int port_nr = 0;
  size_t total_size;
  size_t namelen = 0;
  ...
  if (res == 
# 281 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
            0
# 281 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                ) {
    return 202;
  }
  *res = 
# 284 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
        0
# 284 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
            ;
  if ((nodename == 
# 285 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                  0
# 285 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                      ) && (servname == 
# 285 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                                        0
# 285 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
  ...
  if (hints != 
# 289 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
              0
# 289 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                  ) {
  ...
  if (servname != 
# 305 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 305 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) {
  ...
  if (nodename != 
# 314 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 314 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) {

    if ((hints != 
# 316 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 316 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) && (hints->ai_flags & 0x04)) {
...
# 337 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
    ...
    if ((hints != 
# 345 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 345 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) && (hints->ai_flags & 0x01)) {
  ...
  if (nodename != 
# 353 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 353 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) {
    ...
    do { if (!(total_size + namelen + 1 > total_size)) { do {rt_kprintf("namelen is too long"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/api/netdb.c", 359);}while(0); }} while(0);
...
# 363 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
  ,
                                 364
# 363 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
  );}while(0); }} while(0)
  ...
  if (ai == 
# 366 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
           0
# 366 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
               ) {
    return 203;
  }
  ...
  if (0) {
# 382 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
  } else {
  ...
  if (hints != 
# 395 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
              0
# 395 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                  ) {
  ...
  if (nodename != 
# 400 "../../../components/net/lwip-2.0.2/src/api/netdb.c" 3 4
                 0
# 400 "../../../components/net/lwip-2.0.2/src/api/netdb.c"
                     ) {
