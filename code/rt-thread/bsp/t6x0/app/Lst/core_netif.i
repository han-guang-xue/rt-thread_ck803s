# 1 "../../../components/net/lwip-2.0.2/src/core/netif.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/netif.c"
# 51 "../../../components/net/lwip-2.0.2/src/core/netif.c"
...
# 52 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 56 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 57 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 59 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 60 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 61 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
void igmp_tmr(void);
# 64 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 65 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 67 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 75 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
...
# 81 "../../../components/net/lwip-2.0.2/src/core/netif.c" 2
# 104 "../../../components/net/lwip-2.0.2/src/core/netif.c"
struct netif *netif_list;
struct netif *netif_default;

static u8_t netif_num;
# 117 "../../../components/net/lwip-2.0.2/src/core/netif.c"
static void netif_issue_reports(struct netif* netif, u8_t report_type);
# 164 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
netif_init(void)
{
# 193 "../../../components/net/lwip-2.0.2/src/core/netif.c"
}
# 204 "../../../components/net/lwip-2.0.2/src/core/netif.c"
err_t
...
# 242 "../../../components/net/lwip-2.0.2/src/core/netif.c"
struct netif *
          ...
          void *state, netif_init_fn init, netif_input_fn input)
{
  ...
  do { if (!(init != 
# 253 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
 0
# 253 "../../../components/net/lwip-2.0.2/src/core/netif.c"
 )) { do {rt_kprintf("No init function given"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/netif.c", 253);}while(0); }} while(0);
  ...
  ((&netif->gw)->addr = 0);
# 268 "../../../components/net/lwip-2.0.2/src/core/netif.c"
  ;
  netif->flags = 0;
...
# 281 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                          0
# 281 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                              ;
...
# 287 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                          0
# 287 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                              ;
# 298 "../../../components/net/lwip-2.0.2/src/core/netif.c"
  netif->state = state;
  netif->num = netif_num++;
  netif->input = input;
  ...
  if (init(netif) != ERR_OK) {
    return 
# 313 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
          0
# 313 "../../../components/net/lwip-2.0.2/src/core/netif.c"
              ;
  }
...
# 353 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
netif_set_addr(struct netif *netif, const ip4_addr_t *ipaddr, const ip4_addr_t *netmask,
    const ip4_addr_t *gw)
{
  if (((ipaddr) == 
# 357 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
     0 
# 357 "../../../components/net/lwip-2.0.2/src/core/netif.c"
...
# 378 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
netif_remove(struct netif *netif)
{
  ...
  if (netif == 
# 385 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
              0
# 385 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                  ) {
    return;
  }
...
# 392 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                                    0
# 392 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                                        );


    udp_netif_ip_addr_changed(((const ip_addr_t*)&((netif)->ip_addr)), 
# 395 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                                    0
# 395 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                                        );


    raw_netif_ip_addr_changed(((const ip_addr_t*)&((netif)->ip_addr)), 
# 398 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                                    0
# 398 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                                        );
...
# 429 "../../../components/net/lwip-2.0.2/src/core/netif.c"
  ...
  if (netif_default == netif) {
    ...
    netif_set_default(
# 439 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                     0
# 439 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                         );
  }
...
# 447 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                             0
# 447 "../../../components/net/lwip-2.0.2/src/core/netif.c"
    ...
    if (tmp_netif == 
# 453 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                    0
# 453 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                        ) {
      return;
    }
  }
...
# 473 "../../../components/net/lwip-2.0.2/src/core/netif.c"
struct netif *
netif_find(const char *name)
{
  ...
  if (name == 
# 479 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
             0
# 479 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                 ) {
    return 
# 480 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
          0
# 480 "../../../components/net/lwip-2.0.2/src/core/netif.c"
              ;
  }
...
# 485 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                   0
# 485 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                       ; netif = netif->next) {
    if (num == netif->num &&
       name[0] == netif->name[0] &&
       name[1] == netif->name[1]) {
  ...
  ;
  return 
# 494 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
        0
# 494 "../../../components/net/lwip-2.0.2/src/core/netif.c"
            ;
}
...
netif_find_nonum(const char *name)
{
  ...
  if (name == 
# 502 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
             0
# 502 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                 ) {
    return 
# 503 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
          0
# 503 "../../../components/net/lwip-2.0.2/src/core/netif.c"
              ;
  }

  for (netif = netif_list; netif != 
# 506 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                   0
# 506 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                       ; netif = netif->next) {
  ...
  ;
  return 
# 513 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
        0
# 513 "../../../components/net/lwip-2.0.2/src/core/netif.c"
            ;
}
...
struct netif *netif_find_byindex(u8_t index)
{
  ...
  if (index < 1) {
      return 
# 521 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
            0
# 521 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                ;
  }

  for (netif = netif_list; netif != 
# 524 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                   0
# 524 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                       ; netif = netif->next) {
  ...
  ;
  return 
# 533 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
        0
# 533 "../../../components/net/lwip-2.0.2/src/core/netif.c"
            ;
}
...
u8_t netif_get_index(struct netif *target)
{
    ...
    if (target == 
# 540 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                 0
# 540 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                     ) {
        return 0;
    }

    for (netif = netif_list; netif != 
# 544 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
                                     0
# 544 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                                         ; netif = netif->next) {
        if (netif == target) {
            ;
            return netif->num+1;
...
# 565 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
...
# 588 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
   0 
# 588 "../../../components/net/lwip-2.0.2/src/core/netif.c"
   ? 0 : (ipaddr)->addr));
    ;
    ;
    ;
...
# 615 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
netif_set_gw(struct netif *netif, const ip4_addr_t *gw)
{
  (((&netif->gw))->addr = ((gw) == 
# 618 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
 0 
# 618 "../../../components/net/lwip-2.0.2/src/core/netif.c"
 ? 0 : (gw)->addr));
  ;
...
# 638 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
...
# 643 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
 0 
# 643 "../../../components/net/lwip-2.0.2/src/core/netif.c"
 ? 0 : (netmask)->addr));
  ;
  ;
...
# 662 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
netif_set_default(struct netif *netif)
{
  if (netif == 
# 665 "../../../components/net/lwip-2.0.2/src/core/netif.c" 3 4
              0
# 665 "../../../components/net/lwip-2.0.2/src/core/netif.c"
                  ) {
...
# 734 "../../../components/net/lwip-2.0.2/src/core/netif.c"
}
...
# 793 "../../../components/net/lwip-2.0.2/src/core/netif.c"
void
