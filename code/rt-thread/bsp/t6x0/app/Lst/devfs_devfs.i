# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c"
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c"
...
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c" 2
...
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c" 2
...
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c" 2
...
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c" 2

# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.h" 1
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.h"
#define __DEVICE_FS_H__ 



int devfs_init(void);
# 33 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/devfs/devfs.c" 2
...
int dfs_device_fs_ioctl(struct dfs_fd *file, int cmd, void *args)
{
    ...
    if (!(file != (0))) { rt_assert_handler("file != RT_NULL", __FUNCTION__, 51); };


    dev_id = (rt_device_t)file->data;
    if (!(dev_id != (0))) { rt_assert_handler("dev_id != RT_NULL", __FUNCTION__, 55); };
...
int dfs_device_fs_read(struct dfs_fd *file, void *buf, size_t count)
{
    ...
    if (!(file != (0))) { rt_assert_handler("file != RT_NULL", __FUNCTION__, 70); };


    dev_id = (rt_device_t)file->data;
    if (!(dev_id != (0))) { rt_assert_handler("dev_id != RT_NULL", __FUNCTION__, 74); };
...
int dfs_device_fs_write(struct dfs_fd *file, const void *buf, size_t count)
{
    ...
    if (!(file != (0))) { rt_assert_handler("file != RT_NULL", __FUNCTION__, 88); };


    dev_id = (rt_device_t)file->data;
    if (!(dev_id != (0))) { rt_assert_handler("dev_id != RT_NULL", __FUNCTION__, 92); };
...
int dfs_device_fs_close(struct dfs_fd *file)
{
    ...
    if (!(file != (0))) { rt_assert_handler("file != RT_NULL", __FUNCTION__, 106); };
    ...
    if (file->type == 2)
    {
        ...
        if (!(root_dirent != (0))) { rt_assert_handler("root_dirent != RT_NULL", __FUNCTION__, 113); };
    ...
    dev_id = (rt_device_t)file->data;
    if (!(dev_id != (0))) { rt_assert_handler("dev_id != RT_NULL", __FUNCTION__, 122); };
...
int dfs_device_fs_open(struct dfs_fd *file)
{
        ...
        (file->flags & 0200000))
    {
        ...
        if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 156); };
    ...
    {
        result = rt_device_open(device, 0x003);
        if (result == 0 || result == -6)
        {
            file->data = device;
            return 0;
...
int dfs_device_fs_getdents(struct dfs_fd *file, struct dirent *dirp, uint32_t count)
{
    ...
    root_dirent = (struct device_dirent *)file->data;
    if (!(root_dirent != (0))) { rt_assert_handler("root_dirent != RT_NULL", __FUNCTION__, 279); };
        ...
        index ++)
    {
        ...
        rt_strncpy(d->d_name, object->name, 8);
    }
