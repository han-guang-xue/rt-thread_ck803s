# 1 "../../../packages/webclient-2.0.1/samples/webclient_post_sample.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webclient-2.0.1/samples/webclient_post_sample.c"
# 11 "../../../packages/webclient-2.0.1/samples/webclient_post_sample.c"
...
# 12 "../../../packages/webclient-2.0.1/samples/webclient_post_sample.c" 2
...
# 15 "../../../packages/webclient-2.0.1/samples/webclient_post_sample.c" 2
...
int webclient_post_test(int argc, char **argv)
{
    ...
    if (argc == 1)
    {
        URI = rt_strdup("https://192.168.100.167/upload");
        if(URI == (0))
        {
    ...
    buffer = (unsigned char *) rt_malloc(1024);
    if (buffer == (0))
    {
...
# 123 "../../../packages/webclient-2.0.1/samples/webclient_post_sample.c" 2
const char __fsym___cmd_web_post_test_name[] __attribute__((section(".rodata.name"))) = "__cmd_web_post_test"; const char __fsym___cmd_web_post_test_desc[] __attribute__((section(".rodata.name"))) = "webclient_post_test [URI] - webclient POST request test."; const struct finsh_syscall __fsym___cmd_web_post_test __attribute__((section("FSymTab")))= { __fsym___cmd_web_post_test_name, __fsym___cmd_web_post_test_desc, (syscall_func)&webclient_post_test };;
