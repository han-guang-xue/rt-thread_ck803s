# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
# 63 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 64 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c" 2
...
# 88 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
void __attribute__((section(".fast"))) rt_malloc_sethook(void (*hook)(void *ptr, rt_size_t size))
{
    rt_malloc_hook = hook;
}
...
void __attribute__((section(".fast"))) rt_free_sethook(void (*hook)(void *ptr))
{
    rt_free_hook = hook;
}
...
# 157 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
static void __attribute__((section(".fast"))) plug_holes(struct heap_mem *mem)
{
    struct heap_mem *nmem;
    struct heap_mem *pmem;

    if (!((rt_uint8_t *)mem >= heap_ptr)) { rt_assert_handler("(rt_uint8_t *)mem >= heap_ptr", __FUNCTION__, 162); };
    if (!((rt_uint8_t *)mem < (rt_uint8_t *)heap_end)) { rt_assert_handler("(rt_uint8_t *)mem < (rt_uint8_t *)heap_end", __FUNCTION__, 163); };
    if (!(mem->used == 0)) { rt_assert_handler("mem->used == 0", __FUNCTION__, 164); };
...
# 205 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
void rt_system_heap_init(void *begin_addr, void *end_addr)
{
    struct heap_mem *mem;
    rt_uint32_t begin_align = ((((rt_uint32_t)begin_addr) + (8) - 1) & ~((8) - 1));
    rt_uint32_t end_align = (((rt_uint32_t)end_addr) & ~((8) - 1));

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 211); } } rt_hw_interrupt_enable(level); } while (0);


    if ((end_align > (2 * (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)))) &&
        ((end_align - 2 * (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1))) >= begin_align))
    {

        mem_size_aligned = end_align - begin_align - 2 * (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1));
    }
    else
    {
    ...
    mem->magic = 0x1ea0;
    mem->next = mem_size_aligned + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1));
    mem->prev = 0;
    mem->used = 0;
    ...
    heap_end->used = 1;
    heap_end->next = mem_size_aligned + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1));
    heap_end->prev = mem_size_aligned + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1));
...
# 273 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
void __attribute__((section(".fast"))) *rt_malloc(rt_size_t size)
{
    rt_size_t ptr, ptr2;
    struct heap_mem *mem, *mem2;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 278); } } rt_hw_interrupt_enable(level); } while (0);

    if (size == 0)
        return (0);

    if (size != (((size) + (8) - 1) & ~((8) - 1)))
        do { if (0) rt_kprintf ("malloc size %d, but align to %d\n", size, (((size) + (8) - 1) & ~((8) - 1))); } while (0)
                                                                         ;
    else
         ...
         ptr = ((struct heap_mem *)&heap_ptr[ptr])->next)
    {
        ...
        if ((!mem->used) && (mem->next - (ptr + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)))) >= size)
        {



            if (mem->next - (ptr + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1))) >=
                (size + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)) + (((12) + (8) - 1) & ~((8) - 1))))
            {
# 330 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
                ptr2 = ptr + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)) + size;
                ...
                if (mem2->next != mem_size_aligned + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)))
                {
                    ((struct heap_mem *)&heap_ptr[mem2->next])->prev = ptr2;
                }

                used_mem += (size + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)));
                if (max_mem < used_mem)
                    max_mem = used_mem;
            ...
            if (mem == lfree)
            {
                ...
                if (!(((lfree == heap_end) || (!lfree->used)))) { rt_assert_handler("((lfree == heap_end) || (!lfree->used))", __FUNCTION__, 387); };
            }

            rt_sem_release(&heap_sem);
            if (!((rt_uint32_t)mem + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)) + size <= (rt_uint32_t)heap_end)) { rt_assert_handler("(rt_uint32_t)mem + SIZEOF_STRUCT_MEM + size <= (rt_uint32_t)heap_end", __FUNCTION__, 391); };
            if (!((rt_uint32_t)((rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1))) % 8 == 0)) { rt_assert_handler("(rt_uint32_t)((rt_uint8_t *)mem + SIZEOF_STRUCT_MEM) % RT_ALIGN_SIZE == 0", __FUNCTION__, 392); };
            if (!((((rt_uint32_t)mem) & (8 - 1)) == 0)) { rt_assert_handler("(((rt_uint32_t)mem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 393); };

            do { if (0) rt_kprintf ("allocate memory at 0x%x, size: %d\n", (rt_uint32_t)((rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1))), (rt_uint32_t)(mem->next - ((rt_uint8_t *)mem - heap_ptr))); } while (0)


                                                                                     ;

            do { if ((rt_malloc_hook) != (0)) rt_malloc_hook (((void *)((rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)))), size); } while (0)
                                                                                          ;


            return (rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1));
        }
    }
...
;
# 422 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
void __attribute__((section(".fast"))) *rt_realloc(void *rmem, rt_size_t newsize)
{
    rt_size_t size;
    rt_size_t ptr, ptr2;
    struct heap_mem *mem, *mem2;
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 429); } } rt_hw_interrupt_enable(level); } while (0);
    ...
    mem = (struct heap_mem *)((rt_uint8_t *)rmem - (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)));

    ptr = (rt_uint8_t *)mem - heap_ptr;
    size = mem->next - ptr - (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1));
    if (size == newsize)
    {
    ...
    if (newsize + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)) + 12 < size)
    {
        ...
        ptr2 = ptr + (((sizeof(struct heap_mem)) + (8) - 1) & ~((8) - 1)) + newsize;
        mem2 = (struct heap_mem *)&heap_ptr[ptr2];
        mem2->magic = 0x1ea0;
        mem2->used = 0;
        mem2->next = mem->next;
...
;
# 526 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
void __attribute__((section(".fast"))) *rt_calloc(rt_size_t count, rt_size_t size)
{
    void *p;

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 530); } } rt_hw_interrupt_enable(level); } while (0);
...
void __attribute__((section(".fast"))) rt_free(void *rmem)
{
    struct heap_mem *mem;
    ...
    if (rmem == (0))
        return;
    if (!((((rt_uint32_t)rmem) & (8 - 1)) == 0)) { rt_assert_handler("(((rt_uint32_t)rmem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 557); };
    if (!((rt_uint8_t *)rmem >= (rt_uint8_t *)heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)heap_end)) { rt_assert_handler("(rt_uint8_t *)rmem >= (rt_uint8_t *)heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)heap_end", __FUNCTION__,
                                                         559
# 558 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c"
    ); }
                                                          ;
    ...
    if (!(mem->used)) { rt_assert_handler("mem->used", __FUNCTION__, 589); };
    if (!(mem->magic == 0x1ea0)) { rt_assert_handler("mem->magic == HEAP_MAGIC", __FUNCTION__, 590); };
...
void __attribute__((section(".fast"))) rt_memory_info(rt_uint32_t *total,
                    rt_uint32_t *used,
                    rt_uint32_t *max_used)
{
    if (total != (0))
...
# 629 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/mem.c" 2
