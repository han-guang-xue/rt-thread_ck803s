# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c"
# 25 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c"
...
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c" 2
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c" 2
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/asn1write.c"
int mbedtls_asn1_write_len( unsigned char **p, unsigned char *start, size_t len )
{
    if( len < 0x80 )
    {
                                        ...
                                        size_t val_len )
{
    ...
    if( ( cur = mbedtls_asn1_find_named_data( *head, oid, oid_len ) ) == ((void *)0) )
    {
