...
# 32 "../../../packages/webnet-2.0.0/src/wn_request.c" 2
...
# 33 "../../../packages/webnet-2.0.0/src/wn_request.c" 2
...
# 35 "../../../packages/webnet-2.0.0/src/wn_request.c" 2
...
# 36 "../../../packages/webnet-2.0.0/src/wn_request.c" 2
...
# 37 "../../../packages/webnet-2.0.0/src/wn_request.c" 2
# 46 "../../../packages/webnet-2.0.0/src/wn_request.c"
# 1 "../../../include/rtdbg.h" 1
# 47 "../../../packages/webnet-2.0.0/src/wn_request.c" 2
...
static void _webnet_request_parse_query(struct webnet_request* request)
{
    ...
    if ((request->query == (0)) || (*request->query == '\0')) return;
    ...
    for (index = 0; index < request->query_counter; index ++)
    {
        ...
        request->query_items[index].value = (0);
...
{
    if (request->path != (0)) request->path = rt_strdup(request->path);
    if (request->host != (0))
    {
        char *ptr;
        ptr = request->host;
        ...
        request->host = rt_strdup(request->host);
    }
    if (request->cookie != (0)) request->cookie = rt_strdup(request->cookie);
    if (request->user_agent != (0)) request->user_agent = rt_strdup(request->user_agent);
    if (request->authorization != (0)) request->authorization = rt_strdup(request->authorization);
    if (request->accept_language != (0)) request->accept_language = rt_strdup(request->accept_language);
    if (request->referer != (0)) request->referer = rt_strdup(request->referer);
    if (request->content_type != (0)) request->content_type = rt_strdup(request->content_type);


    if (request->callback) request->callback = rt_strdup(request->callback);
    if (request->soap_action) request->soap_action = rt_strdup(request->soap_action);
    if (request->sid) request->sid = rt_strdup(request->sid);
    ...
    if (request->Range) request->Range = rt_strdup(request->Range);
...
int webnet_request_parse_method(struct webnet_request *request, char* buffer, int length)
{
    ...
    if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 223); };
    if (!(request->session != (0))) { rt_assert_handler("request->session != RT_NULL", __FUNCTION__, 224); };
    ...
    *ch++ = '\0';
    request->path = rt_strdup(request_buffer);
    request_buffer = ch;
...
int webnet_request_parse_header(struct webnet_request *request, char* buffer, int length)
{
    ...
    if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 299); };
    if (!(request->session != (0))) { rt_assert_handler("request->session != RT_NULL", __FUNCTION__, 300); };
    ...
    for (;;)
    {
        if (str_begin_with(request_buffer, "\r\n"))
        {
            ...
            if (request->content_length && request->method == WEBNET_POST)
            {
                ...
                if (!str_begin_with(request->content_type, "multipart/form-data") &&
                    request->content_length < (8 * 1024))
                {
                    session->session_phase = WEB_PHASE_QUERY;


                    request->query = (char*) rt_malloc(request->content_length + 1);
        ...
        *ch ++ = '\0';
        ...
        if (str_begin_with(request_buffer, "Host:"))
        {
            ...
            request->host = rt_strdup(request_buffer);
        }
        else if (str_begin_with(request_buffer, "User-Agent:"))
        {
            ...
            request_buffer += 11;
            while (*request_buffer == ' ') request_buffer ++;
            request->user_agent = rt_strdup(request_buffer);
        }
        else if (str_begin_with(request_buffer, "Accept-Language:"))
        {
            ...
            request_buffer += 16;
            while (*request_buffer == ' ') request_buffer ++;
            request->accept_language = rt_strdup(request_buffer);
        }
        ...
        else if (str_begin_with(request_buffer, "Content-Type:"))
        {
            ...
            request_buffer += 13;
            while (*request_buffer == ' ') request_buffer ++;
            request->content_type = rt_strdup(request_buffer);
        }
        else if (str_begin_with(request_buffer, "Referer:"))
        {
            ...
            request_buffer += 8;
            while (*request_buffer == ' ') request_buffer ++;
            request->referer = rt_strdup(request_buffer);
        }
        ...
        else if (str_begin_with(request_buffer, "Range:"))
        {
            ...
            request_buffer += 6;
            while (*request_buffer == ' ') request_buffer ++;
            request->Range = rt_strdup(request_buffer);
        }
# 418 "../../../packages/webnet-2.0.0/src/wn_request.c"
        ...
        else if (str_begin_with(request_buffer, "Cookie:"))
        {
            ...
            request_buffer += 7;
            while (*request_buffer == ' ') request_buffer ++;
            request->cookie = rt_strdup(request_buffer);
        }
        ...
        else if (str_begin_with(request_buffer, "Authorization: Basic"))
        {
            ...
            request_buffer += 20;
            while (*request_buffer == ' ') request_buffer ++;
            request->authorization = rt_strdup(request_buffer);
        }
# 471 "../../../packages/webnet-2.0.0/src/wn_request.c"
        else if (str_begin_with(request_buffer, "SOAPACTION:"))
        {
            request_buffer += 11;
            while (*request_buffer == ' ') request_buffer ++;

            request->soap_action = rt_strdup(request_buffer);
        }
        else if (str_begin_with(request_buffer, "CALLBACK:"))
        {
            ...
            request->callback = rt_strdup(request_buffer);
        }
...
void webnet_request_parse(struct webnet_request* request, char* buffer, int length)
{
    ...
    if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 533); };
    if (!(request->session != (0))) { rt_assert_handler("request->session != RT_NULL", __FUNCTION__, 534); };
...
# 606 "../../../packages/webnet-2.0.0/src/wn_request.c"
    else
    {
    ...
    *ch ++ = '\0';
    ...
    for (;;)
    {
        if (str_begin_with(request_buffer, "\r\n"))
        {
            ...
            if (request->method == WEBNET_POST && request->content_length > 0)
            {
                char *read_ptr = (0);
                int read_length;
                struct webnet_session* session = request->session;
                ...
                {
                    if ((3) >= 1) { switch(3) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn.request" "content length too long: %d, discard it.", request->content_length); rt_kprintf("\033[""0""m"); }; if ((3) >= 1) { rt_kprintf("\n"); };
                ...
                read_ptr = (char *)rt_malloc(request->content_length);
                if (read_ptr == (0))
                {
                    if ((3) >= 1) { switch(3) { case 3: rt_kprintf("\033[""31""m"); break; case 2: rt_kprintf("\033[""33""m"); break; case 1: rt_kprintf("\033[""32""m"); break; default: break; } rt_kprintf("wn.request" "No memory for request read buffer!"); rt_kprintf("\033[""0""m"); }; if ((3) >= 1) { rt_kprintf("\n"); };
                    request->query = (0);
                    return ;
                }
...
# 821 "../../../packages/webnet-2.0.0/src/wn_request.c"
        else if (str_begin_with(request_buffer, "Connection:"))
        {
...
# 875 "../../../packages/webnet-2.0.0/src/wn_request.c"
        else if (str_begin_with(request_buffer, "SOAPACTION:"))
        {
            request_buffer += 11;
            while (*request_buffer == ' ') request_buffer ++;
...
void webnet_request_destory(struct webnet_request* request)
{
    if (request != (0))
    {
        ...
        {
            if (request->path != (0)) rt_free(request->path);
            if (request->host != (0)) rt_free(request->host);
            if (request->cookie != (0)) rt_free(request->cookie);
            if (request->user_agent != (0)) rt_free(request->user_agent);
            if (request->authorization != (0)) rt_free(request->authorization);
            if (request->accept_language != (0)) rt_free(request->accept_language);
            if (request->referer != (0)) rt_free(request->referer);
            if (request->content_type != (0)) rt_free(request->content_type);
            if (request->query != (0)) rt_free(request->query);
            if (request->query_items != (0)) rt_free(request->query_items);

            if (request->callback) rt_free(request->callback);
            if (request->soap_action) rt_free(request->soap_action);
            if (request->sid) rt_free(request->sid);

            if (request->Range) rt_free(request->Range);
