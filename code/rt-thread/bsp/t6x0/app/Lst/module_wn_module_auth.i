# 1 "../../../packages/webnet-2.0.0/module/wn_module_auth.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/module/wn_module_auth.c"
# 27 "../../../packages/webnet-2.0.0/module/wn_module_auth.c"
...
# 28 "../../../packages/webnet-2.0.0/module/wn_module_auth.c" 2
...
# 30 "../../../packages/webnet-2.0.0/module/wn_module_auth.c" 2
...
# 31 "../../../packages/webnet-2.0.0/module/wn_module_auth.c" 2
...
# 32 "../../../packages/webnet-2.0.0/module/wn_module_auth.c" 2
...
static struct webnet_auth_item* _auth_items = (0);
static rt_uint32_t _auth_items_count = 0;
# 52 "../../../packages/webnet-2.0.0/module/wn_module_auth.c"
void webnet_auth_set(const char* path, const char* username_password)
{
    if (_auth_items == (0))
    {
        _auth_items_count = 1;
        _auth_items = (struct webnet_auth_item*)rt_malloc (sizeof(struct webnet_auth_item) *
                      _auth_items_count);
    }
    else
    {
        ...
        for (index = 0; index < _auth_items_count; index ++)
        {
            ...
            {
                rt_free(_auth_items[index].username_password);
        ...
        _auth_items_count += 1;
        _auth_items = (struct webnet_auth_item*) rt_realloc (_auth_items, sizeof(struct webnet_auth_item) *
                      _auth_items_count);
    }

    if (!(_auth_items != (0))) { rt_assert_handler("_auth_items != RT_NULL", __FUNCTION__, 80); };

    _auth_items[_auth_items_count - 1].path = rt_strdup(path);
...
int webnet_module_auth(struct webnet_session* session, int event)
{
    if (event == (1 << 1))
    {
        ...
        if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 97); };
        request = session->request;
        if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 99); };
