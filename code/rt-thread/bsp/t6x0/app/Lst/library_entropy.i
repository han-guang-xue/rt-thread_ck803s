# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
# 25 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
...
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c" 2
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
...
# 37 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c" 2
...
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c" 2
...
# 40 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c" 2
# 53 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
...
# 54 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c" 2
# 63 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
...
# 98 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
    ...
    mbedtls_entropy_add_source( ctx, mbedtls_hardware_poll, ((void *)0),
                                32,
                                1 );
                           ...
                           const unsigned char *data, size_t len )
{
    ...
    ret = entropy_update( ctx, 3, data, len );
...
int mbedtls_entropy_func( void *data, unsigned char *output, size_t len )
{
    ...
    if( len > 32 )
        return( -0x003C );
# 308 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
    if( ( ret = mbedtls_mutex_lock( &ctx->mutex ) ) != 0 )
        return( ret );
    ...
    memset( buf, 0, 32 );
# 350 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
...
# 463 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
...
static int mbedtls_entropy_source_self_test_gather( unsigned char *buf, size_t buf_len )
{
    ...
    {
        if( ( ret = mbedtls_hardware_poll( ((void *)0), buf + entropy_len,
...
# 530 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
int mbedtls_entropy_source_self_test( int verbose )
{
    int ret = 0;
...
# 578 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
int mbedtls_entropy_self_test( int verbose )
{
    int ret = 1;
    ...
    if( ( ret = mbedtls_entropy_update_manual( &ctx, buf, sizeof buf ) ) != 0 )
        goto cleanup;
# 614 "../../../packages/mbedtls-2.6.0/mbedtls/library/entropy.c"
    for( i = 0; i < 8; i++ )
    {
