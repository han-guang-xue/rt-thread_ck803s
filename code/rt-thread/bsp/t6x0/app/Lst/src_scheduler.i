# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
# 40 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
...
# 41 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c" 2
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 42 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c" 2
...
# 77 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
void
__attribute__((section(".fast"))) rt_scheduler_sethook(void (*hook)(struct rt_thread *from, struct rt_thread *to))
{
...
static void __attribute__((section(".fast"))) _rt_scheduler_stack_check(struct rt_thread *thread)
{
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 89); };
    ...
    extern unsigned int irq_stack_offset;
    if (*((rt_uint8_t *)((unsigned int)&irq_stack_offset - 0xffc)) != 0x23)
    {
        rt_kprintf("\n\n\n\n\nirq stack overflow\n\n\n\n");
    }
}
...
# 197 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
void __attribute__((section(".fast"))) rt_schedule(void)
{
    rt_base_t level;
    ...
    if (rt_scheduler_lock_nest == 0)
    {
        ...
        highest_ready_priority = __rt_ffs(rt_thread_ready_priority_group) - 1;
# 221 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
        to_thread = ((struct rt_thread *)((char *)(rt_thread_priority_table[highest_ready_priority].next) - (unsigned long)(&((struct rt_thread *)0)->tlist)))
...
# 292 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
void __attribute__((section(".fast"))) rt_schedule_insert_thread(struct rt_thread *thread)
{
    register rt_base_t temp;

    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 296); };
    ...
    do { if (0) rt_kprintf ("insert thread[%.*s], the priority: %d\n", 8, thread->name, thread->current_priority); } while (0)
                                                                                           ;
# 325 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
    rt_thread_ready_priority_group |= thread->number_mask;


    rt_hw_interrupt_enable(temp);
}
# 338 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
void __attribute__((section(".fast"))) rt_schedule_remove_thread(struct rt_thread *thread)
{
    register rt_base_t temp;

    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 342); };
    ...
    do { if (0) rt_kprintf ("remove thread[%.*s], the priority: %d\n", 8, thread->name, thread->current_priority); } while (0)
                                                                ...
                                                                ;
# 362 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/scheduler.c"
...
void __attribute__((section(".fast"))) rt_enter_critical(void)
{
...
void __attribute__((section(".fast"))) rt_exit_critical(void)
{
    register rt_base_t level;
...
rt_uint16_t __attribute__((section(".fast"))) rt_critical_level(void)
{
