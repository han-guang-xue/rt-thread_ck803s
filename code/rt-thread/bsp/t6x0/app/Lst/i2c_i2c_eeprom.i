# 1 "../../../components/drivers/i2c/i2c_eeprom.c"
...
# 2 "../../../components/drivers/i2c/i2c_eeprom.c" 2
...
# 3 "../../../components/drivers/i2c/i2c_eeprom.c" 2
...
# 4 "../../../components/drivers/i2c/i2c_eeprom.c" 2
...
# 5 "../../../components/drivers/i2c/i2c_eeprom.c" 2
...
static struct rt_i2c_bus_device *eep_i2c_bus = (0);
                                   ...
                                   rt_size_t size)
{
    ...
    rt_size_t ret = 0;
    if (!(dev != 0)) { rt_assert_handler("dev != 0", __FUNCTION__, 48); };
    ...
    msg[1].addr = 0x50;
    msg[1].flags = (1u << 0) | (1u << 2);
    msg[1].buf = (rt_uint8_t *) buffer;
    msg[1].len = size;

    rt_mutex_take(&i2c_eeprom_device.lock, -1);
                                    ...
                                    rt_size_t size)
{
    ...
    if (!(dev != 0)) { rt_assert_handler("dev != 0", __FUNCTION__, 92); };
...
# 206 "../../../components/drivers/i2c/i2c_eeprom.c"
int eeprom_24aa128_init(void)
{
    ...
    if (rt_mutex_init(&i2c_eeprom_device.lock, i2c_bus_name, 0x00) != 0)
    {
    ...
    i2c_eeprom_device.eeprom_device.user_data = (0);
...
const init_fn_t __rt_init_eeprom_24aa128_init __attribute__((section(".rti_fn.""3"))) = eeprom_24aa128_init;
