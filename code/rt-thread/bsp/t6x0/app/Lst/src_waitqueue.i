...
void __attribute__((section(".fast"))) rt_wqueue_remove(struct rt_wqueue_node *node)
{
    rt_base_t level;
...
int __attribute__((section(".fast"))) __wqueue_default_wake(struct rt_wqueue_node *wait, void *key)
{
    return 0;
}

void __attribute__((section(".fast"))) rt_wqueue_wakeup(rt_wqueue_t *queue, void *key)
{
    rt_base_t level;
...
int __attribute__((section(".fast"))) rt_wqueue_wait(rt_wqueue_t *queue, int condition, int msec)
{
    int tick;
