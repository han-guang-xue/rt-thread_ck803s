# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c"
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c"
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pkcs5.h" 1
# 28 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pkcs5.h"
...
# 29 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pkcs5.h" 2
...
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pkcs5.h" 2
...
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/asn1.h" 1
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2
...
int mbedtls_cipher_auth_decrypt( mbedtls_cipher_context_t *ctx,
                         ...
                         unsigned char *output, size_t *olen,
                         const unsigned char *tag, size_t tag_len );
# 43 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2
...
# 44 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2
...
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2
...
# 51 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c" 2




# 54 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c"
                                      ...
                                      int *keylen, mbedtls_md_type_t *md_type )
{
    ...
    if( params->tag != ( 0x20 | 0x10 ) )
        return( -0x2f00 +
                -0x0062 );
# 75 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c"
                       ...
                       uint32_t key_length, unsigned char *output )
{
    ...
    while( key_length )
    {
        ...
        mbedtls_md_hmac_finish( ctx, work );
        ...
        for( i = 1; i < iteration_count; i++ )
        {
            ...
            mbedtls_md_hmac_reset( ctx );
            mbedtls_md_hmac_update( ctx, md1, md_size );
            mbedtls_md_hmac_finish( ctx, md1 );
...
# 296 "../../../packages/mbedtls-2.6.0/mbedtls/library/pkcs5.c"
...
int mbedtls_pkcs5_self_test( int verbose )
{
    ...
    if( ( ret = mbedtls_md_setup( &sha1_ctx, info_sha1, ((1 << 0) | (1 << 16)) ) ) != 0 )
    {
        ret = 1;
        goto exit;
    }
