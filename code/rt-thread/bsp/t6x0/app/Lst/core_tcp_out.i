# 1 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 41 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 42 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 2



# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/priv/tcp_priv.h" 1
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/priv/tcp_priv.h"
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/tcp.h" 1
# 45 "../../../components/net/lwip-2.0.2/src/include/lwip/tcp.h"
...
# 42 "../../../components/net/lwip-2.0.2/src/include/lwip/ip.h"
...
# 50 "../../../components/net/lwip-2.0.2/src/include/lwip/netif.h"
...
# 46 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 2
...
# 52 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 2
# 95 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
static err_t tcp_output_segment(struct tcp_seg *seg, struct tcp_pcb *pcb, struct netif *netif);
# 107 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
static struct pbuf *
                      ...
                      u32_t seqno_be )
{
  ...
  if (p != 
# 113 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 113 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ) {
...
# 114 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ,
                                              115
# 114 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    );}while(0); }} while(0)
...
tcp_send_fin(struct tcp_pcb *pcb)
{
  ...
  if (pcb->unsent != 
# 142 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                    0
# 142 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                        ) {
    struct tcp_seg *last_unsent;
    for (last_unsent = pcb->unsent; last_unsent->next != 
# 144 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                        0
# 144 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                            ;
...
# 172 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 178 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                            0
# 178 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                ) {
    ;
    pbuf_free(p);
    return 
# 181 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 181 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ;
  }
  seg->flags = optflags;
  seg->next = 
# 184 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
             0
# 184 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                 ;
  seg->p = p;
  do { if (!(p->tot_len >= optlen)) { do {rt_kprintf("p->tot_len >= optlen"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 186);}while(0); }} while(0);
  seg->len = p->tot_len - optlen;
# 200 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  if (pbuf_header(p, 20)) {
    ;
    ;
    tcp_seg_free(seg);
    return 
# 204 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 204 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ;
  }
...
# 232 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
static struct pbuf *
                  ...
                  u8_t first_seg)
{
  ...
  (void)first_seg;
  alloc = max_length;
# 268 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  p = pbuf_alloc(layer, alloc, PBUF_RAM);
  if (p == 
# 269 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 269 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ) {
    return 
# 270 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 270 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ;
  }
  do { if (!(p->next == 
# 272 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
 0
# 272 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
 )) { do {rt_kprintf("need unchained pbuf"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 272);}while(0); }} while(0);
  *oversize = p->len - length;

  p->len = p->tot_len = length;
  return p;
}
# 306 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
static err_t
__attribute__((section(".fast"))) tcp_write_checks(struct tcp_pcb *pcb, u16_t len)
{
  ...
  if (pcb->snd_queuelen != 0) {
    do { if (!(pcb->unacked != 
# 341 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0 
# 341 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
   || pcb->unsent != 
# 341 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 341 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 341 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ...
    do { if (!(pcb->unacked == 
# 344 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0 
# 344 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
   && pcb->unsent == 
# 344 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 344 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 367 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
err_t
__attribute__((section(".fast"))) tcp_write(struct tcp_pcb *pcb, const void *arg, u16_t len, u8_t apiflags)
{
  struct pbuf *concat_p = 
# 370 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                         0
# 370 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                             ;
  struct tcp_seg *last_unsent = 
# 371 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                               0
# 371 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                   , *seg = 
# 371 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                            0
# 371 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 371 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ...
  apiflags |= 0x01;
                                            ...
                                            ;
  do { if (!(arg != 
# 401 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
 0
# 401 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 445 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  if (pcb->unsent != 
# 445 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                    0
# 445 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                        ) {
    u16_t space;
    ...
    for (last_unsent = pcb->unsent; last_unsent->next != 
# 450 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                        0
# 450 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                            ;
         last_unsent = last_unsent->next);


    unsent_optlen = (last_unsent->flags & (u8_t)0x01U ? 4 : 0) + (last_unsent->flags & (u8_t)0x02U ? 0 : 0) + (last_unsent->flags & (u8_t)0x08U ? 0 : 0);
    do { if (!(mss_local >= last_unsent->len + unsent_optlen)) { do {rt_kprintf("mss_local is too small"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 455);}while(0); }} while(0);
    space = mss_local - (last_unsent->len + unsent_optlen);
# 471 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    oversize = pcb->unsent_oversize;
    if (oversize > 0) {
      do { if (!(oversize <= space)) { do {rt_kprintf("inconsistent oversize vs. space"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 473);}while(0); }} while(0);
      seg = last_unsent;
    ...
    do { if (!((oversize == 0) || (pos == len))) { do {rt_kprintf("inconsistent oversize vs. len"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 481);}while(0); }} while(0);
# 495 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 504 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                                                   0
# 504 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                                                       ) {
...
# 522 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                           0
# 522 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                               ; p = p->next);
        if (p->type == PBUF_ROM && (const u8_t *)p->payload + p->len == (const u8_t *)arg) {
          do { if (!(pos == 0)) { do {rt_kprintf("tcp_write: ROM pbufs cannot be oversized"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 524);}while(0); }} while(0);
          extendlen = seglen;
        } else {
          if ((concat_p = pbuf_alloc(PBUF_RAW, seglen, PBUF_ROM)) == 
# 527 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                    0
# 527 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                        ) {
    ...
    do { if (!(pcb->unsent_oversize == 0)) { do {rt_kprintf("unsent_oversize mismatch (pcb->unsent is NULL)"); sys_arch_assert(
                                         "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 548 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ,
                                         549
# 548 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    );}while(0); }} while(0)
...
# 572 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                                                               0
# 572 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                                                                   )) == 
# 572 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                                                                         0
# 572 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
      ...
      do { if (!((p->len >= seglen))) { do {rt_kprintf("tcp_write: check that first pbuf can hold the complete seglen"); sys_arch_assert(
                                    "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 576 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
      ,
                                    577
# 576 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
      );}while(0); }} while(0)
      ...
      do { if (!(oversize == 0)) { do {rt_kprintf("oversize == 0"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 587);}while(0); }} while(0);

      if ((p2 = pbuf_alloc(PBUF_TRANSPORT, seglen, PBUF_ROM)) == 
# 589 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                0
# 589 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                    ) {
        ;
        goto memerr;
      }
# 602 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
      ((struct pbuf_rom*)p2)->payload = (const u8_t*)arg + pos;


      if ((p = pbuf_alloc(PBUF_TRANSPORT, optlen, PBUF_RAM)) == 
# 605 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                               0
# 605 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                   ) {
...
# 628 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                              0
# 628 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                                  ) {
      goto memerr;
    }
# 641 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    if (queue == 
# 641 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                0
# 641 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                    ) {
      queue = seg;
      ...
      do { if (!(prev_seg != 
# 645 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
     0
# 645 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
     )) { do {rt_kprintf("prev_seg != NULL"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 645);}while(0); }} while(0);
      prev_seg->next = seg;
    }
...
# 673 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  if (oversize_used > 0) {
    struct pbuf *p;
    ...
    for (p = last_unsent->p; p; p = p->next) {
      ...
      if (p->next == 
# 678 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                    0
# 678 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                        ) {
  ...
  if (concat_p != 
# 697 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                 0
# 697 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                     ) {
    do { if (!((last_unsent != 
# 698 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 698 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 698 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ...
    struct pbuf *p;
    do { if (!(last_unsent != 
# 704 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0 
# 704 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
   && last_unsent->p != 
# 704 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 704 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 704 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                    ...
                                                    ;
    for (p = last_unsent->p; p->next != 
# 706 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                       0
# 706 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                           ; p = p->next) {
      p->tot_len += extendlen;
    }
    p->tot_len += extendlen;
...
# 732 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  if (last_unsent == 
# 732 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                    0
# 732 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                        ) {
    pcb->unsent = queue;
  ...
  if (pcb->snd_queuelen != 0) {
    do { if (!(pcb->unacked != 
# 748 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0 
# 748 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
   || pcb->unsent != 
# 748 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 748 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 748 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ...
  if (seg != 
# 753 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
            0 
# 753 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                 && seg->tcphdr != 
# 753 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                   0 
# 753 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
memerr:
  ...
  if (concat_p != 
# 762 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                 0
# 762 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                     ) {
    pbuf_free(concat_p);
  }
  if (queue != 
# 765 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
              0
# 765 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                  ) {
    tcp_segs_free(queue);
  }
  if (pcb->snd_queuelen != 0) {
    do { if (!(pcb->unacked != 
# 769 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0 
# 769 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
   || pcb->unsent != 
# 769 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 769 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 784 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
err_t
__attribute__((section(".fast"))) tcp_enqueue_flags(struct tcp_pcb *pcb, u8_t flags)
{
  ...
  do { if (!((flags & (0x02U | 0x01U)) != 0)) { do {rt_kprintf("tcp_enqueue_flags: need either TCP_SYN or TCP_FIN in flags (programmer violates API)"); sys_arch_assert(
                                                "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 794 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ,
                                                795
# 794 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  );}while(0); }} while(0)
  ...
  if ((p = pbuf_alloc(PBUF_TRANSPORT, optlen, PBUF_RAM)) == 
# 827 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                           0
# 827 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                               ) {
    pcb->flags |= 0x80U;
    ;
    return ERR_MEM;
  ...
  do { if (!((p->len >= optlen))) { do {rt_kprintf("tcp_enqueue_flags: check that first pbuf can hold optlen"); sys_arch_assert(
                                "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 832 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ,
                                833
# 832 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  );}while(0); }} while(0)
...
# 836 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                                          0
# 836 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                                              ) {
    pcb->flags |= 0x80U;
    ;
    return ERR_MEM;
  }
  do { if (!(((mem_ptr_t)seg->tcphdr % (((8) < (4)) ? (8) : (4))) == 0)) { do {rt_kprintf("seg->tcphdr not aligned"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 841);}while(0); }} while(0);
  do { if (!(seg->len == 0)) { do {rt_kprintf("tcp_enqueue_flags: invalid segment length"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_out.c", 842);}while(0); }} while(0);
  ...
  if (pcb->unsent == 
# 851 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                    0
# 851 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                        ) {
    pcb->unsent = seg;
  } else {
    struct tcp_seg *useg;
    for (useg = pcb->unsent; useg->next != 
# 855 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                          0
# 855 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                              ; useg = useg->next);
    useg->next = seg;
  }
  ...
  if (pcb->snd_queuelen != 0) {
    do { if (!(pcb->unacked != 
# 876 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0 
# 876 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
   || pcb->unsent != 
# 876 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
   0
# 876 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 917 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
err_t
__attribute__((section(".fast"))) tcp_send_empty_ack(struct tcp_pcb *pcb)
{
  ...
  u8_t optlen = 0;
  struct netif *netif;
# 934 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  p = tcp_output_alloc_header(pcb, optlen, 0, lwip_htonl(pcb->snd_nxt));
  if (p == 
# 935 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 935 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ) {
    ...
    return ERR_BUF;
                                                                       ...
                                                                       ;
# 956 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 957 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
              0
# 957 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                  ) {
    err = ERR_RTE;
  } else {
...
# 992 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
err_t
__attribute__((section(".fast"))) tcp_output(struct tcp_pcb *pcb)
{
  ...
  do { if (!(pcb->state != LISTEN)) { do {rt_kprintf("don't call tcp_output for listen-pcbs"); sys_arch_assert(
                        "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 1004 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ,
                        1005
# 1004 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  );}while(0); }} while(0)
  ...
  if (pcb->flags & 0x02U &&
     (seg == 
# 1026 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
            0 
# 1026 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                 ||
  ...
  useg = pcb->unacked;
  if (useg != 
# 1033 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
             0
# 1033 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                 ) {
    for (; useg->next != 
# 1034 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                        0
# 1034 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                            ; useg = useg->next);
  }

  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 1038 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
              0
# 1038 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                  ) {
    return ERR_RTE;
  }
  ...
  if (((&pcb->local_ip) == 
# 1043 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
     0 
# 1043 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
     || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL)))) {
    const ip_addr_t *local_ip = (((netif) != 
# 1044 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                               0
# 1044 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 1044 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ...
    if (local_ip == 
# 1045 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                   0
# 1045 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                       ) {
      return ERR_RTE;
    }
    ((pcb->local_ip).addr = (*local_ip).addr);
  }
# 1080 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  if (seg != 
# 1080 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
            0 
# 1080 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                 &&
      lwip_htonl(seg->tcphdr->seqno) - pcb->lastack + seg->len > wnd &&
      wnd > 0 && wnd == pcb->snd_wnd && pcb->unacked == 
# 1082 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                                       0
# 1082 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                                           ) {
  ...
  while (seg != 
# 1091 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
               0 
# 1091 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                    &&
         lwip_htonl(seg->tcphdr->seqno) - pcb->lastack + seg->len <= wnd) {
    do { if (!((((u16_t)(lwip_htons((seg->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU)) & 0x04U) == 0)) { do {rt_kprintf("RST not expected here!"); sys_arch_assert(
                                                        "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 1093 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ,
                                                        1094
# 1093 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    );}while(0); }} while(0)
    ...
    if ((((((pcb)->unacked == 
# 1102 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
        0
# 1102 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
...
# 1115 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
    ...
    if (((seg)->len + (((((u16_t)(lwip_htons(((seg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU)) & (0x01U | 0x02U)) != 0) ? 1U : 0U)) > 0) {
      seg->next = 
# 1138 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                 0
# 1138 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                     ;

      if (pcb->unacked == 
# 1140 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                         0
# 1140 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                             ) {
        pcb->unacked = seg;
        useg = seg;
...
output_done:
  ...
  if (pcb->unsent == 
# 1171 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                    0
# 1171 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                        ) {
...
# 1188 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
static err_t
...
# 1214 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  {
...
# 1251 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  if (pcb->rtime < 0) {
    pcb->rtime = 0;
  }
  ...
  seg->tcphdr->chksum = 0;
# 1314 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ;
...
# 1343 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
void
  ...
  u16_t local_port, u16_t remote_port)
{
  ...
  if (p == 
# 1352 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 1352 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ) {
    ;
    return;
  }
  do { if (!((p->len >= sizeof(struct tcp_hdr)))) { do {rt_kprintf("check that first pbuf can hold struct tcp_hdr"); sys_arch_assert(
                                                "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
# 1356 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  ,
                                                1357
# 1356 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
  );}while(0); }} while(0)
  ...
  if (netif != 
# 1377 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
              0
# 1377 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                  ) {
...
# 1398 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
void
__attribute__((section(".fast"))) tcp_rexmit_rto(struct tcp_pcb *pcb)
{
  ...
  if (pcb->unacked == 
# 1403 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                     0
# 1403 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                         ) {
    return;
  }
...
# 1408 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                                       0
# 1408 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                                           ; seg = seg->next);
  ...
  pcb->unacked = 
# 1420 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                0
# 1420 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                    ;
...
# 1441 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
void
__attribute__((section(".fast"))) tcp_rexmit(struct tcp_pcb *pcb)
{
  ...
  if (pcb->unacked == 
# 1447 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                     0
# 1447 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                         ) {
    return;
  }
  ...
  *cur_seg = seg;
  ...
  if (seg->next == 
# 1464 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                  0
# 1464 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                      ) {
...
{
  if (pcb->unacked != 
# 1492 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
                     0 
# 1492 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                          && !(pcb->flags & 0x04U)) {
...
# 1531 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
err_t
tcp_keepalive(struct tcp_pcb *pcb)
{
  ...
  if (p == 
# 1546 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 1546 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ) {
  ...
  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 1552 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
              0
# 1552 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                  ) {
    err = ERR_RTE;
  } else {
...
# 1585 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
err_t
__attribute__((section(".fast"))) tcp_zero_window_probe(struct tcp_pcb *pcb)
{
  ...
  if (seg == 
# 1608 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
            0
# 1608 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                ) {
    seg = pcb->unsent;
  }
  if (seg == 
# 1611 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
            0
# 1611 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                ) {
  ...
  if (p == 
# 1621 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
          0
# 1621 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
              ) {
    ;
    return ERR_MEM;
  }
  ...
  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 1646 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c" 3 4
              0
# 1646 "../../../components/net/lwip-2.0.2/src/core/tcp_out.c"
                  ) {
    err = ERR_RTE;
  } else {
