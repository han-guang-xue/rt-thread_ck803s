# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/workqueue.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/workqueue.c"
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/workqueue.c"
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/workqueue.c" 2
...
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/src/workqueue.c" 2


static __inline rt_err_t __attribute__((section(".fast"))) _workqueue_work_completion(struct rt_workqueue *queue)
{
    rt_err_t result;
...
static void __attribute__((section(".fast"))) _workqueue_thread_entry(void* parameter)
{
    rt_base_t level;
    struct rt_work* work;
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 68); };
...
struct rt_workqueue __attribute__((section(".fast"))) *rt_workqueue_create(const char* name, rt_uint16_t stack_size, rt_uint8_t priority)
{
...
rt_err_t __attribute__((section(".fast"))) rt_workqueue_destroy(struct rt_workqueue* queue)
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 126); };
...
rt_err_t __attribute__((section(".fast"))) rt_workqueue_dowork(struct rt_workqueue* queue, struct rt_work* work)
{
    rt_base_t level;
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 137); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 138); };
...
rt_err_t __attribute__((section(".fast"))) rt_workqueue_critical_work(struct rt_workqueue* queue, struct rt_work* work)
{
    rt_base_t level;
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 167); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 168); };
...
rt_err_t __attribute__((section(".fast"))) rt_workqueue_cancel_work(struct rt_workqueue* queue, struct rt_work* work)
{
    rt_base_t level;

    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 197); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 198); };
...
rt_err_t __attribute__((section(".fast"))) rt_workqueue_cancel_work_sync(struct rt_workqueue* queue, struct rt_work* work)
{
    rt_base_t level;

    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 216); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 217); };
...
rt_err_t __attribute__((section(".fast"))) rt_workqueue_cancel_all_work(struct rt_workqueue* queue)
{
    struct rt_list_node *node, *next;
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 237); };
