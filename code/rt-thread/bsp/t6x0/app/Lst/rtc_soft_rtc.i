# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c"
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c"
...
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c" 2
...
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c" 2
...
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c" 2




#define RTC_TIME_INIT(year,month,day,hour,minute,second) {.tm_year = year - 1900, .tm_mon = month - 1, .tm_mday = day, .tm_hour = hour, .tm_min = minute, .tm_sec = second}
...
static rt_err_t soft_rtc_control(rt_device_t dev, int cmd, void *args)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 50); };
    ...
    case 0x10:
        time = (time_t *) args;
        *time = init_time + (rt_tick_get() - init_tick) / 100;
        break;

    case 0x11:
    {
        time = (time_t *) args;
        init_time = *time - (rt_tick_get() - init_tick) / 100;
        break;
    }
    }
...
# 83 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/drivers/rtc/soft_rtc.c"
int rt_soft_rtc_init(void)
{
    static rt_bool_t init_ok = 0;
    struct tm time_new = {.tm_year = 2018 - 1900, .tm_mon = 1 - 1, .tm_mday = 1, .tm_hour = 0, .tm_min = 0, .tm_sec = 0};
    ...
    if (!(!rt_device_find("rtc"))) { rt_assert_handler("!rt_device_find(\"rtc\")", __FUNCTION__, 93); };
    ...
    soft_rtc_dev.init = (0);
    soft_rtc_dev.open = (0);
    soft_rtc_dev.close = (0);
    soft_rtc_dev.read = (0);
    soft_rtc_dev.write = (0);
    soft_rtc_dev.control = soft_rtc_control;



    soft_rtc_dev.user_data = (0);

    rt_device_register(&soft_rtc_dev, "rtc", 0x003);

    init_ok = 1;

    return 0;
}
const init_fn_t __rt_init_rt_soft_rtc_init __attribute__((section(".rti_fn.""3"))) = rt_soft_rtc_init;
