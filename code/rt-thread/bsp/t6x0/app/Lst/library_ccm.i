# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
# 34 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
...
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/aes.h"
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/aes.h" 2
...
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
# 45 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
# 48 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
# 50 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
int tih_mpi_inv_mod(const unsigned int *modulus, const unsigned int *a, unsigned int *ainv,
                      unsigned int mod_nword, unsigned int a_nword);
# 51 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
# 57 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c" 2
...
# 62 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
...
# 206 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
    b[0] = 0;
    b[0] |= ( add_len > 0 ) << 6;
    b[0] |= ( ( tag_len - 2 ) / 2 ) << 3;
    b[0] |= q - 1;
...
# 277 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
    ctr[0] = q - 1;
    ...
    {
        unsigned int size;
        if ( ( (unsigned int)src & 0x3 ) || (rt_hw_dtcm_addr_check( (unsigned int)src )) )
        {
            int l = length;
            unsigned char *p = src;
    ...
    {
        unsigned int size;
        if ( ( (unsigned int)dst & 0x3 ) || (rt_hw_dtcm_addr_check( (unsigned int)dst )) )
        {
            int l = length;
            unsigned char *p = dst;
...
# 465 "../../../packages/mbedtls-2.6.0/mbedtls/library/ccm.c"
