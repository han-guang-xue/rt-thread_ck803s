# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c" 2
...
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c" 2
...
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h" 1
# 26 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
...
# 27 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h" 2
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
typedef enum
{
    MBEDTLS_ECDH_SM2_OURS,
    MBEDTLS_ECDH_SM2_THEIRS,
} mbedtls_ecdh_sm2_side;
# 67 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
typedef struct
{
    mbedtls_ecp_group grp;
    mbedtls_mpi d;
...
# 104 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
int mbedtls_ecdh_sm2_gen_public( mbedtls_ecp_group *grp, mbedtls_mpi *d, mbedtls_ecp_point *Q,
                     int (*f_rng)(void *, unsigned char *, size_t),
                     void *p_rng );
# 126 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
...
# 251 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
int mbedtls_ecdh_sm2_get_params4( mbedtls_ecdh_sm2_context *ctx, size_t zlen, mbedtls_ecdh_sm2_side side );
# 266 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
int mbedtls_ecdh_sm2_make_public( mbedtls_ecdh_sm2_context *ctx, size_t *olen,
                      unsigned char *buf, size_t blen,
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng );
# 281 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
...
# 303 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/ecdh_sm2.h"
int mbedtls_ecdh_sm2_calc_secret( mbedtls_ecdh_sm2_context *ctx, size_t *olen,
                                  unsigned char *buf, size_t blen,
                                  int (*f_rng)(void *, unsigned char *, size_t),
                                  void *p_rng );
# 47 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c" 2
...
# 98 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
int mbedtls_ecdh_sm2_make_params( mbedtls_ecdh_sm2_context *ctx, size_t *olen,
                      unsigned char *buf, size_t blen,
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng )
...
# 136 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
                                       ...
                                       size_t blen)
{
    ...
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->S1, buf, blen >> 1) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->SA, buf + ( blen >> 1 ), blen >> 1) ) != 0 ) goto cleanup; } while( 0 );
    return ret;

cleanup:
    return( ret );
}
# 159 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
int mbedtls_ecdh_sm2_read_params( mbedtls_ecdh_sm2_context *ctx,
                      const unsigned char **buf, const unsigned char *end )
{
    int ret;
                                      ...
                                      size_t ilen, mbedtls_ecdh_sm2_side side )
{
    ...
    nbytes = ( ( key->grp.pbits + 7 ) / 8 );
    uint8_t z[nbytes];

    ret = mbedtls_sm2_z_get(&(((mbedtls_ecp_keypair *)key)->grp), &(((mbedtls_ecp_keypair *)key)->Q), id, ilen, z, nbytes);

    if (side == MBEDTLS_ECDH_SM2_OURS) {
        do { if( ( ret = mbedtls_mpi_read_binary( &ctx->Za, z, nbytes) ) != 0 ) goto cleanup; } while( 0 );
    }
    else
    {
        do { if( ( ret = mbedtls_mpi_read_binary( &ctx->Zb, z, nbytes) ) != 0 ) goto cleanup; } while( 0 );
    }
    return 0;
...
# 345 "../../../packages/mbedtls-2.6.0/mbedtls/library/ecdh_sm2.c"
int mbedtls_ecdh_sm2_calc_secret( mbedtls_ecdh_sm2_context *ctx, size_t *olen,
                                  unsigned char *buf, size_t blen,
                                  int (*f_rng)(void *, unsigned char *, size_t),
                                  void *p_rng )
{
    int ret;
    uint8_t nbytes = ( ( ctx->grp.pbits + 7 ) / 8 );
    ...
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->dA, dA, nbytes) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->PB.X, PB, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->PB.Y, PB + nbytes, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->d, rA, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->Q.X, RPA, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->Q.Y, RPA + nbytes, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->Qp.X, RPB, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->Qp.Y, RPB + nbytes, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->Za, ZA, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->Zb, ZB, nbytes ) ) != 0 ) goto cleanup; } while( 0 );
    ...
    do { if( ( ret = mbedtls_mpi_read_binary(&ctx->z, KA, ctx->z_nbytes) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_read_binary(&ctx->S1, S1, nbytes) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_mpi_read_binary(&ctx->SA, SA, nbytes) ) != 0 ) goto cleanup; } while( 0 );
...
int mbedtls_ecdh_sm2_self_test( int verbose )
{
    ...
    do { if( ( ret = mbedtls_ecp_gen_key( MBEDTLS_ECP_DP_SM2P256V1, &key_a, myrand, ((void *)0) ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecp_gen_key( MBEDTLS_ECP_DP_SM2P256V1, &key_b, myrand, ((void *)0) ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecp_gen_key( MBEDTLS_ECP_DP_SM2P256V1, &key_ra, myrand, ((void *)0) ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecp_gen_key( MBEDTLS_ECP_DP_SM2P256V1, &key_rb, myrand, ((void *)0) ) ) != 0 ) goto cleanup; } while( 0 );


    do { if( ( ret = mbedtls_ecdh_sm2_get_params( &ctx_a, &key_ra, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecdh_sm2_get_params( &ctx_a, &key_rb, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_get_params2( &ctx_a, &key_a, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecdh_sm2_get_params2( &ctx_a, &key_b, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_get_params3( &ctx_a, &key_a, id, 4, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecdh_sm2_get_params3( &ctx_a, &key_b, id, 4, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_get_params4( &ctx_a, 64, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_calc_secret( &ctx_a, &olen_a, k_a, 64, myrand, ((void *)0) ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_make_params2( &ctx_a, buf_a, 64 ) ) != 0 ) goto cleanup; } while( 0 );


    do { if( ( ret = mbedtls_ecdh_sm2_get_params( &ctx_b, &key_rb, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecdh_sm2_get_params( &ctx_b, &key_ra, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_get_params2( &ctx_b, &key_b, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecdh_sm2_get_params2( &ctx_b, &key_a, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_get_params3( &ctx_b, &key_b, id, 4, MBEDTLS_ECDH_SM2_OURS ) ) != 0 ) goto cleanup; } while( 0 );
    do { if( ( ret = mbedtls_ecdh_sm2_get_params3( &ctx_b, &key_a, id, 4, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_get_params4( &ctx_b, 64, MBEDTLS_ECDH_SM2_THEIRS ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_calc_secret( &ctx_b, &olen_b, k_b, 64, myrand, ((void *)0) ) ) != 0 ) goto cleanup; } while( 0 );

    do { if( ( ret = mbedtls_ecdh_sm2_make_params2( &ctx_b, buf_b, 64 ) ) != 0 ) goto cleanup; } while( 0 );
