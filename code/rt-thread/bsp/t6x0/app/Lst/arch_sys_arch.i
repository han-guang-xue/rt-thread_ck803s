# 1 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
# 17 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 18 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2

# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/sys.h" 1
# 40 "../../../components/net/lwip-2.0.2/src/include/lwip/sys.h"
...
# 20 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
...
# 22 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
...
# 26 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
...
err_t netifapi_netif_common(struct netif *netif, netifapi_void_fn voidfunc,
                            netifapi_errt_fn errtfunc);
# 27 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
...
# 29 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
...
# 33 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
# 46 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
static void tcpip_init_done_callback(void *arg)
{
    ...
    do { if (!(arg)) { do {rt_kprintf("invalid arg.\n"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/arch/sys_arch.c", 82);}while(0); }} while(0);
...
int lwip_system_init(void)
{
    ...
    if (rc != 0)
    {
        do { if (!(0)) { do {rt_kprintf("Failed to create semaphore"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/arch/sys_arch.c", 166);}while(0); }} while(0);
    ...
    rt_sem_detach(&done_sem);
# 195 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 263 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 330 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 406 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 475 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
u32_t __attribute__((section(".fast"))) sys_arch_mbox_fetch(sys_mbox_t *mbox, void **msg, u32_t timeout)
{
    ...
    {
        do { if (!(ret == 0)) { do {rt_kprintf("rt_mb_recv returned with error!"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/arch/sys_arch.c", 503);}while(0); }} while(0);
    }
...
# 524 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 567 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 671 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
    return mem_new;
}
...
void __attribute__((weak)) __attribute__((section(".fast"))) mem_free(void *mem)
{
    if (mem != (0))
    {
# 689 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
        rt_free(mem);

    }
}
# 737 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c"
...
# 738 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
;
;
;
;
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 764 "../../../components/net/lwip-2.0.2/src/arch/sys_arch.c" 2
;
;
;
;
