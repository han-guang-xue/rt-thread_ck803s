# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/stdlib.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/stdlib.c"
# 15 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/stdlib.c"
...
# 16 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/stdlib.c" 2
...
# 19 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/stdlib.c" 2



# 21 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/libc/compilers/minilibc/stdlib.c"
void __attribute__((section(".fast"))) *malloc(size_t size)
{
 return rt_malloc(size);
}

void __attribute__((section(".fast"))) free(void *ptr)
{
 rt_free(ptr);
}

void __attribute__((section(".fast"))) *realloc(void *ptr, size_t size)
{
 return rt_realloc(ptr, size);
}

void __attribute__((section(".fast"))) *calloc(size_t nelem, size_t elsize)
{
