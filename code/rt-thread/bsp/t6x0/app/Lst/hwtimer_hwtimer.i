...
# 1 "<command-line>"
# 1 "../../../components/drivers/hwtimer/hwtimer.c"
# 25 "../../../components/drivers/hwtimer/hwtimer.c"
...
# 26 "../../../components/drivers/hwtimer/hwtimer.c" 2
...
# 27 "../../../components/drivers/hwtimer/hwtimer.c" 2
...
# 346 "../../../components/drivers/hwtimer/hwtimer.c"
rt_err_t rt_device_hwtimer_register(rt_hwtimer_t *timer, const char *name, void *user_data)
{
    struct rt_device *device;

    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 350); };
    if (!(timer->ops != (0))) { rt_assert_handler("timer->ops != RT_NULL", __FUNCTION__, 351); };
    if (!(timer->info != (0))) { rt_assert_handler("timer->info != RT_NULL", __FUNCTION__, 352); };
