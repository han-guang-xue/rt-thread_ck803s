# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c"
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c"
...
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c" 2
...
# 30 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c" 2
...
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c" 2

# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.h" 1
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.h"
...
# 33 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/ramfs/dfs_ramfs.c" 2
...
int dfs_ramfs_statfs(struct dfs_filesystem *fs, struct statfs *buf)
{
    ...
    if (!(ramfs != ((void *)0))) { rt_assert_handler("ramfs != NULL", __FUNCTION__, 61); };
    if (!(buf != ((void *)0))) { rt_assert_handler("buf != NULL", __FUNCTION__, 62); };
                                      ...
                                      rt_size_t *size)
{
    ...
    for (dirent = ((struct ramfs_dirent *)((char *)(ramfs->root.list.next) - (unsigned long)(&((struct ramfs_dirent *)0)->list)));
         dirent != &(ramfs->root);
         dirent = ((struct ramfs_dirent *)((char *)(dirent->list.next) - (unsigned long)(&((struct ramfs_dirent *)0)->list))))
    {
...
int dfs_ramfs_read(struct dfs_fd *file, void *buf, size_t count)
{
    ...
    if (!(dirent != ((void *)0))) { rt_assert_handler("dirent != NULL", __FUNCTION__, 115); };
...
int dfs_ramfs_write(struct dfs_fd *fd, const void *buf, size_t count)
{
    ...
    if (!(dirent != ((void *)0))) { rt_assert_handler("dirent != NULL", __FUNCTION__, 137); };

    ramfs = dirent->fs;
    if (!(ramfs != ((void *)0))) { rt_assert_handler("ramfs != NULL", __FUNCTION__, 140); };
...
int dfs_ramfs_open(struct dfs_fd *file)
{
    ...
    ramfs = (struct dfs_ramfs *)fs->data;
    if (!(ramfs != ((void *)0))) { rt_assert_handler("ramfs != NULL", __FUNCTION__, 197); };
    ...
    else
    {
        ...
        if (dirent == ((void *)0))
        {
            if (file->flags & 0100 || file->flags & 01)
            {
                char *name_ptr;
                ...
                while (*name_ptr == '/' && *name_ptr)
                    name_ptr ++;
                strncpy(dirent->name, name_ptr, 32);
                       ...
                       uint32_t count)
{
    ...
    ramfs = dirent->fs;
    if (!(ramfs != (0))) { rt_assert_handler("ramfs != RT_NULL", __FUNCTION__, 319); };
    ...
    index = 0;
    count = 0;
    for (dirent = ((struct ramfs_dirent *)((char *)(dirent->list.next) - (unsigned long)(&((struct ramfs_dirent *)0)->list)));
         ...
         dirent = ((struct ramfs_dirent *)((char *)(dirent->list.next) - (unsigned long)(&((struct ramfs_dirent *)0)->list))))
    {
        if (index >= (rt_size_t)file->pos)
        {
            ...
            rt_strncpy(d->d_name, dirent->name, 32);
...
int dfs_ramfs_unlink(struct dfs_filesystem *fs, const char *path)
{
    ...
    ramfs = (struct dfs_ramfs *)fs->data;
    if (!(ramfs != ((void *)0))) { rt_assert_handler("ramfs != NULL", __FUNCTION__, 360); };
                     ...
                     const char *newpath)
{
    ...
    ramfs = (struct dfs_ramfs *)fs->data;
    if (!(ramfs != ((void *)0))) { rt_assert_handler("ramfs != NULL", __FUNCTION__, 383); };
    ...
    strncpy(dirent->name, newpath, 32);
...
const init_fn_t __rt_init_dfs_ramfs_init __attribute__((section(".rti_fn.""4"))) = dfs_ramfs_init;
