# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c"
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c"
...
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c" 2
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c" 2



# 1 "../libraries/inc/tih/core_timer.h" 1
# 25 "../libraries/inc/tih/core_timer.h"
...
void core_timer_hw_init(unsigned int us);
void core_timer_intr_enable(void);
void core_timer_intr_disable(void);
unsigned int core_timer_intr_status(void);
void core_timer_intr_clear(unsigned int intr_src);
void core_timer_start(void);
void core_timer_stop(void);
unsigned int core_timer_current_value_get(void);
# 31 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c" 2
...
# 32 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/bsp/t6x0/drivers/drv_ctimer.c" 2

static void __attribute__((section(".fast"))) sys_tick_isr(void)
{

    core_timer_intr_clear(0);


    rt_hw_interrupt_clear(26);

    rt_tick_increase();
}

static int drv_ctimer_connect(void *isr)
{
    if (isr == ((void *)0)) {
        return -1;
    }

    if (rt_hw_interrupt_install(26, isr, ((void *)0), "core timer") == ((void *)0)) {
        return -1;
    }
...
static void drv_ctimer_intr_enable(void)
{
    ...
    rt_hw_interrupt_umask(26);
}

static void drv_ctimer_intr_disable(void)
{
    rt_hw_interrupt_mask(26);
