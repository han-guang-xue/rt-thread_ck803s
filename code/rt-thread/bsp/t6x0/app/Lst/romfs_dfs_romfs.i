# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c"
# 24 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c"
...
# 25 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c" 2
...
# 26 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c" 2
...
# 27 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c" 2
...
# 28 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c" 2
...
# 29 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/dfs/filesystems/romfs/dfs_romfs.c" 2
...
static __inline int check_dirent(struct romfs_dirent *dirent)
{
    if ((dirent->type != 0x00 && dirent->type != 0x01)
        || dirent->size == ~0)
        return -1;
    return 0;
}
...
int dfs_romfs_read(struct dfs_fd *file, void *buf, size_t count)
{
    ...
    if (!(dirent != ((void *)0))) { rt_assert_handler("dirent != NULL", __FUNCTION__, 150); };
...
int dfs_romfs_open(struct dfs_fd *file)
{
    ...
    if (file->flags & (0100 | 01 | 02000 | 01000 | 02))
        return -22;
...
int dfs_romfs_getdents(struct dfs_fd *file, struct dirent *dirp, uint32_t count)
{
    ...
    if (check_dirent(dirent) != 0)
        return -5;
    if (!(dirent->type == 0x01)) { rt_assert_handler("dirent->type == ROMFS_DIRENT_DIR", __FUNCTION__, 266); };
...
int dfs_romfs_init(void)
{
    ...
    if (dfs_mount((0), "/", "rom", 0, &(romfs_root)) == 0)
    {
...
const init_fn_t __rt_init_dfs_romfs_init __attribute__((section(".rti_fn.""4"))) = dfs_romfs_init;
