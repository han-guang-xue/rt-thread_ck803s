# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
...
# 47 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/cmac.h" 1
# 27 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/cmac.h"
...
int mbedtls_cipher_auth_decrypt( mbedtls_cipher_context_t *ctx,
                         ...
                         unsigned char *output, size_t *olen,
                         const unsigned char *tag, size_t tag_len );
# 28 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/cmac.h" 2
...
# 52 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c" 2
...
# 54 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c" 2
# 63 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
...
# 64 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c" 2
...
# 69 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
static void mbedtls_zeroize( void *v, size_t n ) {

    memset( v, 0, n);
}
# 86 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
...
# 124 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
    mask = - ( input[0] >> 7 );
                                ...
                                const unsigned char *key, size_t keybits )
{
    ...
    if( ctx == ((void *)0) || ctx->cipher_info == ((void *)0) || key == ((void *)0) )
        return( -0x6100 );
                                ...
                                const unsigned char *input, size_t ilen )
{
    ...
    if( ctx == ((void *)0) || ctx->cipher_info == ((void *)0) || input == ((void *)0) ||
        ctx->cmac_ctx == ((void *)0) )
        return( -0x6100 );
                                ...
                                unsigned char *output )
{
    ...
    if( ctx == ((void *)0) || ctx->cipher_info == ((void *)0) || ctx->cmac_ctx == ((void *)0) ||
        output == ((void *)0) )
        return( -0x6100 );
                         ...
                         unsigned char *output )
{
    ...
    if( cipher_info == ((void *)0) || key == ((void *)0) || input == ((void *)0) || output == ((void *)0) )
        return( -0x6100 );
                              ...
                              unsigned char *output )
{
    ...
    if( key == ((void *)0) || input == ((void *)0) || output == ((void *)0) )
        return( -0x6100 );
...
# 488 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
...
# 595 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
...
# 984 "../../../packages/mbedtls-2.6.0/mbedtls/library/cmac.c"
    if( ( ret = cmac_test_subkeys( verbose,
                                   "AES 256",
                                   aes_256_key,
                                   256,
