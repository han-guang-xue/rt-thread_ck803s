# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
# 39 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
...
#define LWIP_PERF 0
# 40 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 2
...
# 44 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 2
...
# 45 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 2


const ip_addr_t ip_addr_any = { ((u32_t)0x00000000UL) };
const ip_addr_t ip_addr_broadcast = { ((u32_t)0xffffffffUL) };
# 57 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
u8_t
__attribute__((section(".fast"))) ip4_addr_isbroadcast_u32(u32_t addr, const struct netif *netif)
{
  ip4_addr_t ipaddr;
  ((&ipaddr)->addr = (addr));
...
u8_t
__attribute__((section(".fast"))) ip4_addr_netmask_valid(u32_t netmask)
{
  u32_t mask;
...
# 132 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
u32_t
__attribute__((section(".fast"))) ipaddr_addr(const char *cp)
{
  ip4_addr_t val;
...
# 154 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
int
__attribute__((section(".fast"))) ip4addr_aton(const char *cp, ip4_addr_t *addr)
{
  u32_t val;
  u8_t base;
  char c;
  ...
  case 4:
    ...
    break;
  default:
    do { if (!(0)) { do {rt_kprintf("unhandled"); sys_arch_assert("E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c", 259);}while(0); }} while(0);
    break;
  }
  if (addr) {
...
# 276 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
char*
__attribute__((section(".fast"))) ip4addr_ntoa(const ip4_addr_t *addr)
{
  static char str[16];
  return ip4addr_ntoa_r(addr, str, 16);
}
# 292 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
char*
__attribute__((section(".fast"))) ip4addr_ntoa_r(const ip4_addr_t *addr, char *buf, int buflen)
{
  u32_t s_addr;
  char inv[3];
  char *rp;
  ...
  for (n = 0; n < 4; n++) {
    ...
    while (i--) {
      if (len++ >= buflen) {
        return 
# 317 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 3 4
              0
# 317 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
                  ;
      }
      *rp++ = inv[i];
    }
    if (len++ >= buflen) {
      return 
# 322 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 3 4
            0
# 322 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
                ;
    }
    *rp++ = '.';
    ap++;
