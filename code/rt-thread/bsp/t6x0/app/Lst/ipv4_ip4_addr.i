# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
# 39 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
...
# 40 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 2
...
# 44 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 2
...
# 45 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 2


const ip_addr_t ip_addr_any = { ((u32_t)0x00000000UL) };
const ip_addr_t ip_addr_broadcast = { ((u32_t)0xffffffffUL) };
# 57 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
u8_t
...
# 132 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
u32_t
...
# 154 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
int
__attribute__((section(".fast"))) ip4addr_aton(const char *cp, ip4_addr_t *addr)
{
  ...
  case 4:
    ...
    break;
  default:
    do { if (!(0)) { do {rt_kprintf("unhandled"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c", 259);}while(0); }} while(0);
    break;
  }
  if (addr) {
...
# 276 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
char*
...
# 292 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
char*
__attribute__((section(".fast"))) ip4addr_ntoa_r(const ip4_addr_t *addr, char *buf, int buflen)
{
  ...
  for (n = 0; n < 4; n++) {
    ...
    while (i--) {
      if (len++ >= buflen) {
        return 
# 317 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 3 4
              0
# 317 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
                  ;
      }
      *rp++ = inv[i];
    }
    if (len++ >= buflen) {
      return 
# 322 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c" 3 4
            0
# 322 "../../../components/net/lwip-2.0.2/src/core/ipv4/ip4_addr.c"
                ;
    }
    *rp++ = '.';
    ap++;
