...
# 3 "../drivers/drv_uart.c" 2
# 1 "../libraries/inc/tih/uart.h" 1
# 51 "../libraries/inc/tih/uart.h"
...
# 4 "../drivers/drv_uart.c" 2




static struct rt_serial_device serial[2];
static unsigned int serial_index[2] = {0, 1};
...
void __attribute__((section(".fast"))) uart1_irq_handler(void)
{
    unsigned int status;

    status = uart_intr_status(1);
    uart_intr_clear(1, status);
    rt_hw_interrupt_clear(15);

    rt_hw_serial_isr(&serial[1],0x01);
}
...
static rt_err_t __attribute__((section(".fast"))) drv_uart_control(struct rt_serial_device *serial, int cmd, void *arg)
{
    ...
    case 0x10:
        ...
        if (uart == 0) {
            ...
            uart_intr_enable(uart, (1 << 2));
            rt_hw_interrupt_install(15, (rt_isr_handler_t)uart1_irq_handler, (void *)1, "UART1");
            rt_hw_interrupt_umask(15);
        }
...
static int drv_uart_init(void)
{
    ...
    rt_hw_serial_register(&serial[1],"uart1", 0x003 | 0x100, &serial_index[1]);
