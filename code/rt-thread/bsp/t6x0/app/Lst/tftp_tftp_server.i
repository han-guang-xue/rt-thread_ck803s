# 1 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
# 50 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h" 1
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h"
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_opts.h" 1
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_opts.h"
...
# 45 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_opts.h" 2
# 45 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h" 2
...
# 46 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h" 2
...
# 47 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h" 2
# 55 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h"
struct tftp_context {
...
# 85 "../../../components/net/lwip-2.0.2/src/include/lwip/apps/tftp_server.h"
  int (*write)(void* handle, struct pbuf* p);
};

err_t tftp_init(const struct tftp_context* ctx);
# 51 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 2



# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/udp.h" 1
# 46 "../../../components/net/lwip-2.0.2/src/include/lwip/udp.h"
...
# 55 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 2
# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/timeouts.h" 1
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/timeouts.h"
...
# 56 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 2
# 67 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
enum tftp_error {
...
# 103 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                            0
# 103 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                ) {
    pbuf_free(tftp_state.last_data);
    tftp_state.last_data = 
# 105 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                          0
# 105 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                              ;
  }

  sys_untimeout(tftp_tmr, 
# 108 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                         0
# 108 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                             );

  if (tftp_state.handle) {
    tftp_state.ctx->close(tftp_state.handle);
    tftp_state.handle = 
# 112 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                       0
# 112 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                           ;
    ;
  }
}
...
send_error(const ip_addr_t *addr, u16_t port, enum tftp_error code, const char *str)
{
  ...
  if(p == 
# 125 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
         0
# 125 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
             ) {
    return;
  }

  payload = (u16_t*) p->payload;
  payload[0] = ((((5) & 0x00ffUL) << 8) | (((5) & 0xff00UL) >> 8));
...
send_ack(u16_t blknum)
{
  ...
  if(p == 
# 145 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
         0
# 145 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
             ) {
    return;
  }
  payload = (u16_t*) p->payload;

  payload[0] = ((((4) & 0x00ffUL) << 8) | (((4) & 0xff00UL) >> 8));
...
resend_data(void)
{
  ...
  if(p == 
# 160 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
         0
# 160 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
             ) {
    return;
  }
...
send_data(void)
{
  ...
  if(tftp_state.last_data != 
# 179 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                            0
# 179 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                ) {
    pbuf_free(tftp_state.last_data);
  }
  ...
  if(tftp_state.last_data == 
# 184 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                            0
# 184 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                ) {
    return;
  }

  payload = (u16_t *) tftp_state.last_data->payload;
  payload[0] = ((((3) & 0x00ffUL) << 8) | (((3) & 0xff00UL) >> 8));
...
recv(void *arg, struct udp_pcb *upcb, struct pbuf *p, const ip_addr_t *addr, u16_t port)
{
  ...
  switch (opcode) {
    case ((((1) & 0x00ffUL) << 8) | (((1) & 0xff00UL) >> 8)):
    case ((((2) & 0x00ffUL) << 8) | (((2) & 0xff00UL) >> 8)):
    {
      const char tftp_null = 0;
      char filename[255 + 1] = { 0 };
      char mode[7] = { 0 };
      u16_t filename_end_offset;
      u16_t mode_end_offset;

      if(tftp_state.handle != 
# 234 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                             0
# 234 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                 ) {
        send_error(addr, port, TFTP_ERROR_ACCESS_VIOLATION, "Only one connection at a time is supported");
        break;
      }
...
# 239 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                                             0
# 239 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                                 );
      ...
      tftp_state.handle = tftp_state.ctx->open(filename, mode, opcode == ((((2) & 0x00ffUL) << 8) | (((2) & 0xff00UL) >> 8)));
      tftp_state.blknum = 1;
      ...
      if (opcode == ((((2) & 0x00ffUL) << 8) | (((2) & 0xff00UL) >> 8))) {
    ...
    case ((((3) & 0x00ffUL) << 8) | (((3) & 0xff00UL) >> 8)):
    {
      ...
      if (tftp_state.handle == 
# 288 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                              0
# 288 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                  ) {
    ...
    case ((((4) & 0x00ffUL) << 8) | (((4) & 0xff00UL) >> 8)):
    {
      ...
      if (tftp_state.handle == 
# 320 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                              0
# 320 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                  ) {
        send_error(addr, port, TFTP_ERROR_ACCESS_VIOLATION, "No connection");
        break;
      }
      ...
      if (tftp_state.last_data != 
# 338 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                                 0
# 338 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                     ) {
...
tftp_tmr(void* arg)
{
  ...
  if (tftp_state.handle == 
# 367 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                          0
# 367 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                              ) {
    return;
  }

  sys_timeout(50, tftp_tmr, 
# 371 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                                         0
# 371 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                                             );

  if ((tftp_state.timer - tftp_state.last_pkt) > (10000 / 50)) {
    if ((tftp_state.last_data != 
# 374 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                                0
# 374 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
...
tftp_init(const struct tftp_context *ctx)
{
  ...
  if (pcb == 
# 395 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
            0
# 395 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                ) {
    return ERR_MEM;
  }
  ...
  tftp_state.handle = 
# 405 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                        0
# 405 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                            ;
  tftp_state.port = 0;
  tftp_state.ctx = ctx;
  tftp_state.timer = 0;
  tftp_state.last_data = 
# 409 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                        0
# 409 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                            ;
  tftp_state.upcb = pcb;

  udp_recv(pcb, recv, 
# 412 "../../../packages/netutils-1.0.0/tftp/tftp_server.c" 3 4
                     0
# 412 "../../../packages/netutils-1.0.0/tftp/tftp_server.c"
                         );
