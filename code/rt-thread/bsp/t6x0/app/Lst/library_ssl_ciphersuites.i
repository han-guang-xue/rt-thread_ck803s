# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
# 27 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
...
# 28 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c" 2
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
...
# 39 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c" 2
...
# 40 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c" 2
...
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c" 2
# 57 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
static const int ciphersuite_preference_gm[] =
{
...
static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
    ...
    { 0xC02B, "TLS-ECDHE-ECDSA-WITH-AES-128-GCM-SHA256",
      ...
      3, 3,
      0 },
# 331 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    ...
    { 0xC0AE, "TLS-ECDHE-ECDSA-WITH-AES-128-CCM-8",
      ...
      3, 3,
      0x02 },
# 393 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    { 0xC008, "TLS-ECDHE-ECDSA-WITH-3DES-EDE-CBC-SHA",
      MBEDTLS_CIPHER_DES_EDE3_CBC, MBEDTLS_MD_SHA1, MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA,
      3, 1,
      3, 3,
      0 },
# 427 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    ...
    { 0xC02F, "TLS-ECDHE-RSA-WITH-AES-128-GCM-SHA256",
      ...
      3, 3,
      0 },
# 512 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    { 0xC012, "TLS-ECDHE-RSA-WITH-3DES-EDE-CBC-SHA",
      MBEDTLS_CIPHER_DES_EDE3_CBC, MBEDTLS_MD_SHA1, MBEDTLS_KEY_EXCHANGE_ECDHE_RSA,
      3, 1,
      3, 3,
      0 },
# 689 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    ...
    { 0xC0A0, "TLS-RSA-WITH-AES-128-CCM-8",
      ...
      3, 3,
      0x02 },
# 803 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    { 0x0A, "TLS-RSA-WITH-3DES-EDE-CBC-SHA",
      MBEDTLS_CIPHER_DES_EDE3_CBC, MBEDTLS_MD_SHA1, MBEDTLS_KEY_EXCHANGE_RSA,
      3, 0,
      3, 3,
      0 },
# 835 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    ...
    { 0xC031, "TLS-ECDH-RSA-WITH-AES-128-GCM-SHA256",
      ...
      3, 3,
      0 },
# 920 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    { 0xC00D, "TLS-ECDH-RSA-WITH-3DES-EDE-CBC-SHA",
      MBEDTLS_CIPHER_DES_EDE3_CBC, MBEDTLS_MD_SHA1, MBEDTLS_KEY_EXCHANGE_ECDH_RSA,
      3, 1,
      3, 3,
      0 },
# 954 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
...
# 1458 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    ...
    { 0x95, "TLS-RSA-PSK-WITH-AES-256-CBC-SHA",
      ...
      3, 3,
      0 },
# 1514 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    { 0x93, "TLS-RSA-PSK-WITH-3DES-EDE-CBC-SHA",
      MBEDTLS_CIPHER_DES_EDE3_CBC, MBEDTLS_MD_SHA1, MBEDTLS_KEY_EXCHANGE_RSA_PSK,
      3, 1,
      3, 3,
      0 },
# 1707 "../../../packages/mbedtls-2.6.0/mbedtls/library/ssl_ciphersuites.c"
    { 0xE013, "ECC_SM4_SM3",
      MBEDTLS_CIPHER_SM4_128_CBC, MBEDTLS_MD_SM3, MBEDTLS_KEY_EXCHANGE_ECC,
      1, 1,
      1, 1,
      0 },
...
static int supported_ciphersuites_ssl[sizeof( ciphersuite_definitions ) / sizeof( ciphersuite_definitions[0] )];
static int supported_init_ssl = 0;




static int supported_ciphersuites_gmssl[sizeof( ciphersuite_definitions ) / sizeof( ciphersuite_definitions[0] )];
static int supported_init_gmssl = 0;
...
const int *mbedtls_ssl_list_ciphersuites( void )
{
    ...
    if( supported_init_ssl == 0 )
    {
        const int *p;
        int *q;

        for( p = ciphersuite_preference, q = supported_ciphersuites_ssl;
             *p != 0 && q < supported_ciphersuites_ssl + sizeof( ciphersuite_definitions ) / sizeof( ciphersuite_definitions[0] ) - 1;
             p++ )
        {
        ...
        *q = 0;
        ...
        supported_init_ssl = 1;
    }

    return( supported_ciphersuites_ssl);
}
...
const int *mbedtls_gmssl_list_ciphersuites( void )
{
    ...
    if( supported_init_gmssl == 0 )
    {
        const int *p;
        int *q;

        for( p = ciphersuite_preference_gm, q = supported_ciphersuites_gmssl;
             *p != 0 && q < supported_ciphersuites_gmssl + sizeof( ciphersuite_definitions ) / sizeof( ciphersuite_definitions[0] ) - 1;
             p++ )
        {
        ...
        *q = 0;
        ...
        supported_init_gmssl = 1;
    }

    return( supported_ciphersuites_gmssl);
}
...
const int *mbedtls_all_list_ciphersuites( void )
{
    ...
    if( supported_init == 0 )
    {
        ...
        for( p = ciphersuite_preference_gm;
             *p != 0 && q < supported_ciphersuites + sizeof( ciphersuite_definitions ) / sizeof( ciphersuite_definitions[0] ) - 1;
             p++ )
        {
