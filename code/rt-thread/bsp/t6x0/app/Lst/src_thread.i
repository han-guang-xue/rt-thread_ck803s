# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
...
# 1 "<command-line>"
# 1 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
# 43 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
...
# 44 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c" 2
# 1 "../../../include/rthw.h" 1
# 30 "../../../include/rthw.h"
#define __RT_HW_H__ 
...
void xmem_init(void);
# 45 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c" 2
...
# 64 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
void __attribute__((section(".fast"))) rt_thread_suspend_sethook(void (*hook)(rt_thread_t thread))
{
    rt_thread_suspend_hook = hook;
}
# 77 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
void __attribute__((section(".fast"))) rt_thread_resume_sethook(void (*hook)(rt_thread_t thread))
{
...
void __attribute__((section(".fast"))) rt_thread_inited_sethook(void (*hook)(rt_thread_t thread))
{
                                ...
                                rt_uint32_t tick)
{
    ...
    rt_timer_init(&(thread->thread_timer),
                  ...
                  0,
                  0x0);
# 202 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
    do { if ((rt_thread_inited_hook) != (0)) rt_thread_inited_hook (thread); } while (0);

    return 0;
}
# 228 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t rt_thread_init(struct rt_thread *thread,
                        const char *name,
                        void (*entry)(void *parameter),
                        void *parameter,
                        ...
                        rt_uint32_t tick)
{
    ...
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 238); };
    if (!(stack_start != (0))) { rt_assert_handler("stack_start != RT_NULL", __FUNCTION__, 239); };
...
rt_thread_t __attribute__((section(".fast"))) rt_thread_self(void)
{
    return rt_current_thread;
}
;
# 273 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_startup(rt_thread_t thread)
{

    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 276); };
    if (!((thread->stat & 0x0f) == 0x00)) { rt_assert_handler("(thread->stat & RT_THREAD_STAT_MASK) == RT_THREAD_INIT", __FUNCTION__, 277); };
...
;
# 315 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_detach(rt_thread_t thread)
{
    rt_base_t lock;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 320); };
...
;
# 368 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_thread_t rt_thread_create(const char *name,
                             void (*entry)(void *parameter),
                             void *parameter,
                             rt_uint32_t stack_size,
...
;
# 413 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_delete(rt_thread_t thread)
{
    rt_base_t lock;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 418); };
...
;
# 453 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_yield(void)
{
    register rt_base_t level;
    struct rt_thread *thread;
...
;
# 497 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_sleep(rt_tick_t tick)
{
    ...
    thread = rt_current_thread;
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 506); };
...
# 534 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_delay(rt_tick_t tick)
{
    return rt_thread_sleep(tick);
}
;
# 547 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_mdelay(rt_int32_t ms)
{
    rt_tick_t tick;
...
;
# 569 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_control(rt_thread_t thread, int cmd, void *arg)
{
    register rt_base_t temp;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 574); };
...
;
# 647 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_suspend(rt_thread_t thread)
{
    register rt_base_t temp;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 652); };
...
;
# 689 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_err_t __attribute__((section(".fast"))) rt_thread_resume(rt_thread_t thread)
{
    register rt_base_t temp;


    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 694); };
...
void __attribute__((section(".fast"))) rt_thread_timeout(void *parameter)
{
    struct rt_thread *thread;
    ...
    if (!(thread != (0))) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 738); };
    if (!((thread->stat & 0x0f) == 0x02)) { rt_assert_handler("(thread->stat & RT_THREAD_STAT_MASK) == RT_THREAD_SUSPEND", __FUNCTION__, 739); };
...
;
# 764 "E:/YCXGIT/T6x0_RTOS_SDK_V0.9.3_b1/T6x0_RTOS_SDK_V0.9.3/code/rt-thread/src/thread.c"
rt_thread_t __attribute__((section(".fast"))) rt_thread_find(char *name)
{
    ...
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 776); };
