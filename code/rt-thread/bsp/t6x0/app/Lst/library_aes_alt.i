# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c"
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c"
...
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c" 2
...
# 37 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c" 2
...
# 39 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c" 2
...
int tih_mpi_inv_mod(const unsigned int *modulus, const unsigned int *a, unsigned int *ainv,
                      unsigned int mod_nword, unsigned int a_nword);
# 40 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c" 2
# 51 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c"
...
# 52 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c" 2
# 62 "../../../packages/mbedtls-2.6.0/mbedtls/library/aes_alt.c"
                    ...
                    unsigned char output[16] )
{
                    ...
                    ( rt_hw_dtcm_addr_check( (unsigned int)output ) ) )
    {
        ...
        memcpy( in, input, 16 );
        ret = tih_aes_crypt( in, out, 16, ctx->key, ctx->keybytes, !mode, 0x00, ((void *)0) );
        memcpy( output, out, 16 );
    }
    else
    {
        ret = (int)tih_aes_crypt( (unsigned char *)input, output, 16, ctx->key, ctx->keybytes, !mode, 0x00, ((void *)0) );
    }
                    ...
                    unsigned char *output )
{
    ...
    {
        ret = tih_aes_crypt( (unsigned char *)input, output, length, ctx->key, ctx->keybytes, !mode, 0x01, iv );
    }
                       ...
                       unsigned char *output )
{
                  ...
                  ( rt_hw_dtcm_addr_check( (unsigned int)output ) ) )
    {
        ...
        if( len > 0 )
        {
            memcpy( output + out_offset, input + 16, len );
            if( mode == 0 )
                ret = tih_aes_crypt( output + out_offset, output + out_offset, len, ctx->key, ctx->keybytes, !mode, 0x02, in_t + 16 - 16 );
            else
                ret = tih_aes_crypt( output + out_offset, output + out_offset, len, ctx->key, ctx->keybytes, !mode, 0x02, out_t + 16 - 16 );
            memmove(output + 16, output + out_offset,len );
            memcpy( output, out_t, 16 );
        }
        else
    ...
    {
        ret = tih_aes_crypt( (unsigned char *)input, output, length, ctx->key, ctx->keybytes, !mode, 0x02, iv );
    }
                       ...
                       unsigned char *output )
{
    ...
    {
        ret = tih_aes_crypt_ctr( (unsigned char*)input, output, length, ctx->key, ctx->keybytes, 0x00, 0x04, nonce_counter, step );
