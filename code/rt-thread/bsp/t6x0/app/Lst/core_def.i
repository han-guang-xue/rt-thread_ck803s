# 1 "../../../components/net/lwip-2.0.2/src/core/def.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/def.c"
# 61 "../../../components/net/lwip-2.0.2/src/core/def.c"
...
# 62 "../../../components/net/lwip-2.0.2/src/core/def.c" 2
...
# 63 "../../../components/net/lwip-2.0.2/src/core/def.c" 2
# 75 "../../../components/net/lwip-2.0.2/src/core/def.c"
u16_t
__attribute__((section(".fast"))) lwip_htons(u16_t n)
{
  return (u16_t)((((n) & 0x00ffUL) << 8) | (((n) & 0xff00UL) >> 8));
}
# 89 "../../../components/net/lwip-2.0.2/src/core/def.c"
u32_t
...
# 104 "../../../components/net/lwip-2.0.2/src/core/def.c"
char*
lwip_strnstr(const char* buffer, const char* token, size_t n)
{
  ...
  return 
# 117 "../../../components/net/lwip-2.0.2/src/core/def.c" 3 4
        0
# 117 "../../../components/net/lwip-2.0.2/src/core/def.c"
            ;
}
# 127 "../../../components/net/lwip-2.0.2/src/core/def.c"
int
...
# 162 "../../../components/net/lwip-2.0.2/src/core/def.c"
int
...
# 197 "../../../components/net/lwip-2.0.2/src/core/def.c"
void
