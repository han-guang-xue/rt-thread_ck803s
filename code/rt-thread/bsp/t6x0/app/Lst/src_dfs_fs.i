...
# 30 "../../../components/dfs/src/dfs_fs.c" 2
...
# 31 "../../../components/dfs/src/dfs_fs.c" 2
...
# 32 "../../../components/dfs/src/dfs_fs.c" 2
# 45 "../../../components/dfs/src/dfs_fs.c"
int dfs_register(const struct dfs_filesystem_ops *ops)
{
    int ret = 0;
    const struct dfs_filesystem_ops **empty = 
# 48 "../../../components/dfs/src/dfs_fs.c" 3 4
                                             (0)
# 48 "../../../components/dfs/src/dfs_fs.c"
                                                 ;
           ...
           iter < &filesystem_operation_table[4]; iter ++)
    {
        ...
        if (*iter == 
# 58 "../../../components/dfs/src/dfs_fs.c" 3 4
                    (0)
# 58 "../../../components/dfs/src/dfs_fs.c"
                        )
            (empty == 
# 59 "../../../components/dfs/src/dfs_fs.c" 3 4
                     (0)
# 59 "../../../components/dfs/src/dfs_fs.c"
                         ) ? (empty = iter) : 0;
    ...
    if (empty == 
# 69 "../../../components/dfs/src/dfs_fs.c" 3 4
                (0)
# 69 "../../../components/dfs/src/dfs_fs.c"
                    )
    {
        rt_set_errno(-28);
        ret = -1;
...
# 91 "../../../components/dfs/src/dfs_fs.c"
struct dfs_filesystem *dfs_filesystem_lookup(const char *path)
{
    struct dfs_filesystem *iter;
    struct dfs_filesystem *fs = 
# 94 "../../../components/dfs/src/dfs_fs.c" 3 4
                               (0)
# 94 "../../../components/dfs/src/dfs_fs.c"
                                   ;
    ...
    {
        if ((iter->path == 
# 108 "../../../components/dfs/src/dfs_fs.c" 3 4
                          (0)
# 108 "../../../components/dfs/src/dfs_fs.c"
                              ) || (iter->ops == 
# 108 "../../../components/dfs/src/dfs_fs.c" 3 4
                                                 (0)
# 108 "../../../components/dfs/src/dfs_fs.c"
...
# 136 "../../../components/dfs/src/dfs_fs.c"
const char* dfs_filesystem_get_mounted_path(struct rt_device* device)
{
    const char* path = 
# 138 "../../../components/dfs/src/dfs_fs.c" 3 4
                      (0)
# 138 "../../../components/dfs/src/dfs_fs.c"
                          ;
    struct dfs_filesystem *iter;
            ...
            iter < &filesystem_table[4]; iter++)
    {
        ...
        if (iter->ops == 
# 146 "../../../components/dfs/src/dfs_fs.c" 3 4
                        (0)
# 146 "../../../components/dfs/src/dfs_fs.c"
                            ) continue;
...
# 169 "../../../components/dfs/src/dfs_fs.c"
int dfs_filesystem_get_partition(struct dfs_partition *part,
                                      uint8_t *buf,
                                      uint32_t pindex)
{
    ...
    if (!(part != 
# 179 "../../../components/dfs/src/dfs_fs.c" 3 4
   (0)
# 179 "../../../components/dfs/src/dfs_fs.c"
   )) { rt_assert_handler("part != NULL", __FUNCTION__, 179); };
    if (!(buf != 
# 180 "../../../components/dfs/src/dfs_fs.c" 3 4
   (0)
# 180 "../../../components/dfs/src/dfs_fs.c"
...
# 227 "../../../components/dfs/src/dfs_fs.c"
int dfs_mount(const char *device_name,
              const char *path,
              const char *filesystemtype,
              unsigned long rwflag,
              const void *data)
{
    ...
    struct dfs_filesystem *iter;
    struct dfs_filesystem *fs = 
# 235 "../../../components/dfs/src/dfs_fs.c" 3 4
                               (0)
# 235 "../../../components/dfs/src/dfs_fs.c"
                                   ;
    char *fullpath = 
# 236 "../../../components/dfs/src/dfs_fs.c" 3 4
                    (0)
# 236 "../../../components/dfs/src/dfs_fs.c"
                        ;
    rt_device_t dev_id;


    if (device_name == 
# 240 "../../../components/dfs/src/dfs_fs.c" 3 4
                      (0)
# 240 "../../../components/dfs/src/dfs_fs.c"
                          )
    {

        dev_id = 
# 243 "../../../components/dfs/src/dfs_fs.c" 3 4
                (0)
# 243 "../../../components/dfs/src/dfs_fs.c"
                    ;
    }
    else if ((dev_id = rt_device_find(device_name)) == 
# 245 "../../../components/dfs/src/dfs_fs.c" 3 4
                                                      (0)
# 245 "../../../components/dfs/src/dfs_fs.c"
                                                          )
    {
    ...
    for (ops = &filesystem_operation_table[0];
        ...
        if ((*ops != 
# 257 "../../../components/dfs/src/dfs_fs.c" 3 4
                    (0)
# 257 "../../../components/dfs/src/dfs_fs.c"
    ...
    if ((*ops == 
# 270 "../../../components/dfs/src/dfs_fs.c" 3 4
                (0)
# 270 "../../../components/dfs/src/dfs_fs.c"
                    ) || ((*ops)->mount == 
# 270 "../../../components/dfs/src/dfs_fs.c" 3 4
                                           (0)
# 270 "../../../components/dfs/src/dfs_fs.c"
...
# 277 "../../../components/dfs/src/dfs_fs.c" 3 4
                                 (0)
# 277 "../../../components/dfs/src/dfs_fs.c"
                                     , path);
    if (fullpath == 
# 278 "../../../components/dfs/src/dfs_fs.c" 3 4
                   (0)
# 278 "../../../components/dfs/src/dfs_fs.c"
                       )
    {
        rt_set_errno(-20);
        return -1;
            ...
            iter < &filesystem_table[4]; iter++)
    {
        ...
        if (iter->ops == 
# 307 "../../../components/dfs/src/dfs_fs.c" 3 4
                        (0)
# 307 "../../../components/dfs/src/dfs_fs.c"
                            )
            (fs == 
# 308 "../../../components/dfs/src/dfs_fs.c" 3 4
                  (0)
# 308 "../../../components/dfs/src/dfs_fs.c"
                      ) ? (fs = iter) : 0;
    ...
    if ((fs == 
# 317 "../../../components/dfs/src/dfs_fs.c" 3 4
              (0)
# 317 "../../../components/dfs/src/dfs_fs.c"
    ...
    if (dev_id != 
# 331 "../../../components/dfs/src/dfs_fs.c" 3 4
                 (0)
# 331 "../../../components/dfs/src/dfs_fs.c"
                     )
    {
    ...
    if ((*ops)->mount(fs, rwflag, data) < 0)
    {
        ...
        if (dev_id != 
# 348 "../../../components/dfs/src/dfs_fs.c" 3 4
                     (0)
# 348 "../../../components/dfs/src/dfs_fs.c"
                         )
...
# 375 "../../../components/dfs/src/dfs_fs.c"
int dfs_unmount(const char *specialfile)
{
    char *fullpath;
    struct dfs_filesystem *iter;
    struct dfs_filesystem *fs = 
# 379 "../../../components/dfs/src/dfs_fs.c" 3 4
                               (0)
# 379 "../../../components/dfs/src/dfs_fs.c"
                                   ;

    fullpath = dfs_normalize_path(
# 381 "../../../components/dfs/src/dfs_fs.c" 3 4
                                 (0)
# 381 "../../../components/dfs/src/dfs_fs.c"
                                     , specialfile);
    if (fullpath == 
# 382 "../../../components/dfs/src/dfs_fs.c" 3 4
                   (0)
# 382 "../../../components/dfs/src/dfs_fs.c"
                       )
    {
        rt_set_errno(-20);
            ...
            iter < &filesystem_table[4]; iter++)
    {
        ...
        if ((iter->path != 
# 396 "../../../components/dfs/src/dfs_fs.c" 3 4
                          (0)
# 396 "../../../components/dfs/src/dfs_fs.c"
    ...
    if (fs == 
# 403 "../../../components/dfs/src/dfs_fs.c" 3 4
             (0) 
# 403 "../../../components/dfs/src/dfs_fs.c"
                  ||
        fs->ops->unmount == 
# 404 "../../../components/dfs/src/dfs_fs.c" 3 4
                           (0) 
# 404 "../../../components/dfs/src/dfs_fs.c"
                                ||
        fs->ops->unmount(fs) < 0)
    {
        goto err1;
    ...
    if (fs->dev_id != 
# 411 "../../../components/dfs/src/dfs_fs.c" 3 4
                     (0)
# 411 "../../../components/dfs/src/dfs_fs.c"
                         )
        rt_device_close(fs->dev_id);

    if (fs->path != 
# 414 "../../../components/dfs/src/dfs_fs.c" 3 4
                   (0)
# 414 "../../../components/dfs/src/dfs_fs.c"
                       )
        rt_free(fs->path);
...
# 440 "../../../components/dfs/src/dfs_fs.c"
int dfs_mkfs(const char *fs_name, const char *device_name)
{
    int index;
    rt_device_t dev_id = 
# 443 "../../../components/dfs/src/dfs_fs.c" 3 4
                        (0)
# 443 "../../../components/dfs/src/dfs_fs.c"
                            ;


    if (device_name != 
# 446 "../../../components/dfs/src/dfs_fs.c" 3 4
                      (0)
# 446 "../../../components/dfs/src/dfs_fs.c"
                          )
        dev_id = rt_device_find(device_name);

    if (dev_id == 
# 449 "../../../components/dfs/src/dfs_fs.c" 3 4
                 (0)
# 449 "../../../components/dfs/src/dfs_fs.c"
                     )
    {
        rt_set_errno(-19);
        return -1;
...
# 460 "../../../components/dfs/src/dfs_fs.c" 3 4
                                                (0) 
# 460 "../../../components/dfs/src/dfs_fs.c"
                                                     &&
    ...
    if (index <= 4)
    {
        ...
        if (ops->mkfs == 
# 470 "../../../components/dfs/src/dfs_fs.c" 3 4
                        (0)
# 470 "../../../components/dfs/src/dfs_fs.c"
                            )
        {
            rt_set_errno(-38);
            return -1;
...
# 491 "../../../components/dfs/src/dfs_fs.c"
int dfs_statfs(const char *path, struct statfs *buffer)
{
    struct dfs_filesystem *fs;
    ...
    if (fs != 
# 496 "../../../components/dfs/src/dfs_fs.c" 3 4
             (0)
# 496 "../../../components/dfs/src/dfs_fs.c"
                 )
    {
        if (fs->ops->statfs != 
# 498 "../../../components/dfs/src/dfs_fs.c" 3 4
                              (0)
# 498 "../../../components/dfs/src/dfs_fs.c"
                                  )
...
# 533 "../../../components/dfs/src/dfs_fs.c"
...
# 534 "../../../components/dfs/src/dfs_fs.c" 2
...
# 550 "../../../components/dfs/src/dfs_fs.c" 3 4
                                     (0)
# 550 "../../../components/dfs/src/dfs_fs.c"
                                         , &buffer);
    if (result != 0)
    {
