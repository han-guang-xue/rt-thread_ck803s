...
# 1 "<command-line>"
# 1 "../../../components/drivers/i2c/i2c_dev.c"
# 26 "../../../components/drivers/i2c/i2c_dev.c"
...
# 27 "../../../components/drivers/i2c/i2c_dev.c" 2
                                     ...
                                     rt_size_t count)
{
    ...
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 37); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 38); };
                                      ...
                                      rt_size_t count)
{
    ...
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 57); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 58); };
                                       ...
                                       void *args)
{
    ...
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 76); };
...
# 117 "../../../components/drivers/i2c/i2c_dev.c"
rt_err_t rt_i2c_bus_device_device_init(struct rt_i2c_bus_device *bus,
                                       const char *name)
{
    struct rt_device *device;
    if (!(bus != (0))) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 121); };
