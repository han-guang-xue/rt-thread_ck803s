# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
# 29 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
...
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c" 2
...
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c" 2
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c" 2
# 45 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
...
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c" 2
...
static const int supported_digests[] = {
            ...
            MBEDTLS_MD_SM3,
# 72 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
        MBEDTLS_MD_SHA256,
        MBEDTLS_MD_SHA224,
        ...
        MBEDTLS_MD_MD5,
# 96 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
        MBEDTLS_MD_NONE
};
...
const mbedtls_md_info_t *mbedtls_md_info_from_string( const char *md_name )
{
    if( ((void *)0) == md_name )
        return( ((void *)0) );
# 119 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
...
# 144 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
...
const mbedtls_md_info_t *mbedtls_md_info_from_type( mbedtls_md_type_t md_type )
{
    switch( md_type )
    {
# 164 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
        case MBEDTLS_MD_MD5:
...
# 189 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
        case MBEDTLS_MD_SM3:
...
int mbedtls_md_setup( mbedtls_md_context_t *ctx, const mbedtls_md_info_t *md_info, int mode )
{
    ...
    if( md_info->offload_set_func )
    {
        int hw_offload;

        hw_offload = ( ( ( mode & (1 << 16) ) == 0 ) ? 0 : 1 );
        md_info->offload_set_func( ctx->md_ctx, hw_offload );
    }
...
# 355 "../../../packages/mbedtls-2.6.0/mbedtls/library/md.c"
                ...
                unsigned char *output )
{
    ...
    if( ( ret = mbedtls_md_setup( &ctx, md_info, ((1 << 0) | (1 << 16)) ) ) != 0 )
        return( ret );
