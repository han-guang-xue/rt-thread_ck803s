# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
# 29 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
...
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md_internal.h" 1
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md_internal.h"
...
# 37 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md_internal.h" 2
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md_internal.h"
struct mbedtls_md_info_t
{
    ...
    void (*offload_set_func)( void *ctx, int mode );
};
# 96 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/md_internal.h"
...
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c" 2
# 45 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
...
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c" 2
...
# 54 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c" 2
...
# 58 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c" 2
...
# 66 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c" 2
# 204 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
...
# 328 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
...
static void sha1_offload_set_wrap( void *ctx, int mode )
{
    mbedtls_sha1_set( (mbedtls_sha1_context *) ctx, mode );
}
...
const mbedtls_md_info_t mbedtls_sha1_info = {
    ...
    sha1_clone_wrap,
    sha1_process_wrap,
    sha1_offload_set_wrap,
};
# 399 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
...
static void sha224_offload_set_wrap( void *ctx, int mode )
{
    mbedtls_sha256_set( (mbedtls_sha256_context *) ctx, mode );
}
...
# 593 "../../../packages/mbedtls-2.6.0/mbedtls/library/md_wrap.c"
...
{
    void *ctx = calloc( 1, sizeof( mbedtls_sm3_context ) );
...
static void sm3_offload_set_wrap( void *ctx, int mode )
{
    mbedtls_sm3_set( (mbedtls_sm3_context *) ctx, mode );
}
