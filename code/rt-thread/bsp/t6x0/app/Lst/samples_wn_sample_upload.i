# 1 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c"
# 24 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c"
...
# 25 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c" 2
...
# 26 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c" 2
...
# 29 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c" 2
...
# 31 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c" 2
...
# 32 "../../../packages/webnet-2.0.0/samples/wn_sample_upload.c" 2
...
static const char * sd_upload = "/ram";

static const char * upload_dir = "";
static int file_size = 0;

const char *get_file_name(struct webnet_session *session)
{
    const char *path = (0), *path_last = (0);
...
static int upload_open(struct webnet_session *session)
{
    ...
    if (webnet_upload_get_filename(session) != (0))
    {
        int path_size;
        char * file_path;
