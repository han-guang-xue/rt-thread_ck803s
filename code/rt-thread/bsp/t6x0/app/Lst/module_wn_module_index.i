# 1 "../../../packages/webnet-2.0.0/module/wn_module_index.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/webnet-2.0.0/module/wn_module_index.c"
# 25 "../../../packages/webnet-2.0.0/module/wn_module_index.c"
...
# 26 "../../../packages/webnet-2.0.0/module/wn_module_index.c" 2
...
# 27 "../../../packages/webnet-2.0.0/module/wn_module_index.c" 2
...
# 28 "../../../packages/webnet-2.0.0/module/wn_module_index.c" 2
...
# 31 "../../../packages/webnet-2.0.0/module/wn_module_index.c" 2
...
int webnet_module_dirindex(struct webnet_session* session, int event)
{
    ...
    if (event == (1 << 2))
    {
        ...
        if (!(session != (0))) { rt_assert_handler("session != RT_NULL", __FUNCTION__, 50); };
        request = session->request;
        if (!(request != (0))) { rt_assert_handler("request != RT_NULL", __FUNCTION__, 52); };
        ...
        if (dir != (0))
        {
            ...
            webnet_session_printf(session, foot, "2.0.0");
