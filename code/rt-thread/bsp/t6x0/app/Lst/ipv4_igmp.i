# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
# 83 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
...
# 84 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 2



# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/igmp.h" 1
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/igmp.h"
...
# 44 "../../../components/net/lwip-2.0.2/src/include/lwip/netif.h"
...
void igmp_tmr(void);
# 88 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 2
...
# 92 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 2
...
# 93 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 2


# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/prot/igmp.h" 1
# 74 "../../../components/net/lwip-2.0.2/src/include/lwip/prot/igmp.h"
...
# 96 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 2
...
igmp_start(struct netif *netif)
{
  ...
  if (group != 
# 136 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
              0
# 136 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                  ) {
    group->group_state = 2;
    group->use++;
...
# 141 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                 0
# 141 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                                     ) {
      ;
      ;
      ;
...
# 164 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
 0
# 164 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
 );

  while (group != 
# 166 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                 0
# 166 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                     ) {
    struct igmp_group *next = group->next;


    if (netif->igmp_mac_filter != 
# 170 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                 0
# 170 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                                     ) {
      ;
      ;
      ;
...
igmp_report_groups(struct netif *netif)
{
  ...
  if(group != 
# 199 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
             0
# 199 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                 ) {
    group = group->next;
  }

  while (group != 
# 203 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                 0
# 203 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                     ) {
    igmp_delaying_member(group, (500 /100));
    group = group->next;
  }
}
# 217 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
struct igmp_group *
igmp_lookfor_group(struct netif *ifp, const ip4_addr_t *addr)
{
  ...
  while (group != 
# 222 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                 0
# 222 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                     ) {
  ...
  return 
# 232 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
        0
# 232 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
            ;
}
# 243 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
...
igmp_lookup_group(struct netif *ifp, const ip4_addr_t *addr)
{
  ...
  if (group != 
# 251 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
              0
# 251 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                  ) {
  ...
  if (group != 
# 258 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
              0
# 258 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                  ) {
    ((&(group->group_address))->addr = ((addr) == 
# 259 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
   0 
# 259 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
   ? 0 : (addr)->addr));
    group->timer = 0;
    group->group_state = 0;
    ...
    if (list_head == 
# 266 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                    0
# 266 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                        ) {
...
# 268 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
      ,
                                              269
# 268 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
      );}while(0); }} while(0)
                                               ;
      group->next = 
# 270 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                   0
# 270 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                       ;
      ...
      do { if (!((((addr)->addr == (&allsystems)->addr) == 0))) { do {rt_kprintf("igmp_lookup_group: all except first group must not be allsystems"); sys_arch_assert(
                                              "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
# 274 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
      ,
                                              275
# 274 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
      );}while(0); }} while(0)
...
# 301 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                                       0
# 301 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
  ...
  if (tmp_group == 
# 308 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                  0
# 308 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                      ) {
    err = ERR_ARG;
  }
...
# 322 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
void
...
# 369 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                            0 
# 369 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
      ...
      if(groupref != 
# 385 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                    0
# 385 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                        ) {
...
# 395 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
          0 
# 395 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
          || ((*(&igmp->igmp_group_address)).addr == ((u32_t)0x00000000UL)))) {
        ;
        ;
        ...
        if (group != 
# 408 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                    0
# 408 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                        ) {
          ;
...
# 448 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
err_t
igmp_joingroup(const ip4_addr_t *ifaddr, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0x000000ffUL) << 24) | (((0xf0000000UL) & 0x0000ff00UL) << 8) | (((0xf0000000UL) & 0x00ff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0x000000ffUL) << 24) | (((0xe0000000UL) & 0x0000ff00UL) << 8) | (((0xe0000000UL) & 0x00ff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {rt_kprintf("igmp_joingroup: attempt to join non-multicast address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 455);}while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {rt_kprintf("igmp_joingroup: attempt to join allsystems address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 456);}while(0); return ERR_VAL;;}} while(0);


  netif = netif_list;
  while (netif != 
# 460 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                 0
# 460 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                     ) {

    if ((netif->flags & 0x20U) && ((((ifaddr) == 
# 462 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                             0 
# 462 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
...
# 485 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
err_t
igmp_joingroup_netif(struct netif *netif, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0x000000ffUL) << 24) | (((0xf0000000UL) & 0x0000ff00UL) << 8) | (((0xf0000000UL) & 0x00ff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0x000000ffUL) << 24) | (((0xe0000000UL) & 0x0000ff00UL) << 8) | (((0xe0000000UL) & 0x00ff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {rt_kprintf("igmp_joingroup_netif: attempt to join non-multicast address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 491);}while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {rt_kprintf("igmp_joingroup_netif: attempt to join allsystems address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 492);}while(0); return ERR_VAL;;}} while(0);


  do { if (!(netif->flags & 0x20U)) { do {rt_kprintf("igmp_joingroup_netif: attempt to join on non-IGMP netif"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 495);}while(0); return ERR_VAL;;}} while(0);


  group = igmp_lookup_group(netif, groupaddr);

  if (group != 
# 500 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
              0
# 500 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                  ) {
...
# 511 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                                       0
# 511 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                                                           )) {
        ;
        ;
        ;
...
# 544 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
err_t
igmp_leavegroup(const ip4_addr_t *ifaddr, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0x000000ffUL) << 24) | (((0xf0000000UL) & 0x0000ff00UL) << 8) | (((0xf0000000UL) & 0x00ff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0x000000ffUL) << 24) | (((0xe0000000UL) & 0x0000ff00UL) << 8) | (((0xe0000000UL) & 0x00ff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {rt_kprintf("igmp_leavegroup: attempt to leave non-multicast address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 551);}while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {rt_kprintf("igmp_leavegroup: attempt to leave allsystems address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 552);}while(0); return ERR_VAL;;}} while(0);


  netif = netif_list;
  while (netif != 
# 556 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                 0
# 556 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                     ) {

    if ((netif->flags & 0x20U) && ((((ifaddr) == 
# 558 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                             0 
# 558 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                                             || ((*(ifaddr)).addr == ((u32_t)0x00000000UL))) || ((((const ip4_addr_t*)(&((netif)->ip_addr))))->addr == (ifaddr)->addr)))) {
...
# 580 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
err_t
igmp_leavegroup_netif(struct netif *netif, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0x000000ffUL) << 24) | (((0xf0000000UL) & 0x0000ff00UL) << 8) | (((0xf0000000UL) & 0x00ff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0x000000ffUL) << 24) | (((0xe0000000UL) & 0x0000ff00UL) << 8) | (((0xe0000000UL) & 0x00ff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {rt_kprintf("igmp_leavegroup_netif: attempt to leave non-multicast address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 586);}while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {rt_kprintf("igmp_leavegroup_netif: attempt to leave allsystems address"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 587);}while(0); return ERR_VAL;;}} while(0);


  do { if (!(netif->flags & 0x20U)) { do {rt_kprintf("igmp_leavegroup_netif: attempt to leave on non-IGMP netif"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c", 590);}while(0); return ERR_VAL;;}} while(0);


  group = igmp_lookfor_group(netif, groupaddr);

  if (group != 
# 595 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
              0
# 595 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                  ) {
    ...
    if (group->use <= 1) {
      ...
      if (netif->igmp_mac_filter != 
# 614 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                                   0
# 614 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                                       ) {
        ;
        ;
        ;
...
igmp_tmr(void)
{
  ...
  while (netif != 
# 643 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                 0
# 643 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                     ) {
    struct igmp_group *group = ((struct igmp_group *)(netif)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)]);

    while (group != 
# 646 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                   0
# 646 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                       ) {
      if (group->timer > 0) {
        group->timer--;
        if (group->timer == 0) {
...
# 690 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
static void
...
# 739 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
static err_t
...
{
  struct pbuf* p = 
# 759 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                         0
# 759 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                             ;
  struct igmp_msg* igmp = 
# 760 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                         0
# 760 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                             ;
  ip4_addr_t src = *((&ip_addr_any));
  ip4_addr_t* dest = 
# 762 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c" 3 4
                     0
# 762 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
                         ;
  ...
  if (p) {
    ...
    do { if (!((p->len >= sizeof(struct igmp_msg)))) { do {rt_kprintf("igmp_send: check that first pbuf can hold struct igmp_msg"); sys_arch_assert(
                                                  "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
# 769 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
    ,
                                                  770
# 769 "../../../components/net/lwip-2.0.2/src/core/ipv4/igmp.c"
    );}while(0); }} while(0)
