# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c"
# 30 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c"
...
# 31 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c" 2




# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sm3.h" 1
# 32 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sm3.h"
...
# 33 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/sm3.h" 2
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c" 2
...
# 38 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c" 2
...
# 44 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c" 2
# 53 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c"
...
int tih_mpi_inv_mod(const unsigned int *modulus, const unsigned int *a, unsigned int *ainv,
                      unsigned int mod_nword, unsigned int a_nword);
# 54 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c" 2


static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = v; while( n-- ) *p++ = 0;
}
# 83 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c"
void mbedtls_sm3_init( mbedtls_sm3_context *ctx )
{
    if( ((void *)0) == ctx )
        return;
...
# 146 "../../../packages/mbedtls-2.6.0/mbedtls/library/sm3.c"
void mbedtls_sm3_process( mbedtls_sm3_context *ctx, const unsigned char data[64] )
{
    int j;
    uint32_t W[68], W1[64];
    ...
    for (j = 0; j < 16; j++)
    {
        do { (W[j]) = ( (uint32_t) (data)[(4 * j) ] << 24 ) | ( (uint32_t) (data)[(4 * j) + 1] << 16 ) | ( (uint32_t) (data)[(4 * j) + 2] << 8 ) | ( (uint32_t) (data)[(4 * j) + 3] ); } while( 0 );
    }
    for (j = 16; j < 68; j++)
    {
        W[j] = ((W[j-16] ^ W[j-9] ^ (((W[j-3])<<(15)) | ((W[j-3])>>(32-(15))))) ^ ((((W[j-16] ^ W[j-9] ^ (((W[j-3])<<(15)) | ((W[j-3])>>(32-(15))))))<<(15)) | (((W[j-16] ^ W[j-9] ^ (((W[j-3])<<(15)) | ((W[j-3])>>(32-(15))))))>>(32-(15)))) ^ ((((W[j-16] ^ W[j-9] ^ (((W[j-3])<<(15)) | ((W[j-3])>>(32-(15))))))<<(23)) | (((W[j-16] ^ W[j-9] ^ (((W[j-3])<<(15)) | ((W[j-3])>>(32-(15))))))>>(32-(23))))) ^ (((W[j - 13])<<(7)) | ((W[j - 13])>>(32-(7)))) ^ W[j-6];;
    }
    for( j = 0; j < 64; j++) {
        W1[j] = W[j] ^ W[j+4];
    }
    ...
    for(j =0; j < 16; j++)
    {
        ...
        T[j] = 0x79CC4519;
        SS1 = (((((((A)<<(12)) | ((A)>>(32-(12)))) + E + (((T[j])<<(j)) | ((T[j])>>(32-(j))))))<<(7)) | ((((((A)<<(12)) | ((A)>>(32-(12)))) + E + (((T[j])<<(j)) | ((T[j])>>(32-(j))))))>>(32-(7))));
    ...
    for(j =16; j < 64; j++)
    {
        ...
        T[j] = 0x7A879D8A;
        SS1 = (((((((A)<<(12)) | ((A)>>(32-(12)))) + E + (((T[j])<<(j%32)) | ((T[j])>>(32-(j%32))))))<<(7)) | ((((((A)<<(12)) | ((A)>>(32-(12)))) + E + (((T[j])<<(j%32)) | ((T[j])>>(32-(j%32))))))>>(32-(7))));
        SS2 = SS1 ^ (((A)<<(12)) | ((A)>>(32-(12))));
                    ...
                    size_t ilen )
{
    ...
    {
        tih_sm3_update( (unsigned char *)input, ilen );
    }
}
