# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
# 35 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 36 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
...
int mbedtls_x509write_crt_pem( mbedtls_x509write_cert *ctx, unsigned char *buf, size_t size,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng );
# 41 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
...
# 42 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/pk.h" 1
# 43 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
...
# 44 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
...
# 46 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
...
# 47 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
...
# 50 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
# 62 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
# 1 "../../../packages/mbedtls-2.6.0/mbedtls/include/mbedtls/threading.h" 1
# 63 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c" 2
# 81 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 452 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 749 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
    ...
    if( crt->sig_pk == MBEDTLS_PK_EC ){
        if( ( ret = mbedtls_gm_pk_parse_subpubkey( &p, end, &crt->pk ) ) != 0 )
        {
            mbedtls_x509_crt_free( crt );
            return( ret );
        }
...
# 855 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 903 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 1246 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 1295 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 1840 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
...
# 1879 "../../../packages/mbedtls-2.6.0/mbedtls/library/x509_crt.c"
    ...
    *flags |= 0x08;
    ...
    for( ; trust_ca != ((void *)0); trust_ca = trust_ca->next )
    {
        ...
        if( child->sig_pk == MBEDTLS_PK_EC )
        {
            ...
            if( ( ret = mbedtls_pk_z_get( &trust_ca->pk, child->sig_md, hash, 32 ) ) != 0 )
            {
                 return( ret );
            }

            mbedtls_sm3_starts( &ctx );
            mbedtls_sm3_update( &ctx, hash, 32 );

            mbedtls_sm3_update( &ctx, child->tbs.p, child->tbs.len );
            mbedtls_sm3_finish( &ctx, hash );
