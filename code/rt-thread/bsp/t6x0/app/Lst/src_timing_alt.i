# 1 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c"
# 25 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c"
...
# 26 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c" 2
...
# 32 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c" 2
...
# 39 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c" 2
...
# 41 "../../../packages/mbedtls-2.6.0/ports/src/timing_alt.c" 2
...
void mbedtls_set_alarm( int seconds )
{
    static rt_timer_t timer = ((void *)0);
    ...
    timer = rt_timer_create("malarm", mbedtls_alarm_entry, (0),
                            seconds * 100,
                            0x0);
    if (timer != (0))
    {
