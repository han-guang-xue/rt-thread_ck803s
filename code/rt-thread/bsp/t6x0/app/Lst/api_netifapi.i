# 1 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
# 41 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
...
# 42 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 2



# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/netifapi.h" 1
# 39 "../../../components/net/lwip-2.0.2/src/include/lwip/netifapi.h"
...
err_t netifapi_netif_common(struct netif *netif, netifapi_void_fn voidfunc,
                            netifapi_errt_fn errtfunc);
# 46 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 2
# 57 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
static err_t
...
# 109 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
                                 0
# 109 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
                                     ) {
...
# 124 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
err_t
                   ...
                   void *state, netif_init_fn init, netif_input_fn input)
{
  ...
  if (ipaddr == 
# 136 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
               0
# 136 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
                   ) {
    ipaddr = ((&ip_addr_any));
  }
  if (netmask == 
# 139 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
                0
# 139 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
                    ) {
    netmask = ((&ip_addr_any));
  }
  if (gw == 
# 142 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
           0
# 142 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
               ) {
    gw = ((&ip_addr_any));
  }
...
# 169 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
err_t
                        ...
                        const ip4_addr_t *gw)
{
  ...
  if (ipaddr == 
# 179 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
               0
# 179 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
                   ) {
    ipaddr = ((&ip_addr_any));
  }
  if (netmask == 
# 182 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
                0
# 182 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
                    ) {
    netmask = ((&ip_addr_any));
  }
  if (gw == 
# 185 "../../../components/net/lwip-2.0.2/src/api/netifapi.c" 3 4
           0
# 185 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
               ) {
    gw = ((&ip_addr_any));
  }
...
# 205 "../../../components/net/lwip-2.0.2/src/api/netifapi.c"
err_t
