# 1 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
# 44 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 45 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 2
...
# 49 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 2
...
# 55 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 2




# 1 "../../../components/net/lwip-2.0.2/src/include/lwip/nd6.h" 1
# 60 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 2
# 68 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 103 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
void
...
# 109 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                             0
# 109 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                 ;
  struct tcp_pcb_listen *lpcb_any = 
# 110 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                   0
# 110 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                       ;
...
# 159 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
  ...
  tcphdr_opt2 = 
# 169 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 169 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ;
  if (p->len >= hdrlen_bytes) {
    ...
    do { if (!(p->next != 
# 178 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
   0
# 178 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
   )) { do {rt_kprintf("p->next != NULL"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 178);}while(0); }} while(0);
    ...
    do { if (!(p->len == 0)) { do {rt_kprintf("p->len == 0"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 207);}while(0); }} while(0);
    do { if (!(p->tot_len == p->next->tot_len)) { do {rt_kprintf("p->tot_len == p->next->tot_len"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 208);}while(0); }} while(0);
  }
  ...
  prev = 
# 223 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
        0
# 223 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
            ;

  for (pcb = tcp_active_pcbs; pcb != 
# 225 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                    0
# 225 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                        ; pcb = pcb->next) {
    do { if (!(pcb->state != CLOSED)) { do {rt_kprintf("tcp_input: active pcb->state != CLOSED"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 226);}while(0); }} while(0);
    do { if (!(pcb->state != TIME_WAIT)) { do {rt_kprintf("tcp_input: active pcb->state != TIME-WAIT"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 227);}while(0); }} while(0);
    do { if (!(pcb->state != LISTEN)) { do {rt_kprintf("tcp_input: active pcb->state != LISTEN"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 228);}while(0); }} while(0);
    if (pcb->remote_port == tcphdr->src &&
      ...
      do { if (!(pcb->next != pcb)) { do {rt_kprintf("tcp_input: pcb->next != pcb (before cache)"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 236);}while(0); }} while(0);
      if (prev != 
# 237 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                 0
# 237 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                     ) {
        prev->next = pcb->next;
      ...
      do { if (!(pcb->next != pcb)) { do {rt_kprintf("tcp_input: pcb->next != pcb (after cache)"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 244);}while(0); }} while(0);
      break;
    }
    prev = pcb;
  }
  ...
  if (pcb == 
# 250 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
            0
# 250 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                ) {


    for (pcb = tcp_tw_pcbs; pcb != 
# 253 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                  0
# 253 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                      ; pcb = pcb->next) {
      do { if (!(pcb->state == TIME_WAIT)) { do {rt_kprintf("tcp_input: TIME-WAIT pcb->state == TIME-WAIT"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 254);}while(0); }} while(0);
      if (pcb->remote_port == tcphdr->src &&
          pcb->local_port == tcphdr->dest &&
          ((&pcb->remote_ip)->addr == ((&ip_data.current_iphdr_src))->addr) &&
          ((&pcb->local_ip)->addr == ((&ip_data.current_iphdr_dest))->addr)) {
    ...
    prev = 
# 271 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
          0
# 271 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
              ;
    for (lpcb = tcp_listen_pcbs.listen_pcbs; lpcb != 
# 272 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                                    0
# 272 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                                        ; lpcb = lpcb->next) {
...
# 286 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                    0 
# 286 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
    ...
    if (lpcb == 
# 301 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 301 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ) {
    ...
    if (lpcb != 
# 307 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 307 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ) {



      if (prev != 
# 311 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                 0
# 311 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                     ) {
...
# 335 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
  if (pcb != 
# 335 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
            0
# 335 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                ) {
    ...
    inseg.next = 
# 342 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                0
# 342 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                    ;
    inseg.len = p->tot_len;
    inseg.p = p;
    inseg.tcphdr = tcphdr;
    ...
    recv_data = 
# 347 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 347 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ;
    recv_flags = 0;
    recv_acked = 0;
    ...
    if (pcb->refused_data != 
# 356 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                            0
# 356 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                ) {
      if ((tcp_process_refused_data(pcb) == ERR_ABRT) ||
        ((pcb->refused_data != 
# 358 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                              0
# 358 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                  ) && (tcplen > 0))) {
...
# 381 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0
# 381 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        ...
        if (recv_acked > 0) {
          u16_t acked16;
# 399 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
          {
            acked16 = recv_acked;

            do { if((pcb)->sent != 
# 402 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
           0
# 402 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        ...
        if (recv_data != 
# 417 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                        0
# 417 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                            ) {


          do { if (!(pcb->refused_data == 
# 420 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
         0
# 420 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
         )) { do {rt_kprintf("pcb->refused_data == NULL"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 420);}while(0); }} while(0);
          if (pcb->flags & 0x10U) {
          ...
          do { if((pcb)->recv != 
# 435 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
         0
# 435 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 435 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        ...
        if (recv_flags & (u8_t)0x20U) {
          if (pcb->refused_data != 
# 466 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                  0
# 466 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                      ) {
            ...
            do { if(((pcb)->recv != 
# 475 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
           0
# 475 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 475 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        ...
        tcp_input_pcb = 
# 482 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                       0
# 482 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                           ;
        if (tcp_input_delayed_close(pcb)) {
          goto aborted;
        }
...
aborted:
    tcp_input_pcb = 
# 498 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                   0
# 498 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                       ;
    recv_data = 
# 499 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 499 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ;


    if (inseg.p != 
# 502 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                  0
# 502 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                      )
    {
      pbuf_free(inseg.p);
      inseg.p = 
# 505 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 505 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ;
    }
  } else {
  ...
  do { if (!(tcp_pcbs_sane())) { do {rt_kprintf("tcp_input: tcp_pcbs_sane()"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 521);}while(0); }} while(0);
  ;
  return;
dropped:
  ;
...
__attribute__((section(".fast"))) tcp_input_delayed_close(struct tcp_pcb *pcb)
{
  if (recv_flags & (u8_t)0x10U) {
    ...
    if (!(pcb->flags & 0x10U)) {
      ...
      do { (void)pcb->state; if((pcb->errf) != 
# 545 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 545 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 563 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
static void
__attribute__((section(".fast"))) tcp_listen_input(struct tcp_pcb_listen *pcb)
{
  ...
  if (flags & 0x10U) {
    ...
    if (npcb == 
# 595 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
               0
# 595 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                   ) {
      err_t err;
      ;
      ;
      do { if((pcb)->accept != 
# 599 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 599 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 662 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
static void
...
# 708 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
static err_t
__attribute__((section(".fast"))) tcp_process(struct tcp_pcb *pcb)
{
  ...
  if (flags & 0x04U) {
    ...
    if (acceptable) {
      ;
      do { if (!(pcb->state != CLOSED)) { do {rt_kprintf("tcp_input: pcb->state != CLOSED"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 743);}while(0); }} while(0);
  ...
  case SYN_SENT:
    ...
    if ((flags & 0x10U) && (flags & 0x02U)
      ...
      pcb->cwnd = ((((4U * (pcb->mss))) < (((((2U * (pcb->mss))) > (4380U)) ? ((2U * (pcb->mss))) : (4380U)))) ? ((4U * (pcb->mss))) : (((((2U * (pcb->mss))) > (4380U)) ? ((2U * (pcb->mss))) : (4380U))));;
                                                             ...
                                                             ;
      do { if (!((pcb->snd_queuelen > 0))) { do {rt_kprintf("pcb->snd_queuelen > 0"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 794);}while(0); }} while(0);
      --pcb->snd_queuelen;
      ;
      rseg = pcb->unacked;
      if (rseg == 
# 798 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                 0
# 798 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                     ) {


        rseg = pcb->unsent;
        do { if (!(rseg != 
# 802 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0
# 802 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
       )) { do {rt_kprintf("no segment to free"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 802);}while(0); }} while(0);
      ...
      if (pcb->unacked == 
# 811 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                         0
# 811 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                             ) {
        pcb->rtime = -1;
      } else {
        pcb->rtime = 0;
      ...
      do { if((pcb)->connected != 
# 820 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 820 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
  ...
  case SYN_RCVD:
    if (flags & 0x10U) {
      ...
      if ((((s32_t)((u32_t)(ackno) - (u32_t)(pcb->lastack+1)) >= 0) && ((s32_t)((u32_t)(ackno) - (u32_t)(pcb->snd_nxt)) <= 0))) {
        ...
        do { if (!((pcb->listener == 
# 848 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0
# 848 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
       ) || (pcb->listener->accept != 
# 848 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0
# 848 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 848 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        ...
        if (pcb->listener == 
# 851 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                            0
# 851 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                ) {
...
# 859 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
         0
# 859 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
  ...
  case FIN_WAIT_1:
    ...
    if (recv_flags & (u8_t)0x20U) {
      if ((flags & 0x10U) && (ackno == pcb->snd_nxt) &&
          pcb->unsent == 
# 911 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                        0
# 911 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                            ) {
...
# 916 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0
# 916 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 916 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
       ; } while(0); tcp_active_pcbs_changed = 1; } while (0);
        ...
        pcb->state = CLOSING;
               ...
               pcb->unsent == 
# 924 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                             0
# 924 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                 ) {
  ...
  case FIN_WAIT_2:
    ...
    if (recv_flags & (u8_t)0x20U) {
      ...
      tcp_pcb_purge(pcb);
      do { do { if(*(&tcp_active_pcbs) == (pcb)) { (*(&tcp_active_pcbs)) = (*&tcp_active_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_active_pcbs; tcp_tmp_pcb != 
# 934 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 934 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
     ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 934 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 934 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 941 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                                                    0
# 941 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                                                        ) {
      ;
      tcp_pcb_purge(pcb);
      do { do { if(*(&tcp_active_pcbs) == (pcb)) { (*(&tcp_active_pcbs)) = (*&tcp_active_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_active_pcbs; tcp_tmp_pcb != 
# 944 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 944 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
     ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 944 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
     0
# 944 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
  ...
  case LAST_ACK:
    tcp_receive(pcb);
    if ((flags & 0x10U) && ackno == pcb->snd_nxt && pcb->unsent == 
# 951 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                                                                    0
# 951 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                                                        ) {
      ;
...
# 1015 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
static void
__attribute__((section(".fast"))) tcp_receive(struct tcp_pcb *pcb)
{
  ...
  do { if (!(pcb->state >= ESTABLISHED)) { do {rt_kprintf("tcp_receive: wrong state"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1032);}while(0); }} while(0);
  ...
  if (flags & 0x10U) {
    ...
    if (((s32_t)((u32_t)(pcb->snd_wl1) - (u32_t)(seqno)) < 0) ||
      ...
      ;
# 1069 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
    }
# 1092 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
    if (((s32_t)((u32_t)(ackno) - (u32_t)(pcb->lastack)) <= 0)) {
      ...
      while (pcb->unacked != 
# 1170 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                            0 
# 1170 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                                 &&
        ...
        ;
        do { if (!((pcb->snd_queuelen >= pbuf_clen(next->p)))) { do {rt_kprintf("pcb->snd_queuelen >= pbuf_clen(next->p)"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1182);}while(0); }} while(0);
        ...
        if (pcb->snd_queuelen != 0) {
          do { if (!(pcb->unacked != 
# 1190 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
         0 
# 1190 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
         || pcb->unsent != 
# 1190 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
         0
# 1190 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 1190 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
      ...
      if (pcb->unacked == 
# 1197 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                         0
# 1197 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                             ) {
        pcb->rtime = -1;
      } else {
        pcb->rtime = 0;
    ...
    while (pcb->unsent != 
# 1222 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                         0 
# 1222 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                              &&
      ...
      if (pcb->unsent == 
# 1232 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                        0
# 1232 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                            ) {
        pcb->unsent_oversize = 0;
      }

      ;
      do { if (!((pcb->snd_queuelen >= pbuf_clen(next->p)))) { do {rt_kprintf("pcb->snd_queuelen >= pbuf_clen(next->p)"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1237);}while(0); }} while(0);
      ...
      if (pcb->snd_queuelen != 0) {
        do { if (!(pcb->unacked != 
# 1244 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0 
# 1244 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
       || pcb->unsent != 
# 1244 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
       0
# 1244 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 1317 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
    if ((((s32_t)((u32_t)(pcb->rcv_nxt) - (u32_t)(seqno + 1)) >= 0) && ((s32_t)((u32_t)(pcb->rcv_nxt) - (u32_t)(seqno + tcplen - 1)) <= 0))) {
# 1338 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
      struct pbuf *p = inseg.p;
      off = pcb->rcv_nxt - seqno;
      do { if (!(inseg.p)) { do {rt_kprintf("inseg.p != NULL"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1340);}while(0); }} while(0);
      do { if (!((off < 0x7fff))) { do {rt_kprintf("insane offset!"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1341);}while(0); }} while(0);
      if (inseg.p->len < off) {
        do { if (!((((s32_t)inseg.p->tot_len) >= off))) { do {rt_kprintf("pbuf too short!"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1343);}while(0); }} while(0);
        ...
        if (pbuf_header(p, (s16_t)-off)) {
          ...
          do { if (!(0)) { do {rt_kprintf("pbuf_header failed"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1356);}while(0); }} while(0);
        }
      } else {
        if (pbuf_header(inseg.p, (s16_t)-off)) {

          do { if (!(0)) { do {rt_kprintf("pbuf_header failed"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1361);}while(0); }} while(0);
        }
      }
      ...
      if (pcb->rcv_nxt == seqno) {
        ...
        if (tcplen > pcb->rcv_wnd) {
          ...
          do { if (!((seqno + tcplen) == (pcb->rcv_nxt + pcb->rcv_wnd))) { do {rt_kprintf("tcp_receive: segment not trimmed correctly to rcv_wnd\n"); sys_arch_assert(
                                                                       "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
# 1406 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
          ,
                                                                       1407
# 1406 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
          );}while(0); }} while(0)
...
# 1462 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        pcb->rcv_nxt = seqno + tcplen;


        do { if (!(pcb->rcv_wnd >= tcplen)) { do {rt_kprintf("tcp_receive: tcplen > rcv_wnd\n"); sys_arch_assert("../../../components/net/lwip-2.0.2/src/core/tcp_in.c", 1465);}while(0); }} while(0);
        pcb->rcv_wnd -= tcplen;

        tcp_update_rcv_ann_wnd(pcb);
# 1479 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        if (inseg.p->tot_len > 0) {
          ...
          inseg.p = 
# 1484 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                   0
# 1484 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
                       ;
        }
        if (((u16_t)(lwip_htons((inseg.tcphdr)->_hdrlen_rsvd_flags) & 0x3fU)) & 0x01U) {
          ;
...
# 1535 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
        do { if((pcb)->flags & 0x01U) { (pcb)->flags &= ~0x01U; (pcb)->flags |= 0x02U; } else { (pcb)->flags |= 0x01U; } } while (0);
# 1544 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
      } else {

        tcp_send_empty_ack(pcb);
# 1694 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
      }
    } else {
...
{
  if ((tcphdr_opt2 == 
# 1711 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c" 3 4
                     0
# 1711 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
...
# 1728 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
static void
  ...
  if (tcphdr_optlen != 0) {
    for (tcp_optidx = 0; tcp_optidx < tcphdr_optlen; ) {
      ...
      case 2:
        ...
        break;
# 1814 "../../../components/net/lwip-2.0.2/src/core/tcp_in.c"
      default:
        ;
        data = tcp_getoptbyte();
        if (data < 2) {
