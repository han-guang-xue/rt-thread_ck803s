# 1 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c"
# 1 "E:\\YCXGIT\\T6x0_RTOS_SDK_V0.9.3_b1\\T6x0_RTOS_SDK_V0.9.3\\code\\rt-thread\\bsp\\t6x0\\app//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c"
# 24 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c"
...
# 25 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c" 2
...
# 26 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c" 2
...
# 27 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c" 2
...
# 31 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c" 2
...
# 32 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c" 2
# 48 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c"
static const char *REQUEST = "GET https://www.howsmyssl.com/a/check HTTP/1.0\r\n"
    "Host: www.howsmyssl.com\r\n"
    "User-Agent: rtthread/3.1 rtt\r\n"
    "\r\n";

static tls_cli_session *tls_session = (0);
...
static void mbedlts_client_entry(void *parament)
{
    ...
    if((ret = tls_cli_session_init(session, 0)) != 0)
    {
    ...
    while((ret = tls_cli_session_write(session, (const unsigned char *)REQUEST, strlen(REQUEST))) <= 0)
    {
    ...
    do
    {
        ...
        ret = tls_cli_session_read(session, (unsigned char *)session->buffer, len);
        if(ret == -0x6900 || ret == -0x6880)
                continue;
...
int mbedlts_client_start(void)
{
    ...
    tls_session = tls_cli_session_create("www.howsmyssl.com", "443", 1024);
    if(!tls_session)
    {
...
# 153 "../../../packages/mbedtls-2.6.0/samples/tls_app_test.c" 2
    const char __fsym_mbedtls_tls_test_name[] __attribute__((section(".rodata.name"))) = "mbedtls_tls_test"; const char __fsym_mbedtls_tls_test_desc[] __attribute__((section(".rodata.name"))) = "mbedtls client test start"; const struct finsh_syscall __fsym_mbedtls_tls_test __attribute__((section("FSymTab")))= { __fsym_mbedtls_tls_test_name, __fsym_mbedtls_tls_test_desc, (syscall_func)&mbedlts_client_start };;

    const char __fsym___cmd_mbedtls_tls_test_name[] __attribute__((section(".rodata.name"))) = "__cmd_mbedtls_tls_test"; const char __fsym___cmd_mbedtls_tls_test_desc[] __attribute__((section(".rodata.name"))) = "mbedtls client test start"; const struct finsh_syscall __fsym___cmd_mbedtls_tls_test __attribute__((section("FSymTab")))= { __fsym___cmd_mbedtls_tls_test_name, __fsym___cmd_mbedtls_tls_test_desc, (syscall_func)&mbedlts_client_start };;
