...
# 4 "../drivers/drv_wdt.c" 2
# 1 "../libraries/inc/tih/wdt.h" 1
# 21 "../libraries/inc/tih/wdt.h"
...
# 5 "../drivers/drv_wdt.c" 2




static uint8_t wdt_data;
static uint32_t wdt_timeout_value = 20;
static rt_watchdog_t wdt;

static rt_err_t __attribute__((section(".fast"))) drv_wdt_config(rt_watchdog_t *wdt)
{
    wdt_config_t wdt_config_init;
    wdt_config_init.seconds = 20;
    wdt_config_init.signals = 0x1;
    wdt_hw_init(&wdt_config_init);
    return 0;
}
static rt_err_t __attribute__((section(".fast"))) drv_wdt_control(rt_watchdog_t *wdt, int cmd, void *arg)
{
    wdt_config_t wdt_config_init;
...
const init_fn_t __rt_init_drv_wdt_init __attribute__((section(".rti_fn.""1"))) = drv_wdt_init;
