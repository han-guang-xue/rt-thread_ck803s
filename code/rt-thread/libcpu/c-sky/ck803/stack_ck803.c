...
rt_uint8_t __fast *rt_hw_stack_init(void *tentry, void *parameter, rt_uint8_t *stack_addr, void *texit)
{
    ...
    *(--stk)  = (rt_uint32_t)tentry;            /* Entry Point--->pc                                   */ // @suppress("Type cannot be resolved")
    *(--stk)  = (rt_uint32_t)0x80000140L;       /* PSR                                                 */
