...
#define MBEDTLS_GMSSL_MAJOR_VERSION_1           1    /*!< GMSSL v1.1 */
#define MBEDTLS_GMSSL_MINOR_VERSION_1           1   /*!< GMSSL v1.1 */
...
#define MBEDTLS_SSL_PRESET_DEFAULT              0     /* TLS ALL */
#define MBEDTLS_SSL_PRESET_SUITEB               2     /* TLS 1.2 */

#define MBEDTLS_SSL_PRESET_SUITE_GE             0     /* TLS ALL */
#define MBEDTLS_SSL_PRESET_SUITE_GE_V12         2     /* TLS 1.2 */
#if defined(MBEDTLS_GMSSL)
#define MBEDTLS_SSL_PRESET_SUITE_GM             3     /* GMSSL */
#define MBEDTLS_SSL_PRESET_SUITE_GE_AND_GM      4     /* GMSSL + TLS */
#endif
...
#if defined(MBEDTLS_GMSSL)
    const mbedtls_x509_crt_profile *gm_cert_profile; /*!< verification profile */
    mbedtls_ssl_key_cert *gm_key_cert; /*!< own certificate/key pair(s)        */
    mbedtls_x509_crt *gm_ca_chain; 	   /*!< trusted CAs						*/
    mbedtls_x509_crl *gm_ca_crl;	   /*!< trusted CAs CRLs					*/
#endif
#endif /* MBEDTLS_X509_CRT_PARSE_C */
...
{
    int protocol;                   /*!< current protocol:gmssl or TLS  */
