...
{
#if defined(MBEDTLS_GMSSL_CIPHERSUITES)
    MBEDTLS_GMSSL_CIPHERSUITES,
#else
...
static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
    ...
    { MBEDTLS_GMSSL_ECC_SM4_SM3, "ECC_SM4_SM3",
      MBEDTLS_CIPHER_SM4_128_CBC, MBEDTLS_MD_SM3, MBEDTLS_KEY_EXCHANGE_ECC,
      MBEDTLS_GMSSL_MAJOR_VERSION_1, MBEDTLS_GMSSL_MINOR_VERSION_1,
      MBEDTLS_GMSSL_MAJOR_VERSION_1, MBEDTLS_GMSSL_MINOR_VERSION_1,
      0 },
#endif
#endif
...
#define MAX_CIPHERSUITES_SSL    sizeof( ciphersuite_definitions     ) /         \
                            sizeof( ciphersuite_definitions[0]  )
#define MAX_CIPHERSUITES sizeof( ciphersuite_definitions     ) /         \
                            sizeof( ciphersuite_definitions[0]  )

static int supported_ciphersuites_ssl[MAX_CIPHERSUITES_SSL];
static int supported_init_ssl = 0;

#if defined(MBEDTLS_GMSSL)
#define MAX_CIPHERSUITES_GMSSL    sizeof( ciphersuite_definitions     ) /         \
                            sizeof( ciphersuite_definitions[0]  )
static int supported_ciphersuites_gmssl[MAX_CIPHERSUITES_GMSSL];
...
const int *mbedtls_ssl_list_ciphersuites( void )
{
    ...
    if( supported_init_ssl == 0 )
    {
        ...
        for( p = ciphersuite_preference, q = supported_ciphersuites_ssl;
             *p != 0 && q < supported_ciphersuites_ssl + MAX_CIPHERSUITES_SSL - 1;
             p++ )
        {
...
const int *mbedtls_gmssl_list_ciphersuites( void )
{
    ...
    if( supported_init_gmssl == 0 )
    {
        ...
        for( p = ciphersuite_preference_gm, q = supported_ciphersuites_gmssl;
             *p != 0 && q < supported_ciphersuites_gmssl + MAX_CIPHERSUITES_GMSSL - 1;
             p++ )
        {
#if defined(MBEDTLS_REMOVE_ARC4_CIPHERSUITES)
            const mbedtls_ssl_ciphersuite_t *cs_info;
