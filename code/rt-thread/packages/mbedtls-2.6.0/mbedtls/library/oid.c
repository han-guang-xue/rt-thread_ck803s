...
static const oid_x520_attr_t oid_x520_attr_type[] =
{
    ...
    {
        { ADD_LEN( MBEDTLS_OID_C_JURISDICTION ), "id-at-jurisdictionCountryName",    "jurisdictionCountryName" },
        "jurisdictionC",
    },
    {
        { ADD_LEN( MBEDTLS_OID_ST_JURISDICTION ), "id-at-jurisdictionStateOrProvinceName", "jurisdictionStateOrProvinceName" },
        "jurisdictionST",
    },
    {
        { ADD_LEN( MBEDTLS_OID_L_JURISDICTION ), "id-at-jurisdictionLocalityName",    "jurisdictionLocalityName" },
        "jurisdictionL",
    },
    {
        { ADD_LEN( MBEDTLS_OID_BUSINESS_CATEGORY ), "id-at-businessCategory",         "businessCategory" },
        "businessCategory",
    },
    {
        { ADD_LEN( MBEDTLS_OID_STREET ), "id-at-street", "streetAddress" },
        "street",
    },
    {
        { NULL, 0, NULL, NULL },
...
static const oid_sig_alg_t oid_sig_alg[] =
{
    ...
    {
        { ADD_LEN( MBEDTLS_OID_SM2_SM3 ),        "SM2_with_SM3",           "SM2 with SM3" },
...
static const oid_pk_alg_t oid_pk_alg[] =
{
    ...
    {
        { ADD_LEN( MBEDTLS_OID_EC_ALG_UNRESTRICTED ),  "id-ecPublicKey",   "EC key" },
        MBEDTLS_PK_EC,
    },
    {
        { NULL, 0, NULL, NULL },
...
{
    { ADD_LEN( MBEDTLS_OID_EC_GRP_SM2P256V1 ),   "sm2p256v1","sm2p256v1" },
