...
static void __fast iperf_udp_client(void *thread_param)
{
    int sock;
    rt_uint32_t *buffer;
...
static void __fast iperf_udp_server(void *thread_param)
{
    int sock;
    rt_uint32_t *buffer;
    struct sockaddr_in server;
...
static void __fast iperf_client(void *thread_param)
{
    int i;
    int sock;
    int ret;
...
void __fast iperf_server(void *thread_param)
{
    uint8_t *recv_data;
    socklen_t sin_size;
    rt_tick_t tick1, tick2;
