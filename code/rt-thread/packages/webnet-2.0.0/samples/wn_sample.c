...
#include <wn_module.h>
  ...
  #error "To run webnet demo applicaton, RT_USING_DFS_ROMFS must be defined!"
#endif

#ifdef WEBNET_USING_UPLOAD
#if !defined RT_USING_DFS_RAMFS
  #error "To do uploading in webnet demo application, RT_USING_DFS_RAMFS must be defined!"
#endif
